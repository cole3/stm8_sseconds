 ...
 347                     ; 184         COMP->CSR3 |= COMP_CSR3_VREFEN;
 349  0045 72145442      	bset	21570,#2
 351  0049 2004          	jra	L541
 352  004b               L341:
 353                     ; 187         COMP->CSR3 &= (uint8_t)(~COMP_CSR3_VREFEN);
 355  004b 72155442      	bres	21570,#2
 356  004f               L541:
 357                     ; 189 }
 360  004f 81            	ret
 455                     ; 203 void COMP_EdgeConfig(COMP_Selection_TypeDef COMP_Selection, COMP_Edge_TypeDef COMP_Edge)
 455                     ; 204 {
 456                     	switch	.text
 457  0050               _COMP_EdgeConfig:
 459  0050 89            	pushw	x
 460       00000000      OFST:	set	0
 463                     ; 206     assert_param(IS_COMP_ALL_PERIPH(COMP_Selection));
 465                     ; 207     assert_param(IS_COMP_EDGE(COMP_Edge));
 467                     ; 210     if (COMP_Selection == COMP_Selection_COMP1) {
 469  0051 9e            	ld	a,xh
 470  0052 a101          	cp	a,#1
 471  0054 2611          	jrne	L312
 472                     ; 212         COMP->CSR1 &= (uint8_t) (~COMP_CSR1_CMP1);
 474  0056 c65440        	ld	a,21568
 475  0059 a4fc          	and	a,#252
 476  005b c75440        	ld	21568,a
 477                     ; 215         COMP->CSR1 |= (uint8_t) COMP_Edge;
 479  005e 9f            	ld	a,xl
 480  005f ca5440        	or	a,21568
 481  0062 c75440        	ld	21568,a
 483  0065 2010          	jra	L512
 484  0067               L312:
 485                     ; 220         COMP->CSR2 &= (uint8_t) (~COMP_CSR2_CMP2);
 487  0067 c65441        	ld	a,21569
 488  006a a4fc          	and	a,#252
 489  006c c75441        	ld	21569,a
 490                     ; 223         COMP->CSR2 |= (uint8_t) COMP_Edge;
 ...
 499  0077 85            	popw	x
 500  0078 81            	ret
 568                     ; 240 COMP_OutputLevel_TypeDef COMP_GetOutputLevel(COMP_Selection_TypeDef COMP_Selection)
 568                     ; 241 {
 569                     	switch	.text
 570  0079               _COMP_GetOutputLevel:
 572  0079 88            	push	a
 573       00000001      OFST:	set	1
 576                     ; 245     assert_param(IS_COMP_ALL_PERIPH(COMP_Selection));
 578                     ; 248     if (COMP_Selection == COMP_Selection_COMP1) {
 580  007a a101          	cp	a,#1
 581  007c 2611          	jrne	L152
 582                     ; 250         if ((COMP->CSR1 & COMP_CSR1_CMP1OUT) != (uint8_t) RESET) {
 584  007e c65440        	ld	a,21568
 585  0081 a508          	bcp	a,#8
 586  0083 2706          	jreq	L352
 587                     ; 252             compout = (COMP_OutputLevel_TypeDef) COMP_OutputLevel_High;
 589  0085 a601          	ld	a,#1
 590  0087 6b01          	ld	(OFST+0,sp),a
 592  0089 2013          	jra	L752
 593  008b               L352:
 594                     ; 257             compout = (COMP_OutputLevel_TypeDef) COMP_OutputLevel_Low;
 596  008b 0f01          	clr	(OFST+0,sp)
 597  008d 200f          	jra	L752
 598  008f               L152:
 599                     ; 263         if ((COMP->CSR2 & COMP_CSR2_CMP2OUT) != (uint8_t) RESET) {
 601  008f c65441        	ld	a,21569
 602  0092 a508          	bcp	a,#8
 603  0094 2706          	jreq	L162
 604                     ; 265             compout = (COMP_OutputLevel_TypeDef) COMP_OutputLevel_High;
 606  0096 a601          	ld	a,#1
 607  0098 6b01          	ld	(OFST+0,sp),a
 609  009a 2002          	jra	L752
 610  009c               L162:
 611                     ; 270             compout = (COMP_OutputLevel_TypeDef) COMP_OutputLevel_Low;
 613  009c 0f01          	clr	(OFST+0,sp)
 614  009e               L752:
 615                     ; 275     return (COMP_OutputLevel_TypeDef)(compout);
 617  009e 7b01          	ld	a,(OFST+0,sp)
 620  00a0 5b01          	addw	sp,#1
 621  00a2 81            	ret
 656                     ; 307 void COMP_WindowCmd(FunctionalState NewState)
 656                     ; 308 {
 657                     	switch	.text
 658  00a3               _COMP_WindowCmd:
 662                     ; 310     assert_param(IS_FUNCTIONAL_STATE(NewState));
 664                     ; 312     if (NewState != DISABLE) {
 666  00a3 4d            	tnz	a
 667  00a4 2706          	jreq	L303
 668                     ; 314         COMP->CSR3 |= (uint8_t) COMP_CSR3_WNDWE;
 670  00a6 72125442      	bset	21570,#1
 672  00aa 2004          	jra	L503
 673  00ac               L303:
 674                     ; 317         COMP->CSR3 &= (uint8_t)(~COMP_CSR3_WNDWE);
 676  00ac 72135442      	bres	21570,#1
 677  00b0               L503:
 678                     ; 319 }
 681  00b0 81            	ret
 717                     ; 342 void COMP_VrefintOutputCmd(FunctionalState NewState)
 717                     ; 343 {
 718                     	switch	.text
 719  00b1               _COMP_VrefintOutputCmd:
 723                     ; 345     assert_param(IS_FUNCTIONAL_STATE(NewState));
 725                     ; 347     if (NewState != DISABLE) {
 727  00b1 4d            	tnz	a
 728  00b2 2706          	jreq	L523
 729                     ; 349         COMP->CSR3 |= (uint8_t) COMP_CSR3_VREFOUTEN;
 731  00b4 72105442      	bset	21570,#0
 733  00b8 2004          	jra	L723
 734  00ba               L523:
 735                     ; 352         COMP->CSR3 &= (uint8_t) (~COMP_CSR3_VREFOUTEN);
 737  00ba 72115442      	bres	21570,#0
 738  00be               L723:
 739                     ; 354 }
 742  00be 81            	ret
 778                     ; 378 void COMP_SchmittTriggerCmd(FunctionalState NewState)
 778                     ; 379 {
 779                     	switch	.text
 780  00bf               _COMP_SchmittTriggerCmd:
 784                     ; 381     assert_param(IS_FUNCTIONAL_STATE(NewState));
 786                     ; 383     if (NewState != DISABLE) {
 788  00bf 4d            	tnz	a
 789  00c0 2706          	jreq	L743
 790                     ; 385         COMP->CSR1 |= (uint8_t) COMP_CSR1_STE;
 792  00c2 72145440      	bset	21568,#2
 794  00c6 2004          	jra	L153
 795  00c8               L743:
 796                     ; 388         COMP->CSR1 &= (uint8_t) (~COMP_CSR1_STE);
 798  00c8 72155440      	bres	21568,#2
 799  00cc               L153:
 800                     ; 390 }
 803  00cc 81            	ret
 923                     ; 409 void COMP_TriggerConfig(COMP_TriggerGroup_TypeDef COMP_TriggerGroup,
 923                     ; 410                         COMP_TriggerPin_TypeDef COMP_TriggerPin,
 923                     ; 411                         FunctionalState NewState)
 923                     ; 412 {
 924                     	switch	.text
 925  00cd               _COMP_TriggerConfig:
 927  00cd 89            	pushw	x
 928       00000000      OFST:	set	0
 931                     ; 414     assert_param(IS_COMP_TRIGGERGROUP(COMP_TriggerGroup));
 933                     ; 415     assert_param(IS_COMP_TRIGGERPIN(COMP_TriggerPin));
 935                     ; 417     switch (COMP_TriggerGroup) {
 937  00ce 9e            	ld	a,xh
 939                     ; 451     default:
 939                     ; 452         break;
 940  00cf 4a            	dec	a
 ...
 949  00dd               L353:
 950                     ; 418     case COMP_TriggerGroup_InvertingInput:
 950                     ; 419 
 950                     ; 420         if (NewState != DISABLE) {
 952  00dd 0d05          	tnz	(OFST+5,sp)
 953  00df 270b          	jreq	L544
 954                     ; 421             COMP->CSR4 &= (uint8_t) ~COMP_TriggerPin;
 ...
 962  00ec               L544:
 963                     ; 423             COMP->CSR4 |= (uint8_t) COMP_TriggerPin;
 965  00ec c65443        	ld	a,21571
 966  00ef 1a02          	or	a,(OFST+2,sp)
 967  00f1 c75443        	ld	21571,a
 968  00f4 2055          	jra	L344
 969  00f6               L553:
 970                     ; 427     case COMP_TriggerGroup_NonInvertingInput:
 970                     ; 428         if (NewState != DISABLE) {
 972  00f6 0d05          	tnz	(OFST+5,sp)
 973  00f8 270e          	jreq	L154
 974                     ; 429             COMP->CSR4 &= (uint8_t) ~((uint8_t)(COMP_TriggerPin << 3));
 ...
 985  0108               L154:
 986                     ; 431             COMP->CSR4 |= (uint8_t) (COMP_TriggerPin << 3);
 ...
 995  0115               L753:
 996                     ; 435     case COMP_TriggerGroup_VREFINTOutput:
 996                     ; 436         if (NewState != DISABLE) {
 998  0115 0d05          	tnz	(OFST+5,sp)
 999  0117 270b          	jreq	L554
1000                     ; 437             COMP->CSR5 &= (uint8_t) ~COMP_TriggerPin;
...
1008  0124               L554:
1009                     ; 439             COMP->CSR5 |= (uint8_t) COMP_TriggerPin;
1011  0124 c65444        	ld	a,21572
1012  0127 1a02          	or	a,(OFST+2,sp)
1013  0129 c75444        	ld	21572,a
1014  012c 201d          	jra	L344
1015  012e               L163:
1016                     ; 443     case COMP_TriggerGroup_DACOutput:
1016                     ; 444         if (NewState != DISABLE) {
1018  012e 0d05          	tnz	(OFST+5,sp)
1019  0130 270e          	jreq	L164
1020                     ; 445             COMP->CSR5 &= (uint8_t) ~((uint8_t)(COMP_TriggerPin << 3));
...
1031  0140               L164:
1032                     ; 447             COMP->CSR5 |= (uint8_t) (COMP_TriggerPin << 3);
...
1047  014b 85            	popw	x
1048  014c 81            	ret
1093                     ; 482 void COMP_ITConfig(COMP_Selection_TypeDef COMP_Selection, FunctionalState NewState)
1093                     ; 483 {
1094                     	switch	.text
1095  014d               _COMP_ITConfig:
1097  014d 89            	pushw	x
1098       00000000      OFST:	set	0
1101                     ; 485     assert_param(IS_COMP_ALL_PERIPH(COMP_Selection));
1103                     ; 486     assert_param(IS_FUNCTIONAL_STATE(NewState));
1105                     ; 489     if (COMP_Selection == COMP_Selection_COMP1) {
1107  014e 9e            	ld	a,xh
1108  014f a101          	cp	a,#1
1109  0151 2610          	jrne	L705
1110                     ; 490         if (NewState != DISABLE) {
1112  0153 9f            	ld	a,xl
1113  0154 4d            	tnz	a
1114  0155 2706          	jreq	L115
1115                     ; 492             COMP->CSR1 |= (uint8_t) COMP_CSR1_IE1;
1117  0157 721a5440      	bset	21568,#5
1119  015b 2014          	jra	L515
1120  015d               L115:
1121                     ; 495             COMP->CSR1 &= (uint8_t)(~COMP_CSR1_IE1);
1123  015d 721b5440      	bres	21568,#5
1124  0161 200e          	jra	L515
1125  0163               L705:
1126                     ; 498         if (NewState != DISABLE) {
1128  0163 0d02          	tnz	(OFST+2,sp)
1129  0165 2706          	jreq	L715
1130                     ; 500             COMP->CSR2 |= (uint8_t) COMP_CSR2_IE2;
1132  0167 721a5441      	bset	21569,#5
1134  016b 2004          	jra	L515
1135  016d               L715:
1136                     ; 503             COMP->CSR2 &= (uint8_t)(~COMP_CSR2_IE2);
1138  016d 721b5441      	bres	21569,#5
1139  0171               L515:
1140                     ; 506 }
1143  0171 85            	popw	x
1144  0172 81            	ret
1210                     ; 516 FlagStatus COMP_GetFlagStatus(COMP_Selection_TypeDef COMP_Selection)
1210                     ; 517 {
1211                     	switch	.text
1212  0173               _COMP_GetFlagStatus:
1214  0173 88            	push	a
1215       00000001      OFST:	set	1
1218                     ; 518     FlagStatus bitstatus = RESET;
1220  0174 0f01          	clr	(OFST+0,sp)
1221                     ; 521     assert_param(IS_COMP_ALL_PERIPH(COMP_Selection));
1223                     ; 524     if (COMP_Selection == COMP_Selection_COMP1) {
1225  0176 a101          	cp	a,#1
1226  0178 2611          	jrne	L555
1227                     ; 525         if ((COMP->CSR1 & COMP_CSR1_EF1) != (uint8_t) RESET) {
1229  017a c65440        	ld	a,21568
1230  017d a510          	bcp	a,#16
1231  017f 2706          	jreq	L755
1232                     ; 527             bitstatus = SET;
1234  0181 a601          	ld	a,#1
1235  0183 6b01          	ld	(OFST+0,sp),a
1237  0185 2013          	jra	L365
1238  0187               L755:
1239                     ; 530             bitstatus = RESET;
1241  0187 0f01          	clr	(OFST+0,sp)
1242  0189 200f          	jra	L365
1243  018b               L555:
1244                     ; 533         if ((COMP->CSR2 & COMP_CSR2_EF2) != (uint8_t) RESET) {
1246  018b c65441        	ld	a,21569
1247  018e a510          	bcp	a,#16
1248  0190 2706          	jreq	L565
1249                     ; 535             bitstatus = SET;
1251  0192 a601          	ld	a,#1
1252  0194 6b01          	ld	(OFST+0,sp),a
1254  0196 2002          	jra	L365
1255  0198               L565:
1256                     ; 538             bitstatus = RESET;
1258  0198 0f01          	clr	(OFST+0,sp)
1259  019a               L365:
1260                     ; 543     return (FlagStatus)(bitstatus);
1262  019a 7b01          	ld	a,(OFST+0,sp)
1265  019c 5b01          	addw	sp,#1
1266  019e 81            	ret
1301                     ; 554 void COMP_ClearFlag(COMP_Selection_TypeDef COMP_Selection)
1301                     ; 555 {
1302                     	switch	.text
1303  019f               _COMP_ClearFlag:
1307                     ; 557     assert_param(IS_COMP_ALL_PERIPH(COMP_Selection));
1309                     ; 559     if (COMP_Selection == COMP_Selection_COMP1) {
1311  019f a101          	cp	a,#1
1312  01a1 2606          	jrne	L706
1313                     ; 561         COMP->CSR1 &= (uint8_t) (~COMP_CSR1_EF1);
1315  01a3 72195440      	bres	21568,#4
1317  01a7 2004          	jra	L116
1318  01a9               L706:
1319                     ; 564         COMP->CSR2 &= (uint8_t) (~COMP_CSR2_EF2);
1321  01a9 72195441      	bres	21569,#4
1322  01ad               L116:
1323                     ; 566 }
1326  01ad 81            	ret
1390                     ; 576 ITStatus COMP_GetITStatus(COMP_Selection_TypeDef COMP_Selection)
1390                     ; 577 {
1391                     	switch	.text
