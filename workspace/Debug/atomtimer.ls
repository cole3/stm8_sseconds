 ...
 117                     ; 126 uint8_t atomTimerRegister (ATOM_TIMER *timer_ptr)
 117                     ; 127 {
 119                     	switch	.text
 ...
 127                     ; 132     if ((timer_ptr == NULL) || (timer_ptr->cb_func == NULL)
 127                     ; 133         || (timer_ptr->cb_ticks == 0))
 ...
 321  0066 f7            ld (X),A
 322  0067 9b            sim
 324                     ; 209         prev_ptr = next_ptr = timer_queue;
 ...
 358  0090 85            	popw	x
 359  0091               L571:
 360                     ; 227                 status = ATOM_OK;
 362  0091 0f02          	clr	(OFST-4,sp)
 363                     ; 228                 break;
 364  0093               L761:
 365                     ; 238         CRITICAL_END ();
 ...
 922  014e               L524:
 923                     ; 422         if (--(next_ptr->cb_ticks) == 0)
...
1071  01a8 f7            ld (X),A
1072  01a9 9b            sim
1074                     ; 490         (void)tcbEnqueuePriority (&tcbReadyQ, timer_data_ptr->tcb_ptr);
