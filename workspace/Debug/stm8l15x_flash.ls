 ...
 191                     ; 204         FLASH->CR1 |= (uint8_t)FLASH_CR1_WAITM;
 193  0015 72145050      	bset	20560,#2
 195  0019 2004          	jra	L77
 196  001b               L57:
 197                     ; 208         FLASH->CR1 &= (uint8_t)(~FLASH_CR1_WAITM);
 199  001b 72155050      	bres	20560,#2
 200  001f               L77:
 201                     ; 210 }
 204  001f 81            	ret
 227                     ; 251 void FLASH_DeInit(void)
 227                     ; 252 {
 228                     	switch	.text
 229  0020               _FLASH_DeInit:
 233                     ; 253     FLASH->CR1 = FLASH_CR1_RESET_VALUE;
 235  0020 725f5050      	clr	20560
 236                     ; 254     FLASH->CR2 = FLASH_CR2_RESET_VALUE;
 238  0024 725f5051      	clr	20561
 239                     ; 255     FLASH->IAPSR = FLASH_IAPSR_RESET_VALUE;
 241  0028 35405054      	mov	20564,#64
 242                     ; 256     (void) FLASH->IAPSR; /* Reading of this register causes the clearing of status flags */
 244  002c c65054        	ld	a,20564
 245  002f 97            	ld	xl,a
 246                     ; 257 }
 249  0030 81            	ret
 305                     ; 267 void FLASH_Unlock(FLASH_MemType_TypeDef FLASH_MemType)
 305                     ; 268 {
 306                     	switch	.text
 307  0031               _FLASH_Unlock:
 309  0031 88            	push	a
 310       00000000      OFST:	set	0
 313                     ; 270     assert_param(IS_FLASH_MEMORY_TYPE(FLASH_MemType));
 315                     ; 273     if (FLASH_MemType == FLASH_MemType_Program) {
 317  0032 a1fd          	cp	a,#253
 318  0034 2608          	jrne	L731
 319                     ; 274         FLASH->PUKR = FLASH_RASS_KEY1;
 321  0036 35565052      	mov	20562,#86
 322                     ; 275         FLASH->PUKR = FLASH_RASS_KEY2;
 324  003a 35ae5052      	mov	20562,#174
 325  003e               L731:
 326                     ; 279     if (FLASH_MemType == FLASH_MemType_Data) {
 328  003e 7b01          	ld	a,(OFST+1,sp)
 329  0040 a1f7          	cp	a,#247
 330  0042 2608          	jrne	L141
 331                     ; 280         FLASH->DUKR = FLASH_RASS_KEY2; /* Warning: keys are reversed on data memory !!! */
 333  0044 35ae5053      	mov	20563,#174
 334                     ; 281         FLASH->DUKR = FLASH_RASS_KEY1;
 336  0048 35565053      	mov	20563,#86
 337  004c               L141:
 338                     ; 283 }
 341  004c 84            	pop	a
 342  004d 81            	ret
 377                     ; 293 void FLASH_Lock(FLASH_MemType_TypeDef FLASH_MemType)
 377                     ; 294 {
 378                     	switch	.text
 379  004e               _FLASH_Lock:
 383                     ; 296     assert_param(IS_FLASH_MEMORY_TYPE(FLASH_MemType));
 385                     ; 298     FLASH->IAPSR &= (uint8_t)FLASH_MemType;
 387  004e c45054        	and	a,20564
 388  0051 c75054        	ld	20564,a
 389                     ; 299 }
 392  0054 81            	ret
 435                     ; 307 void FLASH_ProgramByte(uint32_t Address, uint8_t Data)
 435                     ; 308 {
 436                     	switch	.text
 437  0055               _FLASH_ProgramByte:
 439       00000000      OFST:	set	0
 442                     ; 310     assert_param(IS_FLASH_ADDRESS(Address));
 444                     ; 312     *(PointerAttr uint8_t*) (uint16_t)Address = Data;
 ...
 455                     ; 313 }
 458  0067 81            	ret
 492                     ; 320 void FLASH_EraseByte(uint32_t Address)
 492                     ; 321 {
 493                     	switch	.text
 494  0068               _FLASH_EraseByte:
 496       00000000      OFST:	set	0
 499                     ; 323     assert_param(IS_FLASH_ADDRESS(Address));
 501                     ; 325     *(PointerAttr uint8_t*) (uint16_t)Address = FLASH_CLEAR_BYTE; /* Erase byte */
 ...
 512                     ; 326 }
 515  0079 81            	ret
 558                     ; 334 void FLASH_ProgramWord(uint32_t Address, uint32_t Data)
 558                     ; 335 {
 559                     	switch	.text
 560  007a               _FLASH_ProgramWord:
 562       00000000      OFST:	set	0
 565                     ; 337     assert_param(IS_FLASH_ADDRESS(Address));
 567                     ; 339     FLASH->CR2 |= FLASH_CR2_WPRG;
 569  007a 721c5051      	bset	20561,#6
 570                     ; 342     *((PointerAttr uint8_t*)(uint16_t)Address)       = *((uint8_t*)(&Data));
 ...
 581                     ; 344     *(((PointerAttr uint8_t*)(uint16_t)Address) + 1) = *((uint8_t*)(&Data) + 1);
 ...
 594                     ; 346     *(((PointerAttr uint8_t*)(uint16_t)Address) + 2) = *((uint8_t*)(&Data) + 2);
 ...
 607                     ; 348     *(((PointerAttr uint8_t*)(uint16_t)Address) + 3) = *((uint8_t*)(&Data) + 3);
 ...
 620                     ; 349 }
 623  00d5 81            	ret
 657                     ; 356 uint8_t FLASH_ReadByte(uint32_t Address)
 657                     ; 357 {
 658                     	switch	.text
 659  00d6               _FLASH_ReadByte:
 661       00000000      OFST:	set	0
 664                     ; 359     return(*(PointerAttr uint8_t *) (uint16_t)Address);
 ...
 978  014e 81            	ret
1012                     ; 494 uint16_t FLASH_GetCodeSize(void)
1012                     ; 495 {
1013                     	switch	.text
1014  014f               _FLASH_GetCodeSize:
1016  014f 89            	pushw	x
1017       00000002      OFST:	set	2
1020                     ; 496     uint16_t temp = 0;
1022  0150 5f            	clrw	x
1023  0151 1f01          	ldw	(OFST-1,sp),x
1024                     ; 499     temp = (uint16_t)((uint16_t)OPT->PCODESIZE * (uint16_t)128);
...
1034                     ; 502     if (OPT->PCODESIZE > 0x7F) {
...
1043  016a               L114:
1044                     ; 507     return(temp);
1046  016a 1e01          	ldw	x,(OFST-1,sp)
1049  016c 5b02          	addw	sp,#2
1050  016e 81            	ret
1085                     ; 532 void FLASH_ITConfig(FunctionalState NewState)
1085                     ; 533 {
1086                     	switch	.text
1087  016f               _FLASH_ITConfig:
1091                     ; 536     assert_param(IS_FUNCTIONAL_STATE(NewState));
1093                     ; 538     if (NewState != DISABLE) {
1095  016f 4d            	tnz	a
1096  0170 2706          	jreq	L134
1097                     ; 540         FLASH->CR1 |= FLASH_CR1_IE;
1099  0172 72125050      	bset	20560,#1
1101  0176 2004          	jra	L334
1102  0178               L134:
1103                     ; 543         FLASH->CR1 &= (uint8_t)(~FLASH_CR1_IE);
1105  0178 72135050      	bres	20560,#1
1106  017c               L334:
1107                     ; 545 }
1110  017c 81            	ret
1219                     ; 559 FlagStatus FLASH_GetFlagStatus(FLASH_FLAG_TypeDef FLASH_FLAG)
1219                     ; 560 {
1220                     	switch	.text
1221  017d               _FLASH_GetFlagStatus:
1223  017d 88            	push	a
1224       00000001      OFST:	set	1
1227                     ; 561     FlagStatus status = RESET;
1229  017e 0f01          	clr	(OFST+0,sp)
1230                     ; 562     assert_param(IS_FLASH_FLAGS(FLASH_FLAG));
1232                     ; 565     if ((FLASH->IAPSR  & (uint8_t)FLASH_FLAG) != (uint8_t)RESET) {
1234  0180 c45054        	and	a,20564
1235  0183 2706          	jreq	L505
1236                     ; 566         status = SET; /* Flash_FLAG is set*/
1238  0185 a601          	ld	a,#1
1239  0187 6b01          	ld	(OFST+0,sp),a
1241  0189 2002          	jra	L705
1242  018b               L505:
1243                     ; 568         status = RESET; /* Flash_FLAG is reset*/
1245  018b 0f01          	clr	(OFST+0,sp)
1246  018d               L705:
1247                     ; 572     return status;
1249  018d 7b01          	ld	a,(OFST+0,sp)
1252  018f 5b01          	addw	sp,#1
1253  0191 81            	ret
1289                     ; 688 IN_RAM(void FLASH_PowerRunModeConfig(FLASH_Power_TypeDef FLASH_Power))
1289                     ; 689 {
1290                     	switch	.text
1291  0192               _FLASH_PowerRunModeConfig:
1295                     ; 691     assert_param(IS_FLASH_POWER(FLASH_Power));
1297                     ; 693     if (FLASH_Power != FLASH_Power_On) {
1299  0192 a101          	cp	a,#1
1300  0194 2706          	jreq	L725
1301                     ; 694         FLASH->CR1 |= (uint8_t)FLASH_CR1_EEPM;
1303  0196 72165050      	bset	20560,#3
1305  019a 2004          	jra	L135
1306  019c               L725:
1307                     ; 696         FLASH->CR1 &= (uint8_t)(~FLASH_CR1_EEPM);
1309  019c 72175050      	bres	20560,#3
1310  01a0               L135:
1311                     ; 698 }
1314  01a0 81            	ret
1378                     ; 711 IN_RAM(FLASH_PowerStatus_TypeDef FLASH_GetPowerStatus(void))
1378                     ; 712 {
1379                     	switch	.text
1380  01a1               _FLASH_GetPowerStatus:
1384                     ; 713     return((FLASH_PowerStatus_TypeDef)(FLASH->CR1 & (uint8_t)0x0C));
1386  01a1 c65050        	ld	a,20560
1387  01a4 a40c          	and	a,#12
1390  01a6 81            	ret
1494                     ; 731 IN_RAM(void FLASH_ProgramBlock(uint16_t BlockNum, FLASH_MemType_TypeDef FLASH_MemType,
1494                     ; 732                                FLASH_ProgramMode_TypeDef FLASH_ProgMode, uint8_t *Buffer))
1494                     ; 733 {
1495                     	switch	.text
...
1503                     ; 734     uint16_t Count = 0;
1505  01aa 1e05          	ldw	x,(OFST-1,sp)
1506                     ; 735     uint32_t startaddress = 0;
1508  01ac 96            	ldw	x,sp
1509  01ad 1c0001        	addw	x,#OFST-5
1510  01b0 cd0000        	call	c_ltor
1512                     ; 738     assert_param(IS_FLASH_MEMORY_TYPE(FLASH_MemType));
1514                     ; 739     assert_param(IS_FLASH_PROGRAM_MODE(FLASH_ProgMode));
1516                     ; 740     if (FLASH_MemType == FLASH_MemType_Program) {
1518  01b3 7b0b          	ld	a,(OFST+5,sp)
1519  01b5 a1fd          	cp	a,#253
1520  01b7 260c          	jrne	L136
1521                     ; 741         assert_param(IS_FLASH_PROGRAM_BLOCK_NUMBER(BlockNum));
1523                     ; 742         startaddress = FLASH_PROGRAM_START_PHYSICAL_ADDRESS;
...
1531  01c5               L136:
1532                     ; 744         assert_param(IS_FLASH_DATA_EEPROM_BLOCK_NUMBER(BlockNum));
1534                     ; 745         startaddress = FLASH_DATA_EEPROM_START_PHYSICAL_ADDRESS;
1536  01c5 ae1000        	ldw	x,#4096
1537  01c8 1f03          	ldw	(OFST-3,sp),x
1538  01ca ae0000        	ldw	x,#0
1539  01cd 1f01          	ldw	(OFST-5,sp),x
1540  01cf               L336:
1541                     ; 749     startaddress = startaddress + ((uint32_t)BlockNum * FLASH_BLOCK_SIZE);
...
1551                     ; 752     if (FLASH_ProgMode == FLASH_ProgramMode_Standard) {
1553  01dd 0d0c          	tnz	(OFST+6,sp)
1554  01df 2606          	jrne	L536
1555                     ; 754         FLASH->CR2 |= FLASH_CR2_PRG;
1557  01e1 72105051      	bset	20561,#0
1559  01e5 2004          	jra	L736
1560  01e7               L536:
1561                     ; 757         FLASH->CR2 |= FLASH_CR2_FPRG;
1563  01e7 72185051      	bset	20561,#4
1564  01eb               L736:
1565                     ; 761     for (Count = 0; Count < FLASH_BLOCK_SIZE; Count++) {
1567  01eb 5f            	clrw	x
1568  01ec 1f05          	ldw	(OFST-1,sp),x
1569  01ee               L146:
1570                     ; 765         *((PointerAttr uint8_t*) (uint32_t)startaddress + Count) = ((uint8_t)(Buffer[Count]));
...
1584                     ; 761     for (Count = 0; Count < FLASH_BLOCK_SIZE; Count++) {
...
1598  0215 81            	ret
1661                     ; 780 IN_RAM(void FLASH_EraseBlock(uint16_t BlockNum, FLASH_MemType_TypeDef FLASH_MemType))
1661                     ; 781 {
1662                     	switch	.text
...
1670                     ; 782     uint32_t startaddress = 0;
1672  0219 96            	ldw	x,sp
1673  021a 1c0001        	addw	x,#OFST-6
1674  021d cd0000        	call	c_ltor
1676                     ; 790     assert_param(IS_FLASH_MEMORY_TYPE(FLASH_MemType));
1678                     ; 791     if (FLASH_MemType == FLASH_MemType_Program) {
1680  0220 7b0c          	ld	a,(OFST+5,sp)
1681  0222 a1fd          	cp	a,#253
1682  0224 260c          	jrne	L107
1683                     ; 792         assert_param(IS_FLASH_PROGRAM_BLOCK_NUMBER(BlockNum));
1685                     ; 793         startaddress = FLASH_PROGRAM_START_PHYSICAL_ADDRESS;
...
1693  0232               L107:
1694                     ; 795         assert_param(IS_FLASH_DATA_EEPROM_BLOCK_NUMBER(BlockNum));
1696                     ; 796         startaddress = FLASH_DATA_EEPROM_START_PHYSICAL_ADDRESS;
1698  0232 ae1000        	ldw	x,#4096
1699  0235 1f03          	ldw	(OFST-4,sp),x
1700  0237 ae0000        	ldw	x,#0
1701  023a 1f01          	ldw	(OFST-6,sp),x
1702  023c               L307:
1703                     ; 803     pwFlash = (PointerAttr uint8_t *)(uint32_t)(startaddress + ((uint32_t)BlockNum * FLASH_BLOCK_SIZE));
...
1718                     ; 807     FLASH->CR2 |= FLASH_CR2_ERASE;
1720  0255 721a5051      	bset	20561,#5
1721                     ; 812     *pwFlash = (uint8_t)0;
...
1763  029e 81            	ret
1848                     ; 829 IN_RAM(FLASH_Status_TypeDef FLASH_WaitForLastOperation(FLASH_MemType_TypeDef FLASH_MemType))
1848                     ; 830 {
1849                     	switch	.text
1850  029f               _FLASH_WaitForLastOperation:
1852  029f 5205          	subw	sp,#5
1853       00000005      OFST:	set	5
1856                     ; 831     uint32_t timeout = OPERATION_TIMEOUT;
1858  02a1 aeffff        	ldw	x,#65535
1859  02a4 1f03          	ldw	(OFST-2,sp),x
1860  02a6 ae0000        	ldw	x,#0
1861  02a9 1f01          	ldw	(OFST-4,sp),x
1862                     ; 832     uint8_t flagstatus = 0x00;
1864  02ab 0f05          	clr	(OFST+0,sp)
1865                     ; 834     if (FLASH_MemType == FLASH_MemType_Program) {
1867  02ad a1fd          	cp	a,#253
1868  02af 2631          	jrne	L367
1870  02b1 2010          	jra	L157
1871  02b3               L747:
1872                     ; 836             flagstatus = (uint8_t)(FLASH->IAPSR & (uint8_t)(FLASH_IAPSR_EOP |
1872                     ; 837                                    FLASH_IAPSR_WR_PG_DIS));
...
1884  02c3               L157:
1885                     ; 835         while ((flagstatus == 0x00) && (timeout != 0x00)) {
...
1896  02d2               L167:
1897                     ; 842             flagstatus = (uint8_t)(FLASH->IAPSR & (uint8_t)(FLASH_IAPSR_HVOFF |
1897                     ; 843                                    FLASH_IAPSR_WR_PG_DIS));
...
1909  02e2               L367:
1910                     ; 841         while ((flagstatus == 0x00) && (timeout != 0x00)) {
