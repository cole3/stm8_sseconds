 ...
 795                     ; 382     TIM1->CR1 |= TIM1_CR1_UDIS;
 797  0139 721252b0      	bset	21168,#1
 799  013d 2004          	jra	L103
 800  013f               L772:
 801                     ; 386     TIM1->CR1 &= (uint8_t)(~TIM1_CR1_UDIS);
 803  013f 721352b0      	bres	21168,#1
 804  0143               L103:
 805                     ; 388 }
 808  0143 81            	ret
 866                     ; 398 void TIM1_UpdateRequestConfig(TIM1_UpdateSource_TypeDef TIM1_UpdateSource)
 866                     ; 399 {
 867                     	switch	.text
 868  0144               _TIM1_UpdateRequestConfig:
 872                     ; 401   assert_param(IS_TIM1_UPDATE_SOURCE(TIM1_UpdateSource));
 874                     ; 404   if (TIM1_UpdateSource != TIM1_UpdateSource_Global)
 876  0144 4d            	tnz	a
 877  0145 2706          	jreq	L133
 878                     ; 406     TIM1->CR1 |= TIM1_CR1_URS;
 880  0147 721452b0      	bset	21168,#2
 882  014b 2004          	jra	L333
 883  014d               L133:
 884                     ; 410     TIM1->CR1 &= (uint8_t)(~TIM1_CR1_URS);
 886  014d 721552b0      	bres	21168,#2
 887  0151               L333:
 888                     ; 412 }
 891  0151 81            	ret
 927                     ; 420 void TIM1_ARRPreloadConfig(FunctionalState NewState)
 927                     ; 421 {
 928                     	switch	.text
 929  0152               _TIM1_ARRPreloadConfig:
 933                     ; 423   assert_param(IS_FUNCTIONAL_STATE(NewState));
 935                     ; 426   if (NewState != DISABLE)
 937  0152 4d            	tnz	a
 938  0153 2706          	jreq	L353
 939                     ; 428     TIM1->CR1 |= TIM1_CR1_ARPE;
 941  0155 721e52b0      	bset	21168,#7
 943  0159 2004          	jra	L553
 944  015b               L353:
 945                     ; 432     TIM1->CR1 &= (uint8_t)(~TIM1_CR1_ARPE);
 947  015b 721f52b0      	bres	21168,#7
 948  015f               L553:
 949                     ; 434 }
 952  015f 81            	ret
1009                     ; 444 void TIM1_SelectOnePulseMode(TIM1_OPMode_TypeDef TIM1_OPMode)
1009                     ; 445 {
1010                     	switch	.text
1011  0160               _TIM1_SelectOnePulseMode:
1015                     ; 447   assert_param(IS_TIM1_OPM_MODE(TIM1_OPMode));
1017                     ; 450   if (TIM1_OPMode != TIM1_OPMode_Repetitive)
1019  0160 4d            	tnz	a
1020  0161 2706          	jreq	L504
1021                     ; 452     TIM1->CR1 |= TIM1_CR1_OPM;
1023  0163 721652b0      	bset	21168,#3
1025  0167 2004          	jra	L704
1026  0169               L504:
1027                     ; 456     TIM1->CR1 &= (uint8_t)(~TIM1_CR1_OPM);
1029  0169 721752b0      	bres	21168,#3
1030  016d               L704:
1031                     ; 458 }
1034  016d 81            	ret
1069                     ; 466 void TIM1_Cmd(FunctionalState NewState)
1069                     ; 467 {
1070                     	switch	.text
1071  016e               _TIM1_Cmd:
1075                     ; 469   assert_param(IS_FUNCTIONAL_STATE(NewState));
1077                     ; 472   if (NewState != DISABLE)
1079  016e 4d            	tnz	a
1080  016f 2706          	jreq	L724
1081                     ; 474     TIM1->CR1 |= TIM1_CR1_CEN;
1083  0171 721052b0      	bset	21168,#0
1085  0175 2004          	jra	L134
1086  0177               L724:
1087                     ; 478     TIM1->CR1 &= (uint8_t)(~TIM1_CR1_CEN);
1089  0177 721152b0      	bres	21168,#0
1090  017b               L134:
1091                     ; 480 }
1094  017b 81            	ret
1379                     ; 571 void TIM1_OC1Init(TIM1_OCMode_TypeDef TIM1_OCMode,
1379                     ; 572                   TIM1_OutputState_TypeDef TIM1_OutputState,
1379                     ; 573                   TIM1_OutputNState_TypeDef TIM1_OutputNState,
1379                     ; 574                   uint16_t TIM1_Pulse,
1379                     ; 575                   TIM1_OCPolarity_TypeDef TIM1_OCPolarity,
1379                     ; 576                   TIM1_OCNPolarity_TypeDef TIM1_OCNPolarity,
1379                     ; 577                   TIM1_OCIdleState_TypeDef TIM1_OCIdleState,
1379                     ; 578                   TIM1_OCNIdleState_TypeDef TIM1_OCNIdleState)
1379                     ; 579 {
1380                     	switch	.text
...
1388                     ; 581   assert_param(IS_TIM1_OC_MODE(TIM1_OCMode));
1390                     ; 582   assert_param(IS_TIM1_OUTPUT_STATE(TIM1_OutputState));
1392                     ; 583   assert_param(IS_TIM1_OUTPUTN_STATE(TIM1_OutputNState));
1394                     ; 584   assert_param(IS_TIM1_OC_POLARITY(TIM1_OCPolarity));
1396                     ; 585   assert_param(IS_TIM1_OCN_POLARITY(TIM1_OCNPolarity));
1398                     ; 586   assert_param(IS_TIM1_OCIDLE_STATE(TIM1_OCIdleState));
1400                     ; 587   assert_param(IS_TIM1_OCNIDLE_STATE(TIM1_OCNIdleState));
1402                     ; 591   TIM1->CCER1 &= (uint8_t)(~(TIM1_CCER1_CC1E | TIM1_CCER1_CC1NE
1402                     ; 592                              | TIM1_CCER1_CC1P | TIM1_CCER1_CC1NP));
1404  017f c652bd        	ld	a,21181
1405  0182 a4f0          	and	a,#240
1406  0184 c752bd        	ld	21181,a
1407                     ; 595   TIM1->CCER1 |= (uint8_t)((uint8_t)((uint8_t)(TIM1_OutputState & TIM1_CCER1_CC1E)
1407                     ; 596                                      | (uint8_t)(TIM1_OutputNState & TIM1_CCER1_CC1NE))
1407                     ; 597                            | (uint8_t)( (uint8_t)(TIM1_OCPolarity  & TIM1_CCER1_CC1P)
1407                     ; 598                                         | (uint8_t)(TIM1_OCNPolarity & TIM1_CCER1_CC1NP)));
...
1425                     ; 601   TIM1->CCMR1 = (uint8_t)((uint8_t)(TIM1->CCMR1 & (uint8_t)(~TIM1_CCMR_OCM))
1425                     ; 602                           | (uint8_t)TIM1_OCMode);
1427  01a8 c652b9        	ld	a,21177
1428  01ab a48f          	and	a,#143
1429  01ad 1a04          	or	a,(OFST+1,sp)
1430  01af c752b9        	ld	21177,a
1431                     ; 605   TIM1->OISR &= (uint8_t)(~(TIM1_OISR_OIS1 | TIM1_OISR_OIS1N));
1433  01b2 c652d0        	ld	a,21200
1434  01b5 a4fc          	and	a,#252
1435  01b7 c752d0        	ld	21200,a
1436                     ; 607   TIM1->OISR |= (uint8_t)((uint8_t)(TIM1_OCIdleState & TIM1_OISR_OIS1)
1436                     ; 608                           | (uint8_t)(TIM1_OCNIdleState & TIM1_OISR_OIS1N));
...
1446                     ; 611   TIM1->CCR1H = (uint8_t)(TIM1_Pulse >> 8);
1448  01cc 7b09          	ld	a,(OFST+6,sp)
1449  01ce c752c6        	ld	21190,a
1450                     ; 612   TIM1->CCR1L = (uint8_t)(TIM1_Pulse);
1452  01d1 7b0a          	ld	a,(OFST+7,sp)
1453  01d3 c752c7        	ld	21191,a
1454                     ; 613 }
1457  01d6 5b05          	addw	sp,#5
1458  01d8 81            	ret
1562                     ; 652 void TIM1_OC2Init(TIM1_OCMode_TypeDef TIM1_OCMode,
1562                     ; 653                   TIM1_OutputState_TypeDef TIM1_OutputState,
1562                     ; 654                   TIM1_OutputNState_TypeDef TIM1_OutputNState,
1562                     ; 655                   uint16_t TIM1_Pulse,
1562                     ; 656                   TIM1_OCPolarity_TypeDef TIM1_OCPolarity,
1562                     ; 657                   TIM1_OCNPolarity_TypeDef TIM1_OCNPolarity,
1562                     ; 658                   TIM1_OCIdleState_TypeDef TIM1_OCIdleState,
1562                     ; 659                   TIM1_OCNIdleState_TypeDef TIM1_OCNIdleState)
1562                     ; 660 {
1563                     	switch	.text
...
1571                     ; 663   assert_param(IS_TIM1_OC_MODE(TIM1_OCMode));
1573                     ; 664   assert_param(IS_TIM1_OUTPUT_STATE(TIM1_OutputState));
1575                     ; 665   assert_param(IS_TIM1_OUTPUTN_STATE(TIM1_OutputNState));
1577                     ; 666   assert_param(IS_TIM1_OC_POLARITY(TIM1_OCPolarity));
1579                     ; 667   assert_param(IS_TIM1_OCN_POLARITY(TIM1_OCNPolarity));
1581                     ; 668   assert_param(IS_TIM1_OCIDLE_STATE(TIM1_OCIdleState));
1583                     ; 669   assert_param(IS_TIM1_OCNIDLE_STATE(TIM1_OCNIdleState));
1585                     ; 673   TIM1->CCER1 &= (uint8_t)(~(TIM1_CCER1_CC2E | TIM1_CCER1_CC2NE | TIM1_CCER1_CC2P | TIM1_CCER1_CC2NP));
1587  01dc c652bd        	ld	a,21181
1588  01df a40f          	and	a,#15
1589  01e1 c752bd        	ld	21181,a
1590                     ; 676   TIM1->CCER1 |= (uint8_t)((uint8_t)((uint8_t)(TIM1_OutputState & TIM1_CCER1_CC2E) | (uint8_t)(TIM1_OutputNState & TIM1_CCER1_CC2NE))
1590                     ; 677                            | (uint8_t) ((uint8_t)(TIM1_OCPolarity & TIM1_CCER1_CC2P) | (uint8_t)(TIM1_OCNPolarity & TIM1_CCER1_CC2NP)));
...
1608                     ; 680   TIM1->CCMR2 = (uint8_t)((uint8_t)(TIM1->CCMR2 & (uint8_t)(~TIM1_CCMR_OCM)) | (uint8_t)TIM1_OCMode);
1610  0205 c652ba        	ld	a,21178
1611  0208 a48f          	and	a,#143
1612  020a 1a04          	or	a,(OFST+1,sp)
1613  020c c752ba        	ld	21178,a
1614                     ; 683   TIM1->OISR &= (uint8_t)(~(TIM1_OISR_OIS2 | TIM1_OISR_OIS2N));
1616  020f c652d0        	ld	a,21200
1617  0212 a4f3          	and	a,#243
1618  0214 c752d0        	ld	21200,a
1619                     ; 685   TIM1->OISR |= (uint8_t)((uint8_t)(TIM1_OISR_OIS2 & TIM1_OCIdleState) | (uint8_t)(TIM1_OISR_OIS2N & TIM1_OCNIdleState));
...
1629                     ; 688   TIM1->CCR2H = (uint8_t)(TIM1_Pulse >> 8);
1631  0229 7b09          	ld	a,(OFST+6,sp)
1632  022b c752c8        	ld	21192,a
1633                     ; 689   TIM1->CCR2L = (uint8_t)(TIM1_Pulse);
1635  022e 7b0a          	ld	a,(OFST+7,sp)
1636  0230 c752c9        	ld	21193,a
1637                     ; 690 }
1640  0233 5b05          	addw	sp,#5
1641  0235 81            	ret
1745                     ; 729 void TIM1_OC3Init(TIM1_OCMode_TypeDef TIM1_OCMode,
1745                     ; 730                   TIM1_OutputState_TypeDef TIM1_OutputState,
1745                     ; 731                   TIM1_OutputNState_TypeDef TIM1_OutputNState,
1745                     ; 732                   uint16_t TIM1_Pulse,
1745                     ; 733                   TIM1_OCPolarity_TypeDef TIM1_OCPolarity,
1745                     ; 734                   TIM1_OCNPolarity_TypeDef TIM1_OCNPolarity,
1745                     ; 735                   TIM1_OCIdleState_TypeDef TIM1_OCIdleState,
1745                     ; 736                   TIM1_OCNIdleState_TypeDef TIM1_OCNIdleState)
1745                     ; 737 {
1746                     	switch	.text
...
1754                     ; 740   assert_param(IS_TIM1_OC_MODE(TIM1_OCMode));
1756                     ; 741   assert_param(IS_TIM1_OUTPUT_STATE(TIM1_OutputState));
1758                     ; 742   assert_param(IS_TIM1_OUTPUTN_STATE(TIM1_OutputNState));
1760                     ; 743   assert_param(IS_TIM1_OC_POLARITY(TIM1_OCPolarity));
1762                     ; 744   assert_param(IS_TIM1_OCN_POLARITY(TIM1_OCNPolarity));
1764                     ; 745   assert_param(IS_TIM1_OCIDLE_STATE(TIM1_OCIdleState));
1766                     ; 746   assert_param(IS_TIM1_OCNIDLE_STATE(TIM1_OCNIdleState));
1768                     ; 750   TIM1->CCER2 &= (uint8_t)(~( TIM1_CCER2_CC3E | TIM1_CCER2_CC3NE | TIM1_CCER2_CC3P | TIM1_CCER2_CC3NP));
1770  0239 c652be        	ld	a,21182
1771  023c a4f0          	and	a,#240
1772  023e c752be        	ld	21182,a
1773                     ; 753   TIM1->CCER2 |= (uint8_t)((uint8_t)((uint8_t)(TIM1_OutputState & TIM1_CCER2_CC3E) | (uint8_t)(TIM1_OutputNState & TIM1_CCER2_CC3NE))
1773                     ; 754                            | (uint8_t)((uint8_t)(TIM1_OCPolarity & TIM1_CCER2_CC3P) | (uint8_t)(TIM1_OCNPolarity & TIM1_CCER2_CC3NP)));
...
1791                     ; 757   TIM1->CCMR3 = (uint8_t)((uint8_t)(TIM1->CCMR3 & (uint8_t)(~TIM1_CCMR_OCM)) | (uint8_t)TIM1_OCMode);
1793  0262 c652bb        	ld	a,21179
1794  0265 a48f          	and	a,#143
1795  0267 1a04          	or	a,(OFST+1,sp)
1796  0269 c752bb        	ld	21179,a
1797                     ; 760   TIM1->OISR &= (uint8_t)(~(TIM1_OISR_OIS3 | TIM1_OISR_OIS3N));
1799  026c c652d0        	ld	a,21200
1800  026f a4cf          	and	a,#207
1801  0271 c752d0        	ld	21200,a
1802                     ; 762   TIM1->OISR |= (uint8_t)((uint8_t)(TIM1_OISR_OIS3 & TIM1_OCIdleState) | (uint8_t) (TIM1_OISR_OIS3N & TIM1_OCNIdleState));
...
1812                     ; 765   TIM1->CCR3H = (uint8_t)(TIM1_Pulse >> 8);
1814  0286 7b09          	ld	a,(OFST+6,sp)
1815  0288 c752ca        	ld	21194,a
1816                     ; 766   TIM1->CCR3L = (uint8_t)(TIM1_Pulse);
1818  028b 7b0a          	ld	a,(OFST+7,sp)
1819  028d c752cb        	ld	21195,a
1820                     ; 767 }
1823  0290 5b05          	addw	sp,#5
1824  0292 81            	ret
2031                     ; 797 void TIM1_BDTRConfig(TIM1_OSSIState_TypeDef TIM1_OSSIState,
2031                     ; 798                      TIM1_LockLevel_TypeDef TIM1_LockLevel,
2031                     ; 799                      uint8_t TIM1_DeadTime,
2031                     ; 800                      TIM1_BreakState_TypeDef TIM1_Break,
2031                     ; 801                      TIM1_BreakPolarity_TypeDef TIM1_BreakPolarity,
2031                     ; 802                      TIM1_AutomaticOutput_TypeDef TIM1_AutomaticOutput)
2031                     ; 803 {
2032                     	switch	.text
...
2040                     ; 806   assert_param(IS_TIM1_OSSI_STATE(TIM1_OSSIState));
2042                     ; 807   assert_param(IS_TIM1_LOCK_LEVEL(TIM1_LockLevel));
2044                     ; 808   assert_param(IS_TIM1_BREAK_STATE(TIM1_Break));
2046                     ; 809   assert_param(IS_TIM1_BREAK_POLARITY(TIM1_BreakPolarity));
2048                     ; 810   assert_param(IS_TIM1_AUTOMATIC_OUTPUT_STATE(TIM1_AutomaticOutput));
2050                     ; 812   TIM1->DTR = (uint8_t)(TIM1_DeadTime);
2052  0295 7b06          	ld	a,(OFST+5,sp)
2053  0297 c752cf        	ld	21199,a
2054                     ; 816   TIM1->BKR  =  (uint8_t)((uint8_t)((uint8_t)TIM1_OSSIState | (uint8_t)TIM1_LockLevel)
2054                     ; 817                           | (uint8_t)((uint8_t)((uint8_t)TIM1_Break | (uint8_t)TIM1_BreakPolarity)
2054                     ; 818                                       | (uint8_t)TIM1_AutomaticOutput));
...
2068  02ac 81            	ret
2104                     ; 828 void TIM1_CtrlPWMOutputs(FunctionalState NewState)
2104                     ; 829 {
2105                     	switch	.text
2106  02ad               _TIM1_CtrlPWMOutputs:
2110                     ; 831   assert_param(IS_FUNCTIONAL_STATE(NewState));
2112                     ; 835   if (NewState != DISABLE)
2114  02ad 4d            	tnz	a
2115  02ae 2706          	jreq	L5601
2116                     ; 837     TIM1->BKR |= TIM1_BKR_MOE;
2118  02b0 721e52ce      	bset	21198,#7
2120  02b4 2004          	jra	L7601
2121  02b6               L5601:
2122                     ; 841     TIM1->BKR &= (uint8_t)(~TIM1_BKR_MOE);
2124  02b6 721f52ce      	bres	21198,#7
2125  02ba               L7601:
2126                     ; 843 }
2129  02ba 81            	ret
2208                     ; 865 void TIM1_SelectOCxM(TIM1_Channel_TypeDef TIM1_Channel, TIM1_OCMode_TypeDef TIM1_OCMode)
2208                     ; 866 {
2209                     	switch	.text
2210  02bb               _TIM1_SelectOCxM:
2212  02bb 89            	pushw	x
2213       00000000      OFST:	set	0
2216                     ; 868   assert_param(IS_TIM1_CHANNEL(TIM1_Channel));
2218                     ; 869   assert_param(IS_TIM1_OCM(TIM1_OCMode));
2220                     ; 871   if (TIM1_Channel == TIM1_Channel_1)
2222  02bc 9e            	ld	a,xh
2223  02bd 4d            	tnz	a
2224  02be 2610          	jrne	L7211
2225                     ; 874     TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC1E);
2227  02c0 721152bd      	bres	21181,#0
2228                     ; 877     TIM1->CCMR1 = (uint8_t)((uint8_t)(TIM1->CCMR1 & (uint8_t)(~TIM1_CCMR_OCM)) | (uint8_t)TIM1_OCMode);
...
2236  02d0               L7211:
2237                     ; 879   else if (TIM1_Channel == TIM1_Channel_2)
2239  02d0 7b01          	ld	a,(OFST+1,sp)
2240  02d2 a101          	cp	a,#1
2241  02d4 2610          	jrne	L3311
2242                     ; 882     TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC2E);
2244  02d6 721952bd      	bres	21181,#4
2245                     ; 885     TIM1->CCMR2 = (uint8_t)((uint8_t)(TIM1->CCMR2 & (uint8_t)(~TIM1_CCMR_OCM)) | (uint8_t)TIM1_OCMode);
...
2253  02e6               L3311:
2254                     ; 890     TIM1->CCER2 &= (uint8_t)(~TIM1_CCER2_CC3E);
2256  02e6 721152be      	bres	21182,#0
2257                     ; 893     TIM1->CCMR3 = (uint8_t)((uint8_t)(TIM1->CCMR3 & (uint8_t)(~TIM1_CCMR_OCM)) | (uint8_t)TIM1_OCMode);
...
2267  02f4 85            	popw	x
2268  02f5 81            	ret
2302                     ; 904 void TIM1_SetCompare1(uint16_t Compare1)
2302                     ; 905 {
2303                     	switch	.text
2304  02f6               _TIM1_SetCompare1:
2308                     ; 907   TIM1->CCR1H = (uint8_t)(Compare1 >> 8);
2310  02f6 9e            	ld	a,xh
2311  02f7 c752c6        	ld	21190,a
2312                     ; 908   TIM1->CCR1L = (uint8_t)(Compare1);
2314  02fa 9f            	ld	a,xl
2315  02fb c752c7        	ld	21191,a
2316                     ; 910 }
2319  02fe 81            	ret
2353                     ; 918 void TIM1_SetCompare2(uint16_t Compare2)
2353                     ; 919 {
2354                     	switch	.text
2355  02ff               _TIM1_SetCompare2:
2359                     ; 921   TIM1->CCR2H = (uint8_t)(Compare2 >> 8);
2361  02ff 9e            	ld	a,xh
2362  0300 c752c8        	ld	21192,a
2363                     ; 922   TIM1->CCR2L = (uint8_t)(Compare2);
2365  0303 9f            	ld	a,xl
2366  0304 c752c9        	ld	21193,a
2367                     ; 923 }
2370  0307 81            	ret
2404                     ; 931 void TIM1_SetCompare3(uint16_t Compare3)
2404                     ; 932 {
2405                     	switch	.text
2406  0308               _TIM1_SetCompare3:
2410                     ; 934   TIM1->CCR3H = (uint8_t)(Compare3 >> 8);
2412  0308 9e            	ld	a,xh
2413  0309 c752ca        	ld	21194,a
2414                     ; 935   TIM1->CCR3L = (uint8_t)(Compare3);
2416  030c 9f            	ld	a,xl
2417  030d c752cb        	ld	21195,a
2418                     ; 936 }
2421  0310 81            	ret
2455                     ; 944 void TIM1_SetCompare4(uint16_t Compare4)
2455                     ; 945 {
2456                     	switch	.text
2457  0311               _TIM1_SetCompare4:
2461                     ; 947   TIM1->CCR4H = (uint8_t)(Compare4 >> 8);
2463  0311 9e            	ld	a,xh
2464  0312 c752cc        	ld	21196,a
2465                     ; 948   TIM1->CCR4L = (uint8_t)(Compare4);
2467  0315 9f            	ld	a,xl
2468  0316 c752cd        	ld	21197,a
2469                     ; 949 }
2472  0319 81            	ret
2508                     ; 957 void TIM1_CCPreloadControl(FunctionalState NewState)
2508                     ; 958 {
2509                     	switch	.text
2510  031a               _TIM1_CCPreloadControl:
2514                     ; 960   assert_param(IS_FUNCTIONAL_STATE(NewState));
2516                     ; 963   if (NewState != DISABLE)
2518  031a 4d            	tnz	a
2519  031b 2706          	jreq	L5421
2520                     ; 965     TIM1->CR2 |= TIM1_CR2_CCPC;
2522  031d 721052b1      	bset	21169,#0
2524  0321 2004          	jra	L7421
2525  0323               L5421:
2526                     ; 969     TIM1->CR2 &= (uint8_t)(~TIM1_CR2_CCPC);
2528  0323 721152b1      	bres	21169,#0
2529  0327               L7421:
2530                     ; 971 }
2533  0327 81            	ret
2591                     ; 981 void TIM1_ForcedOC1Config(TIM1_ForcedAction_TypeDef TIM1_ForcedAction)
2591                     ; 982 {
2592                     	switch	.text
2593  0328               _TIM1_ForcedOC1Config:
2595  0328 88            	push	a
2596       00000000      OFST:	set	0
2599                     ; 984   assert_param(IS_TIM1_FORCED_ACTION(TIM1_ForcedAction));
2601                     ; 987   TIM1->CCMR1 =  (uint8_t)((uint8_t)(TIM1->CCMR1 & (uint8_t)(~TIM1_CCMR_OCM)) | (uint8_t)TIM1_ForcedAction);
...
2610  0333 84            	pop	a
2611  0334 81            	ret
2647                     ; 998 void TIM1_ForcedOC2Config(TIM1_ForcedAction_TypeDef TIM1_ForcedAction)
2647                     ; 999 {
2648                     	switch	.text
2649  0335               _TIM1_ForcedOC2Config:
2651  0335 88            	push	a
2652       00000000      OFST:	set	0
2655                     ; 1001   assert_param(IS_TIM1_FORCED_ACTION(TIM1_ForcedAction));
2657                     ; 1004   TIM1->CCMR2  =  (uint8_t)((uint8_t)(TIM1->CCMR2 & (uint8_t)(~TIM1_CCMR_OCM)) | (uint8_t)TIM1_ForcedAction);
...
2666  0340 84            	pop	a
2667  0341 81            	ret
2703                     ; 1015 void TIM1_ForcedOC3Config(TIM1_ForcedAction_TypeDef TIM1_ForcedAction)
2703                     ; 1016 {
2704                     	switch	.text
2705  0342               _TIM1_ForcedOC3Config:
2707  0342 88            	push	a
2708       00000000      OFST:	set	0
2711                     ; 1018   assert_param(IS_TIM1_FORCED_ACTION(TIM1_ForcedAction));
2713                     ; 1021   TIM1->CCMR3 = (uint8_t)((uint8_t)(TIM1->CCMR3 & (uint8_t)(~TIM1_CCMR_OCM)) | (uint8_t)TIM1_ForcedAction);
...
2722  034d 84            	pop	a
2723  034e 81            	ret
2759                     ; 1030 void TIM1_OC1PreloadConfig(FunctionalState NewState)
2759                     ; 1031 {
2760                     	switch	.text
2761  034f               _TIM1_OC1PreloadConfig:
2765                     ; 1033   assert_param(IS_FUNCTIONAL_STATE(NewState));
2767                     ; 1036   if (NewState != DISABLE)
2769  034f 4d            	tnz	a
2770  0350 2706          	jreq	L1531
2771                     ; 1038     TIM1->CCMR1 |= TIM1_CCMR_OCxPE;
2773  0352 721652b9      	bset	21177,#3
2775  0356 2004          	jra	L3531
2776  0358               L1531:
2777                     ; 1042     TIM1->CCMR1 &= (uint8_t)(~TIM1_CCMR_OCxPE);
2779  0358 721752b9      	bres	21177,#3
2780  035c               L3531:
2781                     ; 1044 }
2784  035c 81            	ret
2820                     ; 1052 void TIM1_OC2PreloadConfig(FunctionalState NewState)
2820                     ; 1053 {
2821                     	switch	.text
2822  035d               _TIM1_OC2PreloadConfig:
2826                     ; 1055   assert_param(IS_FUNCTIONAL_STATE(NewState));
2828                     ; 1058   if (NewState != DISABLE)
2830  035d 4d            	tnz	a
2831  035e 2706          	jreq	L3731
2832                     ; 1060     TIM1->CCMR2 |= TIM1_CCMR_OCxPE;
2834  0360 721652ba      	bset	21178,#3
2836  0364 2004          	jra	L5731
2837  0366               L3731:
2838                     ; 1064     TIM1->CCMR2 &= (uint8_t)(~TIM1_CCMR_OCxPE);
2840  0366 721752ba      	bres	21178,#3
2841  036a               L5731:
2842                     ; 1066 }
2845  036a 81            	ret
2881                     ; 1074 void TIM1_OC3PreloadConfig(FunctionalState NewState)
2881                     ; 1075 {
2882                     	switch	.text
2883  036b               _TIM1_OC3PreloadConfig:
2887                     ; 1077   assert_param(IS_FUNCTIONAL_STATE(NewState));
2889                     ; 1080   if (NewState != DISABLE)
2891  036b 4d            	tnz	a
2892  036c 2706          	jreq	L5141
2893                     ; 1082     TIM1->CCMR3 |= TIM1_CCMR_OCxPE;
2895  036e 721652bb      	bset	21179,#3
2897  0372 2004          	jra	L7141
2898  0374               L5141:
2899                     ; 1086     TIM1->CCMR3 &= (uint8_t)(~TIM1_CCMR_OCxPE);
2901  0374 721752bb      	bres	21179,#3
2902  0378               L7141:
2903                     ; 1088 }
2906  0378 81            	ret
2942                     ; 1096 void TIM1_OC4PreloadConfig(FunctionalState NewState)
2942                     ; 1097 {
2943                     	switch	.text
2944  0379               _TIM1_OC4PreloadConfig:
2948                     ; 1099   assert_param(IS_FUNCTIONAL_STATE(NewState));
2950                     ; 1102   if (NewState != DISABLE)
2952  0379 4d            	tnz	a
2953  037a 2706          	jreq	L7341
2954                     ; 1104     TIM1->CCMR4 |= TIM1_CCMR_OCxPE;
2956  037c 721652bc      	bset	21180,#3
2958  0380 2004          	jra	L1441
2959  0382               L7341:
2960                     ; 1108     TIM1->CCMR4 &= (uint8_t)(~TIM1_CCMR_OCxPE);
2962  0382 721752bc      	bres	21180,#3
2963  0386               L1441:
2964                     ; 1110 }
2967  0386 81            	ret
3002                     ; 1118 void TIM1_OC1FastConfig(FunctionalState NewState)
3002                     ; 1119 {
3003                     	switch	.text
3004  0387               _TIM1_OC1FastConfig:
3008                     ; 1121   assert_param(IS_FUNCTIONAL_STATE(NewState));
3010                     ; 1124   if (NewState != DISABLE)
3012  0387 4d            	tnz	a
3013  0388 2706          	jreq	L1641
3014                     ; 1126     TIM1->CCMR1 |= TIM1_CCMR_OCxFE;
3016  038a 721452b9      	bset	21177,#2
3018  038e 2004          	jra	L3641
3019  0390               L1641:
3020                     ; 1130     TIM1->CCMR1 &= (uint8_t)(~TIM1_CCMR_OCxFE);
3022  0390 721552b9      	bres	21177,#2
3023  0394               L3641:
3024                     ; 1132 }
3027  0394 81            	ret
3062                     ; 1140 void TIM1_OC2FastConfig(FunctionalState NewState)
3062                     ; 1141 {
3063                     	switch	.text
3064  0395               _TIM1_OC2FastConfig:
3068                     ; 1143   assert_param(IS_FUNCTIONAL_STATE(NewState));
3070                     ; 1146   if (NewState != DISABLE)
3072  0395 4d            	tnz	a
3073  0396 2706          	jreq	L3051
3074                     ; 1148     TIM1->CCMR2 |= TIM1_CCMR_OCxFE;
3076  0398 721452ba      	bset	21178,#2
3078  039c 2004          	jra	L5051
3079  039e               L3051:
3080                     ; 1152     TIM1->CCMR2 &= (uint8_t)(~TIM1_CCMR_OCxFE);
3082  039e 721552ba      	bres	21178,#2
3083  03a2               L5051:
3084                     ; 1154 }
3087  03a2 81            	ret
3122                     ; 1162 void TIM1_OC3FastConfig(FunctionalState NewState)
3122                     ; 1163 {
3123                     	switch	.text
3124  03a3               _TIM1_OC3FastConfig:
3128                     ; 1165   assert_param(IS_FUNCTIONAL_STATE(NewState));
3130                     ; 1168   if (NewState != DISABLE)
3132  03a3 4d            	tnz	a
3133  03a4 2706          	jreq	L5251
3134                     ; 1170     TIM1->CCMR3 |= TIM1_CCMR_OCxFE;
3136  03a6 721452bb      	bset	21179,#2
3138  03aa 2004          	jra	L7251
3139  03ac               L5251:
3140                     ; 1174     TIM1->CCMR3 &= (uint8_t)(~TIM1_CCMR_OCxFE);
3142  03ac 721552bb      	bres	21179,#2
3143  03b0               L7251:
3144                     ; 1176 }
3147  03b0 81            	ret
3182                     ; 1184 void TIM1_ClearOC1Ref(FunctionalState NewState)
3182                     ; 1185 {
3183                     	switch	.text
3184  03b1               _TIM1_ClearOC1Ref:
3188                     ; 1187   assert_param(IS_FUNCTIONAL_STATE(NewState));
3190                     ; 1190   if (NewState != DISABLE)
3192  03b1 4d            	tnz	a
3193  03b2 2706          	jreq	L7451
3194                     ; 1192     TIM1->CCMR1 |= TIM1_CCMR_OCxCE;
3196  03b4 721e52b9      	bset	21177,#7
3198  03b8 2004          	jra	L1551
3199  03ba               L7451:
3200                     ; 1196     TIM1->CCMR1 &= (uint8_t)(~TIM1_CCMR_OCxCE);
3202  03ba 721f52b9      	bres	21177,#7
3203  03be               L1551:
3204                     ; 1198 }
3207  03be 81            	ret
3242                     ; 1206 void TIM1_ClearOC2Ref(FunctionalState NewState)
3242                     ; 1207 {
3243                     	switch	.text
3244  03bf               _TIM1_ClearOC2Ref:
3248                     ; 1209   assert_param(IS_FUNCTIONAL_STATE(NewState));
3250                     ; 1212   if (NewState != DISABLE)
3252  03bf 4d            	tnz	a
3253  03c0 2706          	jreq	L1751
3254                     ; 1214     TIM1->CCMR2 |= TIM1_CCMR_OCxCE;
3256  03c2 721e52ba      	bset	21178,#7
3258  03c6 2004          	jra	L3751
3259  03c8               L1751:
3260                     ; 1218     TIM1->CCMR2 &= (uint8_t)(~TIM1_CCMR_OCxCE);
3262  03c8 721f52ba      	bres	21178,#7
3263  03cc               L3751:
3264                     ; 1220 }
3267  03cc 81            	ret
3302                     ; 1228 void TIM1_ClearOC3Ref(FunctionalState NewState)
3302                     ; 1229 {
3303                     	switch	.text
3304  03cd               _TIM1_ClearOC3Ref:
3308                     ; 1231   assert_param(IS_FUNCTIONAL_STATE(NewState));
3310                     ; 1234   if (NewState != DISABLE)
3312  03cd 4d            	tnz	a
3313  03ce 2706          	jreq	L3161
3314                     ; 1236     TIM1->CCMR3 |= TIM1_CCMR_OCxCE;
3316  03d0 721e52bb      	bset	21179,#7
3318  03d4 2004          	jra	L5161
3319  03d6               L3161:
3320                     ; 1240     TIM1->CCMR3 &= (uint8_t)(~TIM1_CCMR_OCxCE);
3322  03d6 721f52bb      	bres	21179,#7
3323  03da               L5161:
3324                     ; 1242 }
3327  03da 81            	ret
3362                     ; 1250 void TIM1_ClearOC4Ref(FunctionalState NewState)
3362                     ; 1251 {
3363                     	switch	.text
3364  03db               _TIM1_ClearOC4Ref:
3368                     ; 1253   assert_param(IS_FUNCTIONAL_STATE(NewState));
3370                     ; 1256   if (NewState != DISABLE)
3372  03db 4d            	tnz	a
3373  03dc 2706          	jreq	L5361
3374                     ; 1258     TIM1->CCMR4 |= TIM1_CCMR_OCxCE;
3376  03de 721e52bc      	bset	21180,#7
3378  03e2 2004          	jra	L7361
3379  03e4               L5361:
3380                     ; 1262     TIM1->CCMR4 &= (uint8_t)(~TIM1_CCMR_OCxCE);
3382  03e4 721f52bc      	bres	21180,#7
3383  03e8               L7361:
3384                     ; 1264 }
3387  03e8 81            	ret
3423                     ; 1274 void TIM1_OC1PolarityConfig(TIM1_OCPolarity_TypeDef TIM1_OCPolarity)
3423                     ; 1275 {
3424                     	switch	.text
3425  03e9               _TIM1_OC1PolarityConfig:
3429                     ; 1277   assert_param(IS_TIM1_OC_POLARITY(TIM1_OCPolarity));
3431                     ; 1280   if (TIM1_OCPolarity != TIM1_OCPolarity_High)
3433  03e9 4d            	tnz	a
3434  03ea 2706          	jreq	L7561
3435                     ; 1282     TIM1->CCER1 |= TIM1_CCER1_CC1P;
3437  03ec 721252bd      	bset	21181,#1
3439  03f0 2004          	jra	L1661
3440  03f2               L7561:
3441                     ; 1286     TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC1P);
3443  03f2 721352bd      	bres	21181,#1
3444  03f6               L1661:
3445                     ; 1288 }
3448  03f6 81            	ret
3484                     ; 1298 void TIM1_OC1NPolarityConfig(TIM1_OCNPolarity_TypeDef TIM1_OCNPolarity)
3484                     ; 1299 {
3485                     	switch	.text
3486  03f7               _TIM1_OC1NPolarityConfig:
3490                     ; 1301   assert_param(IS_TIM1_OCN_POLARITY(TIM1_OCNPolarity));
3492                     ; 1304   if (TIM1_OCNPolarity != TIM1_OCNPolarity_High)
3494  03f7 4d            	tnz	a
3495  03f8 2706          	jreq	L1071
3496                     ; 1306     TIM1->CCER1 |= TIM1_CCER1_CC1NP;
3498  03fa 721652bd      	bset	21181,#3
3500  03fe 2004          	jra	L3071
3501  0400               L1071:
3502                     ; 1310     TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC1NP);
3504  0400 721752bd      	bres	21181,#3
3505  0404               L3071:
3506                     ; 1312 }
3509  0404 81            	ret
3545                     ; 1322 void TIM1_OC2PolarityConfig(TIM1_OCPolarity_TypeDef TIM1_OCPolarity)
3545                     ; 1323 {
3546                     	switch	.text
3547  0405               _TIM1_OC2PolarityConfig:
3551                     ; 1325   assert_param(IS_TIM1_OC_POLARITY(TIM1_OCPolarity));
3553                     ; 1328   if (TIM1_OCPolarity != TIM1_OCPolarity_High)
3555  0405 4d            	tnz	a
3556  0406 2706          	jreq	L3271
3557                     ; 1330     TIM1->CCER1 |= TIM1_CCER1_CC2P;
3559  0408 721a52bd      	bset	21181,#5
3561  040c 2004          	jra	L5271
3562  040e               L3271:
3563                     ; 1334     TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC2P);
3565  040e 721b52bd      	bres	21181,#5
3566  0412               L5271:
3567                     ; 1336 }
3570  0412 81            	ret
3606                     ; 1346 void TIM1_OC2NPolarityConfig(TIM1_OCNPolarity_TypeDef TIM1_OCNPolarity)
3606                     ; 1347 {
3607                     	switch	.text
3608  0413               _TIM1_OC2NPolarityConfig:
3612                     ; 1349   assert_param(IS_TIM1_OCN_POLARITY(TIM1_OCNPolarity));
3614                     ; 1352   if (TIM1_OCNPolarity != TIM1_OCNPolarity_High)
3616  0413 4d            	tnz	a
3617  0414 2706          	jreq	L5471
3618                     ; 1354     TIM1->CCER1 |= TIM1_CCER1_CC2NP;
3620  0416 721e52bd      	bset	21181,#7
3622  041a 2004          	jra	L7471
3623  041c               L5471:
3624                     ; 1358     TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC2NP);
3626  041c 721f52bd      	bres	21181,#7
3627  0420               L7471:
3628                     ; 1360 }
3631  0420 81            	ret
3667                     ; 1370 void TIM1_OC3PolarityConfig(TIM1_OCPolarity_TypeDef TIM1_OCPolarity)
3667                     ; 1371 {
3668                     	switch	.text
3669  0421               _TIM1_OC3PolarityConfig:
3673                     ; 1373   assert_param(IS_TIM1_OC_POLARITY(TIM1_OCPolarity));
3675                     ; 1376   if (TIM1_OCPolarity != TIM1_OCPolarity_High)
3677  0421 4d            	tnz	a
3678  0422 2706          	jreq	L7671
3679                     ; 1378     TIM1->CCER2 |= TIM1_CCER2_CC3P;
3681  0424 721252be      	bset	21182,#1
3683  0428 2004          	jra	L1771
3684  042a               L7671:
3685                     ; 1382     TIM1->CCER2 &= (uint8_t)(~TIM1_CCER2_CC3P);
3687  042a 721352be      	bres	21182,#1
3688  042e               L1771:
3689                     ; 1384 }
3692  042e 81            	ret
3728                     ; 1394 void TIM1_OC3NPolarityConfig(TIM1_OCNPolarity_TypeDef TIM1_OCNPolarity)
3728                     ; 1395 {
3729                     	switch	.text
3730  042f               _TIM1_OC3NPolarityConfig:
3734                     ; 1397   assert_param(IS_TIM1_OCN_POLARITY(TIM1_OCNPolarity));
3736                     ; 1400   if (TIM1_OCNPolarity != TIM1_OCNPolarity_High)
3738  042f 4d            	tnz	a
3739  0430 2706          	jreq	L1102
3740                     ; 1402     TIM1->CCER2 |= TIM1_CCER2_CC3NP;
3742  0432 721652be      	bset	21182,#3
3744  0436 2004          	jra	L3102
3745  0438               L1102:
3746                     ; 1406     TIM1->CCER2 &= (uint8_t)(~TIM1_CCER2_CC3NP);
3748  0438 721752be      	bres	21182,#3
3749  043c               L3102:
3750                     ; 1408 }
3753  043c 81            	ret
3812                     ; 1418 void TIM1_SelectOCREFClear(TIM1_OCReferenceClear_TypeDef TIM1_OCReferenceClear)
3812                     ; 1419 {
3813                     	switch	.text
3814  043d               _TIM1_SelectOCREFClear:
3818                     ; 1421   assert_param(IS_TIM1_OCREFERENCECECLEAR_SOURCE(TIM1_OCReferenceClear));
3820                     ; 1424   TIM1->SMCR &=  (uint8_t) (~TIM1_SMCR_OCCS);
3822  043d 721752b2      	bres	21170,#3
3823                     ; 1425   TIM1->SMCR |=  (uint8_t) TIM1_OCReferenceClear;
3825  0441 ca52b2        	or	a,21170
3826  0444 c752b2        	ld	21170,a
3827                     ; 1426 }
3830  0447 81            	ret
3865                     ; 1434 void TIM1_SelectCOM(FunctionalState NewState)
3865                     ; 1435 {
3866                     	switch	.text
3867  0448               _TIM1_SelectCOM:
3871                     ; 1437   assert_param(IS_FUNCTIONAL_STATE(NewState));
3873                     ; 1440   if (NewState != DISABLE)
3875  0448 4d            	tnz	a
3876  0449 2706          	jreq	L1602
3877                     ; 1442     TIM1->CR2 |= TIM1_CR2_CCUS;
3879  044b 721452b1      	bset	21169,#2
3881  044f 2004          	jra	L3602
3882  0451               L1602:
3883                     ; 1446     TIM1->CR2 &= (uint8_t)(~TIM1_CR2_CCUS);
3885  0451 721552b1      	bres	21169,#2
3886  0455               L3602:
3887                     ; 1448 }
3890  0455 81            	ret
3935                     ; 1462 void TIM1_CCxCmd(TIM1_Channel_TypeDef TIM1_Channel, FunctionalState NewState)
3935                     ; 1463 {
3936                     	switch	.text
3937  0456               _TIM1_CCxCmd:
3939  0456 89            	pushw	x
3940       00000000      OFST:	set	0
3943                     ; 1465   assert_param(IS_TIM1_CHANNEL(TIM1_Channel));
3945                     ; 1466   assert_param(IS_FUNCTIONAL_STATE(NewState));
3947                     ; 1468   if (TIM1_Channel == TIM1_Channel_1)
3949  0457 9e            	ld	a,xh
3950  0458 4d            	tnz	a
3951  0459 2610          	jrne	L7012
3952                     ; 1471     if (NewState != DISABLE)
3954  045b 9f            	ld	a,xl
3955  045c 4d            	tnz	a
3956  045d 2706          	jreq	L1112
3957                     ; 1473       TIM1->CCER1 |= TIM1_CCER1_CC1E;
3959  045f 721052bd      	bset	21181,#0
3961  0463 2040          	jra	L5112
3962  0465               L1112:
3963                     ; 1477       TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC1E);
3965  0465 721152bd      	bres	21181,#0
3966  0469 203a          	jra	L5112
3967  046b               L7012:
3968                     ; 1480   else if (TIM1_Channel == TIM1_Channel_2)
3970  046b 7b01          	ld	a,(OFST+1,sp)
3971  046d a101          	cp	a,#1
3972  046f 2610          	jrne	L7112
3973                     ; 1483     if (NewState != DISABLE)
3975  0471 0d02          	tnz	(OFST+2,sp)
3976  0473 2706          	jreq	L1212
3977                     ; 1485       TIM1->CCER1 |= TIM1_CCER1_CC2E;
3979  0475 721852bd      	bset	21181,#4
3981  0479 202a          	jra	L5112
3982  047b               L1212:
3983                     ; 1489       TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC2E);
3985  047b 721952bd      	bres	21181,#4
3986  047f 2024          	jra	L5112
3987  0481               L7112:
3988                     ; 1492   else if (TIM1_Channel == TIM1_Channel_3)
3990  0481 7b01          	ld	a,(OFST+1,sp)
3991  0483 a102          	cp	a,#2
3992  0485 2610          	jrne	L7212
3993                     ; 1495     if (NewState != DISABLE)
3995  0487 0d02          	tnz	(OFST+2,sp)
3996  0489 2706          	jreq	L1312
3997                     ; 1497       TIM1->CCER2 |= TIM1_CCER2_CC3E;
3999  048b 721052be      	bset	21182,#0
4001  048f 2014          	jra	L5112
4002  0491               L1312:
4003                     ; 1501       TIM1->CCER2 &= (uint8_t)(~TIM1_CCER2_CC3E);
4005  0491 721152be      	bres	21182,#0
4006  0495 200e          	jra	L5112
4007  0497               L7212:
4008                     ; 1507     if (NewState != DISABLE)
4010  0497 0d02          	tnz	(OFST+2,sp)
4011  0499 2706          	jreq	L7312
4012                     ; 1509       TIM1->CCER2 |= TIM1_CCER2_CC4E;
4014  049b 721852be      	bset	21182,#4
4016  049f 2004          	jra	L5112
4017  04a1               L7312:
4018                     ; 1513       TIM1->CCER2 &= (uint8_t)(~TIM1_CCER2_CC4E);
4020  04a1 721952be      	bres	21182,#4
4021  04a5               L5112:
4022                     ; 1516 }
4025  04a5 85            	popw	x
4026  04a6 81            	ret
4071                     ; 1529 void TIM1_CCxNCmd(TIM1_Channel_TypeDef TIM1_Channel, FunctionalState NewState)
4071                     ; 1530 {
4072                     	switch	.text
4073  04a7               _TIM1_CCxNCmd:
4075  04a7 89            	pushw	x
4076       00000000      OFST:	set	0
4079                     ; 1532   assert_param(IS_TIM1_COMPLEMENTARY_CHANNEL(TIM1_Channel));
4081                     ; 1533   assert_param(IS_FUNCTIONAL_STATE(NewState));
4083                     ; 1535   if (TIM1_Channel == TIM1_Channel_1)
4085  04a8 9e            	ld	a,xh
4086  04a9 4d            	tnz	a
4087  04aa 2610          	jrne	L5612
4088                     ; 1538     if (NewState != DISABLE)
4090  04ac 9f            	ld	a,xl
4091  04ad 4d            	tnz	a
4092  04ae 2706          	jreq	L7612
4093                     ; 1540       TIM1->CCER1 |= TIM1_CCER1_CC1NE;
4095  04b0 721452bd      	bset	21181,#2
4097  04b4 202a          	jra	L3712
4098  04b6               L7612:
4099                     ; 1544       TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC1NE);
4101  04b6 721552bd      	bres	21181,#2
4102  04ba 2024          	jra	L3712
4103  04bc               L5612:
4104                     ; 1547   else if (TIM1_Channel == TIM1_Channel_2)
4106  04bc 7b01          	ld	a,(OFST+1,sp)
4107  04be a101          	cp	a,#1
4108  04c0 2610          	jrne	L5712
4109                     ; 1550     if (NewState != DISABLE)
4111  04c2 0d02          	tnz	(OFST+2,sp)
4112  04c4 2706          	jreq	L7712
4113                     ; 1552       TIM1->CCER1 |= TIM1_CCER1_CC2NE;
4115  04c6 721c52bd      	bset	21181,#6
4117  04ca 2014          	jra	L3712
4118  04cc               L7712:
4119                     ; 1556       TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC2NE);
4121  04cc 721d52bd      	bres	21181,#6
4122  04d0 200e          	jra	L3712
4123  04d2               L5712:
4124                     ; 1562     if (NewState != DISABLE)
4126  04d2 0d02          	tnz	(OFST+2,sp)
4127  04d4 2706          	jreq	L5022
4128                     ; 1564       TIM1->CCER2 |= TIM1_CCER2_CC3NE;
4130  04d6 721452be      	bset	21182,#2
4132  04da 2004          	jra	L3712
4133  04dc               L5022:
4134                     ; 1568       TIM1->CCER2 &= (uint8_t)(~TIM1_CCER2_CC3NE);
4136  04dc 721552be      	bres	21182,#2
4137  04e0               L3712:
4138                     ; 1571 }
4141  04e0 85            	popw	x
4142  04e1 81            	ret
4310                     ; 1658 void TIM1_ICInit(TIM1_Channel_TypeDef TIM1_Channel,
4310                     ; 1659                  TIM1_ICPolarity_TypeDef TIM1_ICPolarity,
4310                     ; 1660                  TIM1_ICSelection_TypeDef TIM1_ICSelection,
4310                     ; 1661                  TIM1_ICPSC_TypeDef TIM1_ICPrescaler,
4310                     ; 1662                  uint8_t TIM1_ICFilter)
4310                     ; 1663 {
4311                     	switch	.text
4312  04e2               _TIM1_ICInit:
4314  04e2 89            	pushw	x
4315       00000000      OFST:	set	0
4318                     ; 1666   assert_param(IS_TIM1_CHANNEL(TIM1_Channel));
4320                     ; 1667   assert_param(IS_TIM1_IC_POLARITY(TIM1_ICPolarity));
4322                     ; 1668   assert_param(IS_TIM1_IC_SELECTION(TIM1_ICSelection));
4324                     ; 1669   assert_param(IS_TIM1_IC_PRESCALER(TIM1_ICPrescaler));
4326                     ; 1670   assert_param(IS_TIM1_IC_FILTER(TIM1_ICFilter));
4328                     ; 1672   if (TIM1_Channel == TIM1_Channel_1)
4330  04e3 9e            	ld	a,xh
4331  04e4 4d            	tnz	a
4332  04e5 2614          	jrne	L5032
4333                     ; 1675     TI1_Config(TIM1_ICPolarity, TIM1_ICSelection, TIM1_ICFilter);
...
4391  0527 84            	pop	a
4392                     ; 1691     TIM1_SetIC3Prescaler(TIM1_ICPrescaler);
4394  0528 7b06          	ld	a,(OFST+6,sp)
4395  052a cd068c        	call	_TIM1_SetIC3Prescaler
4398  052d 2012          	jra	L7032
4399  052f               L5132:
4400                     ; 1696     TI4_Config(TIM1_ICPolarity, TIM1_ICSelection, TIM1_ICFilter);
...
4410  053b 84            	pop	a
4411                     ; 1698     TIM1_SetIC4Prescaler(TIM1_ICPrescaler);
...
4420  0541 85            	popw	x
4421  0542 81            	ret
4519                     ; 1727 void TIM1_PWMIConfig(TIM1_Channel_TypeDef TIM1_Channel,
4519                     ; 1728                      TIM1_ICPolarity_TypeDef TIM1_ICPolarity,
4519                     ; 1729                      TIM1_ICSelection_TypeDef TIM1_ICSelection,
4519                     ; 1730                      TIM1_ICPSC_TypeDef TIM1_ICPrescaler,
4519                     ; 1731                      uint8_t TIM1_ICFilter)
4519                     ; 1732 {
4520                     	switch	.text
...
4528                     ; 1733   TIM1_ICPolarity_TypeDef icpolarity = TIM1_ICPolarity_Rising;
4530  0545 7b01          	ld	a,(OFST-1,sp)
4531  0547 97            	ld	xl,a
4532                     ; 1734   TIM1_ICSelection_TypeDef icselection = TIM1_ICSelection_DirectTI;
4534  0548 7b02          	ld	a,(OFST+0,sp)
4535  054a 97            	ld	xl,a
4536                     ; 1737   assert_param(IS_TIM1_PWMI_CHANNEL(TIM1_Channel));
4538                     ; 1738   assert_param(IS_TIM1_IC_POLARITY(TIM1_ICPolarity));
4540                     ; 1739   assert_param(IS_TIM1_IC_SELECTION(TIM1_ICSelection));
4542                     ; 1740   assert_param(IS_TIM1_IC_PRESCALER(TIM1_ICPrescaler));
4544                     ; 1743   if (TIM1_ICPolarity != TIM1_ICPolarity_Falling)
4546  054b 7b04          	ld	a,(OFST+2,sp)
4547  054d a101          	cp	a,#1
4548  054f 2706          	jreq	L7632
4549                     ; 1745     icpolarity = TIM1_ICPolarity_Falling;
4551  0551 a601          	ld	a,#1
4552  0553 6b01          	ld	(OFST-1,sp),a
4554  0555 2002          	jra	L1732
4555  0557               L7632:
4556                     ; 1749     icpolarity = TIM1_ICPolarity_Rising;
4558  0557 0f01          	clr	(OFST-1,sp)
4559  0559               L1732:
4560                     ; 1753   if (TIM1_ICSelection == TIM1_ICSelection_DirectTI)
4562  0559 7b07          	ld	a,(OFST+5,sp)
4563  055b a101          	cp	a,#1
4564  055d 2606          	jrne	L3732
4565                     ; 1755     icselection = TIM1_ICSelection_IndirectTI;
4567  055f a602          	ld	a,#2
4568  0561 6b02          	ld	(OFST+0,sp),a
4570  0563 2004          	jra	L5732
4571  0565               L3732:
4572                     ; 1759     icselection = TIM1_ICSelection_DirectTI;
4574  0565 a601          	ld	a,#1
4575  0567 6b02          	ld	(OFST+0,sp),a
4576  0569               L5732:
4577                     ; 1762   if (TIM1_Channel == TIM1_Channel_1)
4579  0569 0d03          	tnz	(OFST+1,sp)
4580  056b 2626          	jrne	L7732
4581                     ; 1765     TI1_Config(TIM1_ICPolarity, TIM1_ICSelection, TIM1_ICFilter);
...
4591  0579 84            	pop	a
4592                     ; 1768     TIM1_SetIC1Prescaler(TIM1_ICPrescaler);
4594  057a 7b08          	ld	a,(OFST+6,sp)
4595  057c cd0672        	call	_TIM1_SetIC1Prescaler
4597                     ; 1771     TI2_Config(icpolarity, icselection, TIM1_ICFilter);
...
4607  058b 84            	pop	a
4608                     ; 1774     TIM1_SetIC2Prescaler(TIM1_ICPrescaler);
4610  058c 7b08          	ld	a,(OFST+6,sp)
4611  058e cd067f        	call	_TIM1_SetIC2Prescaler
4614  0591 2024          	jra	L1042
4615  0593               L7732:
4616                     ; 1779     TI2_Config(TIM1_ICPolarity, TIM1_ICSelection, TIM1_ICFilter);
...
4626  059f 84            	pop	a
4627                     ; 1782     TIM1_SetIC2Prescaler(TIM1_ICPrescaler);
4629  05a0 7b08          	ld	a,(OFST+6,sp)
4630  05a2 cd067f        	call	_TIM1_SetIC2Prescaler
4632                     ; 1785     TI1_Config(icpolarity, icselection, TIM1_ICFilter);
...
4642  05b1 84            	pop	a
4643                     ; 1788     TIM1_SetIC1Prescaler(TIM1_ICPrescaler);
...
5063                     ; 1871   return (uint16_t)tmpccr4;
5065  066d 1e03          	ldw	x,(OFST-1,sp)
5068  066f 5b04          	addw	sp,#4
5069  0671 81            	ret
5105                     ; 1884 void TIM1_SetIC1Prescaler(TIM1_ICPSC_TypeDef TIM1_IC1Prescaler)
5105                     ; 1885 {
5106                     	switch	.text
5107  0672               _TIM1_SetIC1Prescaler:
5109  0672 88            	push	a
5110       00000000      OFST:	set	0
5113                     ; 1887   assert_param(IS_TIM1_IC_PRESCALER(TIM1_IC1Prescaler));
5115                     ; 1890   TIM1->CCMR1 = (uint8_t)((uint8_t)(TIM1->CCMR1 & (uint8_t)(~TIM1_CCMR_ICxPSC)) | (uint8_t)TIM1_IC1Prescaler);
...
5124  067d 84            	pop	a
5125  067e 81            	ret
5161                     ; 1903 void TIM1_SetIC2Prescaler(TIM1_ICPSC_TypeDef TIM1_IC2Prescaler)
5161                     ; 1904 {
5162                     	switch	.text
5163  067f               _TIM1_SetIC2Prescaler:
5165  067f 88            	push	a
5166       00000000      OFST:	set	0
5169                     ; 1906   assert_param(IS_TIM1_IC_PRESCALER(TIM1_IC2Prescaler));
5171                     ; 1909   TIM1->CCMR2 = (uint8_t)((uint8_t)(TIM1->CCMR2 & (uint8_t)(~TIM1_CCMR_ICxPSC)) | (uint8_t)TIM1_IC2Prescaler);
...
5180  068a 84            	pop	a
5181  068b 81            	ret
5217                     ; 1922 void TIM1_SetIC3Prescaler(TIM1_ICPSC_TypeDef TIM1_IC3Prescaler)
5217                     ; 1923 {
5218                     	switch	.text
5219  068c               _TIM1_SetIC3Prescaler:
5221  068c 88            	push	a
5222       00000000      OFST:	set	0
5225                     ; 1926   assert_param(IS_TIM1_IC_PRESCALER(TIM1_IC3Prescaler));
5227                     ; 1929   TIM1->CCMR3 = (uint8_t)((uint8_t)(TIM1->CCMR3 & (uint8_t)(~TIM1_CCMR_ICxPSC)) | (uint8_t)TIM1_IC3Prescaler);
...
5236  0697 84            	pop	a
5237  0698 81            	ret
5273                     ; 1942 void TIM1_SetIC4Prescaler(TIM1_ICPSC_TypeDef TIM1_IC4Prescaler)
5273                     ; 1943 {
5274                     	switch	.text
5275  0699               _TIM1_SetIC4Prescaler:
5277  0699 88            	push	a
5278       00000000      OFST:	set	0
5281                     ; 1946   assert_param(IS_TIM1_IC_PRESCALER(TIM1_IC4Prescaler));
5283                     ; 1949   TIM1->CCMR4 = (uint8_t)((uint8_t)(TIM1->CCMR4 & (uint8_t)(~TIM1_CCMR_ICxPSC)) | (uint8_t)TIM1_IC4Prescaler);
...
5292  06a4 84            	pop	a
5293  06a5 81            	ret
5400                     ; 1985 void TIM1_ITConfig(TIM1_IT_TypeDef  TIM1_IT, FunctionalState NewState)
5400                     ; 1986 {
5401                     	switch	.text
5402  06a6               _TIM1_ITConfig:
5404  06a6 89            	pushw	x
5405       00000000      OFST:	set	0
5408                     ; 1988   assert_param(IS_TIM1_IT(TIM1_IT));
5410                     ; 1989   assert_param(IS_FUNCTIONAL_STATE(NewState));
5412                     ; 1991   if (NewState != DISABLE)
5414  06a7 9f            	ld	a,xl
5415  06a8 4d            	tnz	a
5416  06a9 2709          	jreq	L1762
5417                     ; 1994     TIM1->IER |= (uint8_t)TIM1_IT;
5419  06ab 9e            	ld	a,xh
5420  06ac ca52b5        	or	a,21173
5421  06af c752b5        	ld	21173,a
5423  06b2 2009          	jra	L3762
5424  06b4               L1762:
5425                     ; 1999     TIM1->IER &= (uint8_t)(~(uint8_t)TIM1_IT);
...
5435  06bd 85            	popw	x
5436  06be 81            	ret
5541                     ; 2017 void TIM1_GenerateEvent(TIM1_EventSource_TypeDef TIM1_EventSource)
5541                     ; 2018 {
5542                     	switch	.text
5543  06bf               _TIM1_GenerateEvent:
5547                     ; 2020   assert_param(IS_TIM1_EVENT_SOURCE(TIM1_EventSource));
5549                     ; 2023   TIM1->EGR = (uint8_t)TIM1_EventSource;
5551  06bf c752b8        	ld	21176,a
5552                     ; 2024 }
5555  06c2 81            	ret
5729                     ; 2043 FlagStatus TIM1_GetFlagStatus(TIM1_FLAG_TypeDef TIM1_FLAG)
5729                     ; 2044 {
5730                     	switch	.text
...
5843  06fd 85            	popw	x
5844  06fe 81            	ret
5908                     ; 2108 ITStatus TIM1_GetITStatus(TIM1_IT_TypeDef TIM1_IT)
5908                     ; 2109 {
5909                     	switch	.text
...
5917                     ; 2110   ITStatus bitstatus = RESET;
5919  0701 7b02          	ld	a,(OFST+0,sp)
5920  0703 97            	ld	xl,a
5921                     ; 2112   uint8_t TIM1_itStatus = 0x0, TIM1_itEnable = 0x0;
5923  0704 7b01          	ld	a,(OFST-1,sp)
5924  0706 97            	ld	xl,a
5927  0707 7b02          	ld	a,(OFST+0,sp)
5928  0709 97            	ld	xl,a
5929                     ; 2115   assert_param(IS_TIM1_GET_IT(TIM1_IT));
5931                     ; 2117   TIM1_itStatus = (uint8_t)(TIM1->SR1 & (uint8_t)TIM1_IT);
5933  070a c652b6        	ld	a,21174
5934  070d 1403          	and	a,(OFST+1,sp)
5935  070f 6b01          	ld	(OFST-1,sp),a
5936                     ; 2119   TIM1_itEnable = (uint8_t)(TIM1->IER & (uint8_t)TIM1_IT);
5938  0711 c652b5        	ld	a,21173
5939  0714 1403          	and	a,(OFST+1,sp)
5940  0716 6b02          	ld	(OFST+0,sp),a
5941                     ; 2121   if ((TIM1_itStatus != (uint8_t)RESET ) && (TIM1_itEnable != (uint8_t)RESET ))
5943  0718 0d01          	tnz	(OFST-1,sp)
5944  071a 270a          	jreq	L1113
5946  071c 0d02          	tnz	(OFST+0,sp)
5947  071e 2706          	jreq	L1113
5948                     ; 2123     bitstatus = SET;
5950  0720 a601          	ld	a,#1
5951  0722 6b02          	ld	(OFST+0,sp),a
5953  0724 2002          	jra	L3113
5954  0726               L1113:
5955                     ; 2127     bitstatus = RESET;
5957  0726 0f02          	clr	(OFST+0,sp)
5958  0728               L3113:
5959                     ; 2129   return (ITStatus)(bitstatus);
5961  0728 7b02          	ld	a,(OFST+0,sp)
5964  072a 5b03          	addw	sp,#3
5965  072c 81            	ret
6001                     ; 2146 void TIM1_ClearITPendingBit(TIM1_IT_TypeDef TIM1_IT)
6001                     ; 2147 {
6002                     	switch	.text
6003  072d               _TIM1_ClearITPendingBit:
6007                     ; 2149   assert_param(IS_TIM1_IT(TIM1_IT));
6009                     ; 2152   TIM1->SR1 = (uint8_t)(~(uint8_t)TIM1_IT);
6011  072d 43            	cpl	a
6012  072e c752b6        	ld	21174,a
6013                     ; 2153 }
6016  0731 81            	ret
6554                     ; 2161 void TIM1_DMAConfig(TIM1_DMABase_TypeDef TIM1_DMABase,
6554                     ; 2162                     TIM1_DMABurstLength_TypeDef TIM1_DMABurstLength)
6554                     ; 2163 {
6555                     	switch	.text
6556  0732               _TIM1_DMAConfig:
6560                     ; 2165   assert_param(IS_TIM1_DMABase(TIM1_DMABase));
6562                     ; 2166   assert_param(IS_TIM1_DMABurstLength(TIM1_DMABurstLength));
6564                     ; 2169   TIM1->DCR1 = (uint8_t)TIM1_DMABase;
6566  0732 9e            	ld	a,xh
6567  0733 c752d1        	ld	21201,a
6568                     ; 2170   TIM1->DCR2 = (uint8_t)TIM1_DMABurstLength;
6570  0736 9f            	ld	a,xl
6571  0737 c752d2        	ld	21202,a
6572                     ; 2171 }
6575  073a 81            	ret
6669                     ; 2183 void TIM1_DMACmd(TIM1_DMASource_TypeDef TIM1_DMASource, FunctionalState NewState)
6669                     ; 2184 {
6670                     	switch	.text
6671  073b               _TIM1_DMACmd:
6673  073b 89            	pushw	x
6674       00000000      OFST:	set	0
6677                     ; 2186   assert_param(IS_FUNCTIONAL_STATE(NewState));
6679                     ; 2187   assert_param(IS_TIM1_DMA_SOURCE(TIM1_DMASource));
6681                     ; 2189   if (NewState != DISABLE)
6683  073c 9f            	ld	a,xl
6684  073d 4d            	tnz	a
6685  073e 2709          	jreq	L7243
6686                     ; 2192     TIM1->DER |= (uint8_t)TIM1_DMASource;
6688  0740 9e            	ld	a,xh
6689  0741 ca52b4        	or	a,21172
6690  0744 c752b4        	ld	21172,a
6692  0747 2009          	jra	L1343
6693  0749               L7243:
6694                     ; 2197     TIM1->DER &= (uint8_t)(~TIM1_DMASource);
...
6704  0752 85            	popw	x
6705  0753 81            	ret
6740                     ; 2207 void TIM1_SelectCCDMA(FunctionalState NewState)
6740                     ; 2208 {
6741                     	switch	.text
6742  0754               _TIM1_SelectCCDMA:
6746                     ; 2210   assert_param(IS_FUNCTIONAL_STATE(NewState));
6748                     ; 2212   if (NewState != DISABLE)
6750  0754 4d            	tnz	a
6751  0755 2706          	jreq	L1543
6752                     ; 2215     TIM1->CR2 |= TIM1_CR2_CCDS;
6754  0757 721652b1      	bset	21169,#3
6756  075b 2004          	jra	L3543
6757  075d               L1543:
6758                     ; 2220     TIM1->CR2 &= (uint8_t)(~TIM1_CR2_CCDS);
6760  075d 721752b1      	bres	21169,#3
6761  0761               L3543:
6762                     ; 2222 }
6765  0761 81            	ret
6789                     ; 2245 void TIM1_InternalClockConfig(void)
6789                     ; 2246 {
6790                     	switch	.text
6791  0762               _TIM1_InternalClockConfig:
6795                     ; 2248   TIM1->SMCR &= (uint8_t)(~TIM1_SMCR_SMS);
6797  0762 c652b2        	ld	a,21170
6798  0765 a4f8          	and	a,#248
6799  0767 c752b2        	ld	21170,a
6800                     ; 2249 }
6803  076a 81            	ret
6892                     ; 2266 void TIM1_TIxExternalClockConfig(TIM1_TIxExternalCLK1Source_TypeDef TIM1_TIxExternalCLKSource,
6892                     ; 2267                                  TIM1_ICPolarity_TypeDef TIM1_ICPolarity,
6892                     ; 2268                                  uint8_t ICFilter)
6892                     ; 2269 {
6893                     	switch	.text
6894  076b               _TIM1_TIxExternalClockConfig:
6896  076b 89            	pushw	x
6897       00000000      OFST:	set	0
6900                     ; 2271   assert_param(IS_TIM1_TIXCLK_SOURCE(TIM1_TIxExternalCLKSource));
6902                     ; 2272   assert_param(IS_TIM1_IC_POLARITY(TIM1_ICPolarity));
6904                     ; 2273   assert_param(IS_TIM1_IC_FILTER(ICFilter));
6906                     ; 2276   if (TIM1_TIxExternalCLKSource == TIM1_TIxExternalCLK1Source_TI2)
6908  076c 9e            	ld	a,xh
6909  076d a160          	cp	a,#96
6910  076f 260f          	jrne	L5253
6911                     ; 2278     TI2_Config(TIM1_ICPolarity, TIM1_ICSelection_DirectTI, ICFilter);
...
6923  0780               L5253:
6924                     ; 2282     TI1_Config(TIM1_ICPolarity, TIM1_ICSelection_DirectTI, ICFilter);
...
6933  078c 84            	pop	a
6934  078d               L7253:
6935                     ; 2286   TIM1_SelectInputTrigger((TIM1_TRGSelection_TypeDef)TIM1_TIxExternalCLKSource);
6937  078d 7b01          	ld	a,(OFST+1,sp)
6938  078f ad34          	call	_TIM1_SelectInputTrigger
6940                     ; 2289   TIM1->SMCR |= (uint8_t)(TIM1_SlaveMode_External1);
...
6948  0799 85            	popw	x
6949  079a 81            	ret
7066                     ; 2308 void TIM1_ETRClockMode1Config(TIM1_ExtTRGPSC_TypeDef TIM1_ExtTRGPrescaler,
7066                     ; 2309                               TIM1_ExtTRGPolarity_TypeDef TIM1_ExtTRGPolarity,
7066                     ; 2310                               uint8_t ExtTRGFilter)
7066                     ; 2311 {
7067                     	switch	.text
7068  079b               _TIM1_ETRClockMode1Config:
7070  079b 89            	pushw	x
7071       00000000      OFST:	set	0
7074                     ; 2313   assert_param(IS_TIM1_EXT_PRESCALER(TIM1_ExtTRGPrescaler));
7076                     ; 2314   assert_param(IS_TIM1_EXT_POLARITY(TIM1_ExtTRGPolarity));
7078                     ; 2315   assert_param(IS_TIM1_EXT_TRG_FILTER(ExtTRGFilter));
7080                     ; 2318   TIM1_ETRConfig(TIM1_ExtTRGPrescaler, TIM1_ExtTRGPolarity, ExtTRGFilter);
...
7090  07a6 84            	pop	a
7091                     ; 2321   TIM1->SMCR = (uint8_t)((uint8_t)(TIM1->SMCR & (uint8_t)(~(TIM1_SMCR_SMS | TIM1_SMCR_TS)))
7091                     ; 2322                          | (uint8_t)((uint8_t)TIM1_SlaveMode_External1 | (uint8_t) TIM1_TRGSelection_ETRF));
...
7100  07b1 85            	popw	x
7101  07b2 81            	ret
7159                     ; 2341 void TIM1_ETRClockMode2Config(TIM1_ExtTRGPSC_TypeDef TIM1_ExtTRGPrescaler,
7159                     ; 2342                               TIM1_ExtTRGPolarity_TypeDef TIM1_ExtTRGPolarity,
7159                     ; 2343                               uint8_t ExtTRGFilter)
7159                     ; 2344 {
7160                     	switch	.text
7161  07b3               _TIM1_ETRClockMode2Config:
7163  07b3 89            	pushw	x
7164       00000000      OFST:	set	0
7167                     ; 2346   assert_param(IS_TIM1_EXT_PRESCALER(TIM1_ExtTRGPrescaler));
7169                     ; 2347   assert_param(IS_TIM1_EXT_POLARITY(TIM1_ExtTRGPolarity));
7171                     ; 2350   TIM1_ETRConfig(TIM1_ExtTRGPrescaler, TIM1_ExtTRGPolarity, ExtTRGFilter);
...
7181  07be 84            	pop	a
7182                     ; 2353   TIM1->ETR |= TIM1_ETR_ECE;
7184  07bf 721c52b3      	bset	21171,#6
7185                     ; 2354 }
7188  07c3 85            	popw	x
7189  07c4 81            	ret
7296                     ; 2404 void TIM1_SelectInputTrigger(TIM1_TRGSelection_TypeDef TIM1_InputTriggerSource)
7296                     ; 2405 {
7297                     	switch	.text
7298  07c5               _TIM1_SelectInputTrigger:
7300  07c5 88            	push	a
7301       00000000      OFST:	set	0
7304                     ; 2407   assert_param(IS_TIM1_TRIGGER_SELECTION(TIM1_InputTriggerSource));
7306                     ; 2410   TIM1->SMCR = (uint8_t)((uint8_t)(TIM1->SMCR & (uint8_t)(~TIM1_SMCR_TS)) | (uint8_t)TIM1_InputTriggerSource);
...
7315  07d0 84            	pop	a
7316  07d1 81            	ret
7422                     ; 2427 void TIM1_SelectOutputTrigger(TIM1_TRGOSource_TypeDef TIM1_TRGOSource)
7422                     ; 2428 {
7423                     	switch	.text
7424  07d2               _TIM1_SelectOutputTrigger:
7426  07d2 88            	push	a
7427       00000000      OFST:	set	0
7430                     ; 2430   assert_param(IS_TIM1_TRGO_SOURCE(TIM1_TRGOSource));
7432                     ; 2432   TIM1->CR2 = (uint8_t)((uint8_t)(TIM1->CR2 & (uint8_t)(~TIM1_CR2_MMS)) | (uint8_t) TIM1_TRGOSource);
...
7441  07dd 84            	pop	a
7442  07de 81            	ret
7516                     ; 2445 void TIM1_SelectSlaveMode(TIM1_SlaveMode_TypeDef TIM1_SlaveMode)
7516                     ; 2446 {
7517                     	switch	.text
7518  07df               _TIM1_SelectSlaveMode:
7520  07df 88            	push	a
7521       00000000      OFST:	set	0
7524                     ; 2448   assert_param(IS_TIM1_SLAVE_MODE(TIM1_SlaveMode));
7526                     ; 2451   TIM1->SMCR = (uint8_t)((uint8_t)(TIM1->SMCR & (uint8_t)(~TIM1_SMCR_SMS)) | (uint8_t)TIM1_SlaveMode);
...
7535  07ea 84            	pop	a
7536  07eb 81            	ret
7572                     ; 2461 void TIM1_SelectMasterSlaveMode(FunctionalState NewState)
7572                     ; 2462 {
7573                     	switch	.text
7574  07ec               _TIM1_SelectMasterSlaveMode:
7578                     ; 2464   assert_param(IS_FUNCTIONAL_STATE(NewState));
7580                     ; 2467   if (NewState != DISABLE)
7582  07ec 4d            	tnz	a
7583  07ed 2706          	jreq	L5004
7584                     ; 2469     TIM1->SMCR |= TIM1_SMCR_MSM;
7586  07ef 721e52b2      	bset	21170,#7
7588  07f3 2004          	jra	L7004
7589  07f5               L5004:
7590                     ; 2473     TIM1->SMCR &= (uint8_t)(~TIM1_SMCR_MSM);
7592  07f5 721f52b2      	bres	21170,#7
7593  07f9               L7004:
7594                     ; 2475 }
7597  07f9 81            	ret
7653                     ; 2493 void TIM1_ETRConfig(TIM1_ExtTRGPSC_TypeDef TIM1_ExtTRGPrescaler,
7653                     ; 2494                     TIM1_ExtTRGPolarity_TypeDef TIM1_ExtTRGPolarity,
7653                     ; 2495                     uint8_t ExtTRGFilter)
7653                     ; 2496 {
7654                     	switch	.text
7655  07fa               _TIM1_ETRConfig:
7657  07fa 89            	pushw	x
7658       00000000      OFST:	set	0
7661                     ; 2497   assert_param(IS_TIM1_EXT_TRG_FILTER(ExtTRGFilter));
7663                     ; 2500   TIM1->ETR |= (uint8_t)((uint8_t)((uint8_t) TIM1_ExtTRGPrescaler
7663                     ; 2501                                    | (uint8_t) TIM1_ExtTRGPolarity)
7663                     ; 2502                          | (uint8_t) ExtTRGFilter);
...
7673  0806 85            	popw	x
7674  0807 81            	ret
7760                     ; 2541 void TIM1_EncoderInterfaceConfig(TIM1_EncoderMode_TypeDef TIM1_EncoderMode,
7760                     ; 2542                                  TIM1_ICPolarity_TypeDef TIM1_IC1Polarity,
7760                     ; 2543                                  TIM1_ICPolarity_TypeDef TIM1_IC2Polarity)
7760                     ; 2544 {
7761                     	switch	.text
7762  0808               _TIM1_EncoderInterfaceConfig:
7764  0808 89            	pushw	x
7765       00000000      OFST:	set	0
7768                     ; 2546   assert_param(IS_TIM1_ENCODER_MODE(TIM1_EncoderMode));
7770                     ; 2547   assert_param(IS_TIM1_IC_POLARITY(TIM1_IC1Polarity));
7772                     ; 2548   assert_param(IS_TIM1_IC_POLARITY(TIM1_IC2Polarity));
7774                     ; 2551   if (TIM1_IC1Polarity != TIM1_ICPolarity_Rising)
7776  0809 9f            	ld	a,xl
7777  080a 4d            	tnz	a
7778  080b 2706          	jreq	L7704
7779                     ; 2553     TIM1->CCER1 |= TIM1_CCER1_CC1P;
7781  080d 721252bd      	bset	21181,#1
7783  0811 2004          	jra	L1014
7784  0813               L7704:
7785                     ; 2557     TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC1P);
7787  0813 721352bd      	bres	21181,#1
7788  0817               L1014:
7789                     ; 2560   if (TIM1_IC2Polarity != TIM1_ICPolarity_Rising)
7791  0817 0d05          	tnz	(OFST+5,sp)
7792  0819 2706          	jreq	L3014
7793                     ; 2562     TIM1->CCER1 |= TIM1_CCER1_CC2P;
7795  081b 721a52bd      	bset	21181,#5
7797  081f 2004          	jra	L5014
7798  0821               L3014:
7799                     ; 2566     TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC2P);
7801  0821 721b52bd      	bres	21181,#5
7802  0825               L5014:
7803                     ; 2569   TIM1->SMCR = (uint8_t)((uint8_t)(TIM1->SMCR & (uint8_t)(TIM1_SMCR_MSM | TIM1_SMCR_TS)) | (uint8_t) TIM1_EncoderMode);
7805  0825 c652b2        	ld	a,21170
7806  0828 a4f0          	and	a,#240
7807  082a 1a01          	or	a,(OFST+1,sp)
7808  082c c752b2        	ld	21170,a
7809                     ; 2572   TIM1->CCMR1 = (uint8_t)((uint8_t)(TIM1->CCMR1 & (uint8_t)(~TIM1_CCMR_CCxS))  | (uint8_t) CCMR_TIxDirect_Set);
7811  082f c652b9        	ld	a,21177
7812  0832 a4fc          	and	a,#252
7813  0834 aa01          	or	a,#1
7814  0836 c752b9        	ld	21177,a
7815                     ; 2573   TIM1->CCMR2 = (uint8_t)((uint8_t)(TIM1->CCMR2 & (uint8_t)(~TIM1_CCMR_CCxS)) | (uint8_t) CCMR_TIxDirect_Set);
...
7824  0843 85            	popw	x
7825  0844 81            	ret
7861                     ; 2583 void TIM1_SelectHallSensor(FunctionalState NewState)
7861                     ; 2584 {
7862                     	switch	.text
7863  0845               _TIM1_SelectHallSensor:
7867                     ; 2586   assert_param(IS_FUNCTIONAL_STATE(NewState));
7869                     ; 2589   if (NewState != DISABLE)
7871  0845 4d            	tnz	a
7872  0846 2706          	jreq	L5214
7873                     ; 2591     TIM1->CR2 |= TIM1_CR2_TI1S;
7875  0848 721e52b1      	bset	21169,#7
7877  084c 2004          	jra	L7214
7878  084e               L5214:
7879                     ; 2595     TIM1->CR2 &= (uint8_t)(~TIM1_CR2_TI1S);
7881  084e 721f52b1      	bres	21169,#7
7882  0852               L7214:
7883                     ; 2597 }
7886  0852 81            	ret
7938                     ; 2617 static void TI1_Config(uint8_t TIM1_ICPolarity, uint8_t TIM1_ICSelection, uint8_t TIM1_ICFilter)
7938                     ; 2618 {
7939                     	switch	.text
...
7947                     ; 2621   TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC1E);
7949  0855 721152bd      	bres	21181,#0
7950                     ; 2624   TIM1->CCMR1 = (uint8_t)((uint8_t)(TIM1->CCMR1 & (uint8_t)(~( TIM1_CCMR_CCxS | TIM1_CCMR_ICxF)))
7950                     ; 2625                           | (uint8_t)(( (TIM1_ICSelection)) | ((uint8_t)( TIM1_ICFilter << 4))));
...
7963                     ; 2630   if (TIM1_ICPolarity != TIM1_ICPolarity_Rising)
7965  086e 0d02          	tnz	(OFST+1,sp)
7966  0870 2706          	jreq	L7514
7967                     ; 2632     TIM1->CCER1 |= TIM1_CCER1_CC1P;
7969  0872 721252bd      	bset	21181,#1
7971  0876 2004          	jra	L1614
7972  0878               L7514:
7973                     ; 2636     TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC1P);
7975  0878 721352bd      	bres	21181,#1
7976  087c               L1614:
7977                     ; 2640   TIM1->CCER1 |=  TIM1_CCER1_CC1E;
7979  087c 721052bd      	bset	21181,#0
7980                     ; 2641 }
7983  0880 5b03          	addw	sp,#3
7984  0882 81            	ret
8036                     ; 2657 static void TI2_Config(uint8_t TIM1_ICPolarity, uint8_t TIM1_ICSelection, uint8_t TIM1_ICFilter)
8036                     ; 2658 {
8037                     	switch	.text
...
8045                     ; 2660   TIM1->CCER1 &=  (uint8_t)(~TIM1_CCER1_CC2E);
8047  0885 721952bd      	bres	21181,#4
8048                     ; 2663   TIM1->CCMR2  = (uint8_t)((uint8_t)(TIM1->CCMR2 & (uint8_t)(~( TIM1_CCMR_CCxS | TIM1_CCMR_ICxF)))
8048                     ; 2664                            | (uint8_t)(( (TIM1_ICSelection)) | ((uint8_t)( TIM1_ICFilter << 4))));
...
8061                     ; 2666   if (TIM1_ICPolarity != TIM1_ICPolarity_Rising)
8063  089e 0d02          	tnz	(OFST+1,sp)
8064  08a0 2706          	jreq	L1124
8065                     ; 2668     TIM1->CCER1 |= TIM1_CCER1_CC2P;
8067  08a2 721a52bd      	bset	21181,#5
8069  08a6 2004          	jra	L3124
8070  08a8               L1124:
8071                     ; 2672     TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC2P);
8073  08a8 721b52bd      	bres	21181,#5
8074  08ac               L3124:
8075                     ; 2675   TIM1->CCER1 |=  TIM1_CCER1_CC2E;
8077  08ac 721852bd      	bset	21181,#4
8078                     ; 2676 }
8081  08b0 5b03          	addw	sp,#3
8082  08b2 81            	ret
8134                     ; 2692 static void TI3_Config(uint8_t TIM1_ICPolarity, uint8_t TIM1_ICSelection, uint8_t TIM1_ICFilter)
8134                     ; 2693 {
8135                     	switch	.text
...
8143                     ; 2695   TIM1->CCER2 &=  (uint8_t)(~TIM1_CCER2_CC3E);
8145  08b5 721152be      	bres	21182,#0
8146                     ; 2698   TIM1->CCMR3 = (uint8_t)((uint8_t)(TIM1->CCMR3 & (uint8_t)(~( TIM1_CCMR_CCxS | TIM1_CCMR_ICxF)))
8146                     ; 2699                           | (uint8_t)(( (TIM1_ICSelection)) | ((uint8_t)( TIM1_ICFilter << 4))));
...
8159                     ; 2702   if (TIM1_ICPolarity != TIM1_ICPolarity_Rising)
8161  08ce 0d02          	tnz	(OFST+1,sp)
8162  08d0 2706          	jreq	L3424
8163                     ; 2704     TIM1->CCER2 |= TIM1_CCER2_CC3P;
8165  08d2 721252be      	bset	21182,#1
8167  08d6 2004          	jra	L5424
8168  08d8               L3424:
8169                     ; 2708     TIM1->CCER2 &= (uint8_t)(~TIM1_CCER2_CC3P);
8171  08d8 721352be      	bres	21182,#1
8172  08dc               L5424:
8173                     ; 2711   TIM1->CCER2 |=  TIM1_CCER2_CC3E;
8175  08dc 721052be      	bset	21182,#0
8176                     ; 2712 }
8179  08e0 5b03          	addw	sp,#3
8180  08e2 81            	ret
8232                     ; 2727 static void TI4_Config(uint8_t TIM1_ICPolarity, uint8_t TIM1_ICSelection, uint8_t TIM1_ICFilter)
8232                     ; 2728 {
8233                     	switch	.text
...
8241                     ; 2731   TIM1->CCER2 &=  (uint8_t)(~TIM1_CCER2_CC4E);
8243  08e5 721952be      	bres	21182,#4
8244                     ; 2734   TIM1->CCMR4 = (uint8_t)((uint8_t)(TIM1->CCMR4 & (uint8_t)(~( TIM1_CCMR_CCxS | TIM1_CCMR_ICxF)))
8244                     ; 2735                           | (uint8_t)(( (TIM1_ICSelection)) | ((uint8_t)( TIM1_ICFilter << 4))));
...
8257                     ; 2738   if (TIM1_ICPolarity != TIM1_ICPolarity_Rising)
8259  08fe 0d02          	tnz	(OFST+1,sp)
8260  0900 2706          	jreq	L5724
8261                     ; 2740     TIM1->CCER2 |= TIM1_CCER2_CC4P;
8263  0902 721a52be      	bset	21182,#5
8265  0906 2004          	jra	L7724
8266  0908               L5724:
8267                     ; 2744     TIM1->CCER2 &= (uint8_t)(~TIM1_CCER2_CC4P);
8269  0908 721b52be      	bres	21182,#5
8270  090c               L7724:
8271                     ; 2748   TIM1->CCER2 |=  TIM1_CCER2_CC4E;
