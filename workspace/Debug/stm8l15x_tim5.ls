 ...
 407                     ; 280         TIM5->EGR |= TIM_EGR_UG ;
 409  0092 72105308      	bset	21256,#0
 411  0096 2004          	jra	L151
 412  0098               L741:
 413                     ; 282         TIM5->EGR &= (uint8_t)(~TIM_EGR_UG) ;
 415  0098 72115308      	bres	21256,#0
 416  009c               L151:
 417                     ; 284 }
 420  009c 81            	ret
 465                     ; 297 void TIM5_CounterModeConfig(TIM5_CounterMode_TypeDef TIM5_CounterMode)
 465                     ; 298 {
 466                     	switch	.text
 ...
 477                     ; 302     assert_param(IS_TIM5_COUNTER_MODE(TIM5_CounterMode));
 479                     ; 304     tmpcr1 = TIM5->CR1;
 ...
 488                     ; 310     tmpcr1 |= (uint8_t)TIM5_CounterMode;
 490  00ac 7b01          	ld	a,(OFST+0,sp)
 491  00ae 1a02          	or	a,(OFST+1,sp)
 492  00b0 6b01          	ld	(OFST+0,sp),a
 493                     ; 312     TIM5->CR1 = tmpcr1;
 495  00b2 7b01          	ld	a,(OFST+0,sp)
 496  00b4 c75300        	ld	21248,a
 497                     ; 313 }
 500  00b7 85            	popw	x
 501  00b8 81            	ret
 535                     ; 321 void TIM5_SetCounter(uint16_t Counter)
 535                     ; 322 {
 536                     	switch	.text
 537  00b9               _TIM5_SetCounter:
 541                     ; 325     TIM5->CNTRH = (uint8_t)(Counter >> 8);
 543  00b9 9e            	ld	a,xh
 544  00ba c7530c        	ld	21260,a
 545                     ; 326     TIM5->CNTRL = (uint8_t)(Counter);
 547  00bd 9f            	ld	a,xl
 548  00be c7530d        	ld	21261,a
 549                     ; 327 }
 552  00c1 81            	ret
 586                     ; 335 void TIM5_SetAutoreload(uint16_t Autoreload)
 586                     ; 336 {
 587                     	switch	.text
 588  00c2               _TIM5_SetAutoreload:
 592                     ; 338     TIM5->ARRH = (uint8_t)(Autoreload >> 8);
 594  00c2 9e            	ld	a,xh
 595  00c3 c7530f        	ld	21263,a
 596                     ; 339     TIM5->ARRL = (uint8_t)(Autoreload);
 598  00c6 9f            	ld	a,xl
 599  00c7 c75310        	ld	21264,a
 600                     ; 340 }
 603  00ca 81            	ret
 655                     ; 347 uint16_t TIM5_GetCounter(void)
 655                     ; 348 {
 656                     	switch	.text
 ...
 666                     ; 352     tmpcntrh = TIM5->CNTRH;
 668  00cf c6530c        	ld	a,21260
 669  00d2 6b02          	ld	(OFST-2,sp),a
 670                     ; 353     tmpcntrl = TIM5->CNTRL;
 ...
 699  00f2 81            	ret
 723                     ; 374 TIM5_Prescaler_TypeDef TIM5_GetPrescaler(void)
 723                     ; 375 {
 724                     	switch	.text
 725  00f3               _TIM5_GetPrescaler:
 729                     ; 377     return ((TIM5_Prescaler_TypeDef)TIM5->PSCR);
 731  00f3 c6530e        	ld	a,21262
 734  00f6 81            	ret
 790                     ; 387 void TIM5_UpdateDisableConfig(FunctionalState NewState)
 790                     ; 388 {
 791                     	switch	.text
 ...
 802                     ; 394         TIM5->CR1 |= TIM_CR1_UDIS;
 804  00fa 72125300      	bset	21248,#1
 806  00fe 2004          	jra	L713
 807  0100               L513:
 808                     ; 396         TIM5->CR1 &= (uint8_t)(~TIM_CR1_UDIS);
 810  0100 72135300      	bres	21248,#1
 811  0104               L713:
 812                     ; 398 }
 815  0104 81            	ret
 873                     ; 408 void TIM5_UpdateRequestConfig(TIM5_UpdateSource_TypeDef TIM5_UpdateSource)
 873                     ; 409 {
 874                     	switch	.text
 875  0105               _TIM5_UpdateRequestConfig:
 879                     ; 411     assert_param(IS_TIM5_UPDATE_SOURCE(TIM5_UpdateSource));
 881                     ; 414     if (TIM5_UpdateSource == TIM5_UpdateSource_Regular) {
 883  0105 a101          	cp	a,#1
 884  0107 2606          	jrne	L743
 885                     ; 415         TIM5->CR1 |= TIM_CR1_URS ;
 887  0109 72145300      	bset	21248,#2
 889  010d 2004          	jra	L153
 890  010f               L743:
 891                     ; 417         TIM5->CR1 &= (uint8_t)(~TIM_CR1_URS);
 893  010f 72155300      	bres	21248,#2
 894  0113               L153:
 895                     ; 419 }
 898  0113 81            	ret
 934                     ; 427 void TIM5_ARRPreloadConfig(FunctionalState NewState)
 934                     ; 428 {
 935                     	switch	.text
 ...
 946                     ; 434         TIM5->CR1 |= TIM_CR1_ARPE;
 948  0117 721e5300      	bset	21248,#7
 950  011b 2004          	jra	L373
 951  011d               L173:
 952                     ; 436         TIM5->CR1 &= (uint8_t)(~TIM_CR1_ARPE);
 954  011d 721f5300      	bres	21248,#7
 955  0121               L373:
 956                     ; 438 }
 959  0121 81            	ret
1016                     ; 448 void TIM5_SelectOnePulseMode(TIM5_OPMode_TypeDef TIM5_OPMode)
1016                     ; 449 {
1017                     	switch	.text
1018  0122               _TIM5_SelectOnePulseMode:
1022                     ; 451     assert_param(IS_TIM5_OPM_MODE(TIM5_OPMode));
1024                     ; 454     if (TIM5_OPMode == TIM5_OPMode_Single) {
1026  0122 a101          	cp	a,#1
1027  0124 2606          	jrne	L324
1028                     ; 455         TIM5->CR1 |= TIM_CR1_OPM ;
1030  0126 72165300      	bset	21248,#3
1032  012a 2004          	jra	L524
1033  012c               L324:
1034                     ; 457         TIM5->CR1 &= (uint8_t)(~TIM_CR1_OPM);
1036  012c 72175300      	bres	21248,#3
1037  0130               L524:
1038                     ; 459 }
1041  0130 81            	ret
1076                     ; 467 void TIM5_Cmd(FunctionalState NewState)
1076                     ; 468 {
1077                     	switch	.text
1078  0131               _TIM5_Cmd:
...
1088                     ; 474         TIM5->CR1 |= TIM_CR1_CEN;
1090  0134 72105300      	bset	21248,#0
1092  0138 2004          	jra	L744
1093  013a               L544:
1094                     ; 476         TIM5->CR1 &= (uint8_t)(~TIM_CR1_CEN);
1096  013a 72115300      	bres	21248,#0
1097  013e               L744:
1098                     ; 478 }
1101  013e 81            	ret
1299                     ; 554 void TIM5_OC1Init(TIM5_OCMode_TypeDef TIM5_OCMode,
1299                     ; 555                   TIM5_OutputState_TypeDef TIM5_OutputState,
1299                     ; 556                   uint16_t TIM5_Pulse,
1299                     ; 557                   TIM5_OCPolarity_TypeDef TIM5_OCPolarity,
1299                     ; 558                   TIM5_OCIdleState_TypeDef TIM5_OCIdleState)
1299                     ; 559 {
1300                     	switch	.text
...
1311                     ; 563     assert_param(IS_TIM5_OC_MODE(TIM5_OCMode));
1313                     ; 564     assert_param(IS_TIM5_OUTPUT_STATE(TIM5_OutputState));
1315                     ; 565     assert_param(IS_TIM5_OC_POLARITY(TIM5_OCPolarity));
1317                     ; 566     assert_param(IS_TIM5_OCIDLE_STATE(TIM5_OCIdleState));
1319                     ; 568     tmpccmr1 = TIM5->CCMR1;
1321  0143 c65309        	ld	a,21257
1322  0146 6b01          	ld	(OFST+0,sp),a
1323                     ; 571     TIM5->CCER1 &= (uint8_t)(~TIM_CCER1_CC1E);
...
1331                     ; 576     tmpccmr1 |= (uint8_t)TIM5_OCMode;
1333  0152 9e            	ld	a,xh
1334  0153 1a01          	or	a,(OFST+0,sp)
1335  0155 6b01          	ld	(OFST+0,sp),a
1336                     ; 578     TIM5->CCMR1 = tmpccmr1;
1338  0157 7b01          	ld	a,(OFST+0,sp)
1339  0159 c75309        	ld	21257,a
1340                     ; 581     if (TIM5_OutputState == TIM5_OutputState_Enable) {
1342  015c 9f            	ld	a,xl
1343  015d a101          	cp	a,#1
1344  015f 2606          	jrne	L365
1345                     ; 582         TIM5->CCER1 |= TIM_CCER1_CC1E;
1347  0161 7210530b      	bset	21259,#0
1349  0165 2004          	jra	L565
1350  0167               L365:
1351                     ; 584         TIM5->CCER1 &= (uint8_t)(~TIM_CCER1_CC1E);
1353  0167 7211530b      	bres	21259,#0
1354  016b               L565:
1355                     ; 588     if (TIM5_OCPolarity == TIM5_OCPolarity_Low) {
1357  016b 7b08          	ld	a,(OFST+7,sp)
1358  016d a101          	cp	a,#1
1359  016f 2606          	jrne	L765
1360                     ; 589         TIM5->CCER1 |= TIM_CCER1_CC1P;
1362  0171 7212530b      	bset	21259,#1
1364  0175 2004          	jra	L175
1365  0177               L765:
1366                     ; 591         TIM5->CCER1 &= (uint8_t)(~TIM_CCER1_CC1P);
1368  0177 7213530b      	bres	21259,#1
1369  017b               L175:
1370                     ; 595     if (TIM5_OCIdleState == TIM5_OCIdleState_Set) {
1372  017b 7b09          	ld	a,(OFST+8,sp)
1373  017d a101          	cp	a,#1
1374  017f 2606          	jrne	L375
1375                     ; 596         TIM5->OISR |= TIM_OISR_OIS1;
1377  0181 72105316      	bset	21270,#0
1379  0185 2004          	jra	L575
1380  0187               L375:
1381                     ; 598         TIM5->OISR &= (uint8_t)(~TIM_OISR_OIS1);
1383  0187 72115316      	bres	21270,#0
1384  018b               L575:
1385                     ; 602     TIM5->CCR1H = (uint8_t)(TIM5_Pulse >> 8);
1387  018b 7b06          	ld	a,(OFST+5,sp)
1388  018d c75311        	ld	21265,a
1389                     ; 603     TIM5->CCR1L = (uint8_t)(TIM5_Pulse);
1391  0190 7b07          	ld	a,(OFST+6,sp)
1392  0192 c75312        	ld	21266,a
1393                     ; 604 }
1396  0195 5b03          	addw	sp,#3
1397  0197 81            	ret
1480                     ; 631 void TIM5_OC2Init(TIM5_OCMode_TypeDef TIM5_OCMode,
1480                     ; 632                   TIM5_OutputState_TypeDef TIM5_OutputState,
1480                     ; 633                   uint16_t TIM5_Pulse,
1480                     ; 634                   TIM5_OCPolarity_TypeDef TIM5_OCPolarity,
1480                     ; 635                   TIM5_OCIdleState_TypeDef TIM5_OCIdleState)
1480                     ; 636 {
1481                     	switch	.text
...
1492                     ; 640     assert_param(IS_TIM5_OC_MODE(TIM5_OCMode));
1494                     ; 641     assert_param(IS_TIM5_OUTPUT_STATE(TIM5_OutputState));
1496                     ; 642     assert_param(IS_TIM5_OC_POLARITY(TIM5_OCPolarity));
1498                     ; 643     assert_param(IS_TIM5_OCIDLE_STATE(TIM5_OCIdleState));
1500                     ; 645     tmpccmr2 = TIM5->CCMR2;
1502  019c c6530a        	ld	a,21258
1503  019f 6b01          	ld	(OFST+0,sp),a
1504                     ; 648     TIM5->CCER1 &= (uint8_t)(~TIM_CCER1_CC2E);
...
1512                     ; 654     tmpccmr2 |= (uint8_t)TIM5_OCMode;
1514  01ab 9e            	ld	a,xh
1515  01ac 1a01          	or	a,(OFST+0,sp)
1516  01ae 6b01          	ld	(OFST+0,sp),a
1517                     ; 656     TIM5->CCMR2 = tmpccmr2;
1519  01b0 7b01          	ld	a,(OFST+0,sp)
1520  01b2 c7530a        	ld	21258,a
1521                     ; 659     if (TIM5_OutputState == TIM5_OutputState_Enable) {
1523  01b5 9f            	ld	a,xl
1524  01b6 a101          	cp	a,#1
1525  01b8 2606          	jrne	L146
1526                     ; 660         TIM5->CCER1 |= TIM_CCER1_CC2E;
1528  01ba 7218530b      	bset	21259,#4
1530  01be 2004          	jra	L346
1531  01c0               L146:
1532                     ; 662         TIM5->CCER1 &= (uint8_t)(~TIM_CCER1_CC2E);
1534  01c0 7219530b      	bres	21259,#4
1535  01c4               L346:
1536                     ; 666     if (TIM5_OCPolarity == TIM5_OCPolarity_Low) {
1538  01c4 7b08          	ld	a,(OFST+7,sp)
1539  01c6 a101          	cp	a,#1
1540  01c8 2606          	jrne	L546
1541                     ; 667         TIM5->CCER1 |= TIM_CCER1_CC2P;
1543  01ca 721a530b      	bset	21259,#5
1545  01ce 2004          	jra	L746
1546  01d0               L546:
1547                     ; 669         TIM5->CCER1 &= (uint8_t)(~TIM_CCER1_CC2P);
1549  01d0 721b530b      	bres	21259,#5
1550  01d4               L746:
1551                     ; 674     if (TIM5_OCIdleState == TIM5_OCIdleState_Set) {
1553  01d4 7b09          	ld	a,(OFST+8,sp)
1554  01d6 a101          	cp	a,#1
1555  01d8 2606          	jrne	L156
1556                     ; 675         TIM5->OISR |= TIM_OISR_OIS2;
1558  01da 72145316      	bset	21270,#2
1560  01de 2004          	jra	L356
1561  01e0               L156:
1562                     ; 677         TIM5->OISR &= (uint8_t)(~TIM_OISR_OIS2);
1564  01e0 72155316      	bres	21270,#2
1565  01e4               L356:
1566                     ; 681     TIM5->CCR2H = (uint8_t)(TIM5_Pulse >> 8);
1568  01e4 7b06          	ld	a,(OFST+5,sp)
1569  01e6 c75313        	ld	21267,a
1570                     ; 682     TIM5->CCR2L = (uint8_t)(TIM5_Pulse);
1572  01e9 7b07          	ld	a,(OFST+6,sp)
1573  01eb c75314        	ld	21268,a
1574                     ; 683 }
1577  01ee 5b03          	addw	sp,#3
1578  01f0 81            	ret
1776                     ; 712 void TIM5_BKRConfig(TIM5_OSSIState_TypeDef TIM5_OSSIState,
1776                     ; 713                     TIM5_LockLevel_TypeDef TIM5_LockLevel,
1776                     ; 714                     TIM5_BreakState_TypeDef TIM5_BreakState,
1776                     ; 715                     TIM5_BreakPolarity_TypeDef TIM5_BreakPolarity,
1776                     ; 716                     TIM5_AutomaticOutput_TypeDef TIM5_AutomaticOutput)
1776                     ; 717 
1776                     ; 718 {
1777                     	switch	.text
...
1785                     ; 720     assert_param(IS_TIM5_OSSI_STATE(TIM5_OSSIState));
1787                     ; 721     assert_param(IS_TIM5_LOCK_LEVEL(TIM5_LockLevel));
1789                     ; 722     assert_param(IS_TIM5_BREAK_STATE(TIM5_BreakState));
1791                     ; 723     assert_param(IS_TIM5_BREAK_POLARITY(TIM5_BreakPolarity));
1793                     ; 724     assert_param(IS_TIM5_AUTOMATIC_OUTPUT_STATE(TIM5_AutomaticOutput));
1795                     ; 730     TIM5->BKR = (uint8_t)((uint8_t)((uint8_t)((uint8_t)((uint8_t)TIM5_OSSIState | (uint8_t)TIM5_LockLevel) | \
1795                     ; 731                                     (uint8_t)((uint8_t)TIM5_BreakState | (uint8_t)TIM5_BreakPolarity)) | \
1795                     ; 732                                     TIM5_AutomaticOutput));
...
1809  0205 81            	ret
1845                     ; 741 void TIM5_CtrlPWMOutputs(FunctionalState NewState)
1845                     ; 742 {
1846                     	switch	.text
...
1857                     ; 749         TIM5->BKR |= TIM_BKR_MOE ;
1859  0209 721e5315      	bset	21269,#7
1861  020d 2004          	jra	L7001
1862  020f               L5001:
1863                     ; 751         TIM5->BKR &= (uint8_t)(~TIM_BKR_MOE) ;
1865  020f 721f5315      	bres	21269,#7
1866  0213               L7001:
1867                     ; 753 }
1870  0213 81            	ret
1935                     ; 773 void TIM5_SelectOCxM(TIM5_Channel_TypeDef TIM5_Channel,
1935                     ; 774                      TIM5_OCMode_TypeDef TIM5_OCMode)
1935                     ; 775 {
1936                     	switch	.text
1937  0214               _TIM5_SelectOCxM:
1939  0214 89            	pushw	x
1940       00000000      OFST:	set	0
1943                     ; 777     assert_param(IS_TIM5_CHANNEL(TIM5_Channel));
1945                     ; 778     assert_param(IS_TIM5_OCM(TIM5_OCMode));
1947                     ; 780     if (TIM5_Channel == TIM5_Channel_1) {
1949  0215 9e            	ld	a,xh
1950  0216 4d            	tnz	a
1951  0217 2615          	jrne	L3401
1952                     ; 782         TIM5->CCER1 &= (uint8_t)(~TIM_CCER1_CC1E);
1954  0219 7211530b      	bres	21259,#0
1955                     ; 785         TIM5->CCMR1 &= (uint8_t)(~TIM_CCMR_OCM);
1957  021d c65309        	ld	a,21257
1958  0220 a48f          	and	a,#143
1959  0222 c75309        	ld	21257,a
1960                     ; 788         TIM5->CCMR1 |= (uint8_t)TIM5_OCMode;
1962  0225 9f            	ld	a,xl
1963  0226 ca5309        	or	a,21257
1964  0229 c75309        	ld	21257,a
1966  022c 2014          	jra	L5401
1967  022e               L3401:
1968                     ; 791         TIM5->CCER1 &= (uint8_t)(~TIM_CCER1_CC2E);
1970  022e 7219530b      	bres	21259,#4
1971                     ; 794         TIM5->CCMR2 &= (uint8_t)(~TIM_CCMR_OCM);
1973  0232 c6530a        	ld	a,21258
1974  0235 a48f          	and	a,#143
1975  0237 c7530a        	ld	21258,a
1976                     ; 797         TIM5->CCMR2 |= (uint8_t)TIM5_OCMode;
...
1985  0242 85            	popw	x
1986  0243 81            	ret
2020                     ; 807 void TIM5_SetCompare1(uint16_t Compare)
2020                     ; 808 {
2021                     	switch	.text
2022  0244               _TIM5_SetCompare1:
2026                     ; 810     TIM5->CCR1H = (uint8_t)(Compare >> 8);
2028  0244 9e            	ld	a,xh
2029  0245 c75311        	ld	21265,a
2030                     ; 811     TIM5->CCR1L = (uint8_t)(Compare);
2032  0248 9f            	ld	a,xl
2033  0249 c75312        	ld	21266,a
2034                     ; 812 }
2037  024c 81            	ret
2071                     ; 820 void TIM5_SetCompare2(uint16_t Compare)
2071                     ; 821 {
2072                     	switch	.text
2073  024d               _TIM5_SetCompare2:
2077                     ; 823     TIM5->CCR2H = (uint8_t)(Compare >> 8);
2079  024d 9e            	ld	a,xh
2080  024e c75313        	ld	21267,a
2081                     ; 824     TIM5->CCR2L = (uint8_t)(Compare);
2083  0251 9f            	ld	a,xl
2084  0252 c75314        	ld	21268,a
2085                     ; 825 }
2088  0255 81            	ret
2155                     ; 835 void TIM5_ForcedOC1Config(TIM5_ForcedAction_TypeDef TIM5_ForcedAction)
2155                     ; 836 {
2156                     	switch	.text
...
2167                     ; 840     assert_param(IS_TIM5_FORCED_ACTION(TIM5_ForcedAction));
2169                     ; 842     tmpccmr1 = TIM5->CCMR1;
...
2178                     ; 848     tmpccmr1 |= (uint8_t)TIM5_ForcedAction;
2180  0265 7b01          	ld	a,(OFST+0,sp)
2181  0267 1a02          	or	a,(OFST+1,sp)
2182  0269 6b01          	ld	(OFST+0,sp),a
2183                     ; 850     TIM5->CCMR1 = tmpccmr1;
2185  026b 7b01          	ld	a,(OFST+0,sp)
2186  026d c75309        	ld	21257,a
2187                     ; 851 }
2190  0270 85            	popw	x
2191  0271 81            	ret
2236                     ; 861 void TIM5_ForcedOC2Config(TIM5_ForcedAction_TypeDef TIM5_ForcedAction)
2236                     ; 862 {
2237                     	switch	.text
...
2248                     ; 866     assert_param(IS_TIM5_FORCED_ACTION(TIM5_ForcedAction));
2250                     ; 868     tmpccmr2 = TIM5->CCMR2;
...
2320                     ; 892         TIM5->CCMR1 |= TIM_CCMR_OCxPE ;
2322  0291 72165309      	bset	21257,#3
2324  0295 2004          	jra	L7711
2325  0297               L5711:
2326                     ; 894         TIM5->CCMR1 &= (uint8_t)(~TIM_CCMR_OCxPE) ;
2328  0297 72175309      	bres	21257,#3
2329  029b               L7711:
2330                     ; 896 }
2333  029b 81            	ret
2369                     ; 904 void TIM5_OC2PreloadConfig(FunctionalState NewState)
2369                     ; 905 {
2370                     	switch	.text
...
2381                     ; 911         TIM5->CCMR2 |= TIM_CCMR_OCxPE ;
2383  029f 7216530a      	bset	21258,#3
2385  02a3 2004          	jra	L1221
2386  02a5               L7121:
2387                     ; 913         TIM5->CCMR2 &= (uint8_t)(~TIM_CCMR_OCxPE) ;
2389  02a5 7217530a      	bres	21258,#3
2390  02a9               L1221:
2391                     ; 915 }
2394  02a9 81            	ret
2429                     ; 923 void TIM5_OC1FastConfig(FunctionalState NewState)
2429                     ; 924 {
2430                     	switch	.text
...
2441                     ; 930         TIM5->CCMR1 |= TIM_CCMR_OCxFE ;
2443  02ad 72145309      	bset	21257,#2
2445  02b1 2004          	jra	L3421
2446  02b3               L1421:
2447                     ; 932         TIM5->CCMR1 &= (uint8_t)(~TIM_CCMR_OCxFE) ;
2449  02b3 72155309      	bres	21257,#2
2450  02b7               L3421:
2451                     ; 934 }
2454  02b7 81            	ret
2489                     ; 943 void TIM5_OC2FastConfig(FunctionalState NewState)
2489                     ; 944 {
2490                     	switch	.text
...
2501                     ; 950         TIM5->CCMR2 |= TIM_CCMR_OCxFE ;
2503  02bb 7214530a      	bset	21258,#2
2505  02bf 2004          	jra	L5621
2506  02c1               L3621:
2507                     ; 952         TIM5->CCMR2 &= (uint8_t)(~TIM_CCMR_OCxFE) ;
2509  02c1 7215530a      	bres	21258,#2
2510  02c5               L5621:
2511                     ; 954 }
2514  02c5 81            	ret
2550                     ; 964 void TIM5_OC1PolarityConfig(TIM5_OCPolarity_TypeDef TIM5_OCPolarity)
2550                     ; 965 {
2551                     	switch	.text
2552  02c6               _TIM5_OC1PolarityConfig:
2556                     ; 967     assert_param(IS_TIM5_OC_POLARITY(TIM5_OCPolarity));
2558                     ; 970     if (TIM5_OCPolarity == TIM5_OCPolarity_Low) {
2560  02c6 a101          	cp	a,#1
2561  02c8 2606          	jrne	L5031
2562                     ; 971         TIM5->CCER1 |= TIM_CCER1_CC1P ;
2564  02ca 7212530b      	bset	21259,#1
2566  02ce 2004          	jra	L7031
2567  02d0               L5031:
2568                     ; 973         TIM5->CCER1 &= (uint8_t)(~TIM_CCER1_CC1P) ;
2570  02d0 7213530b      	bres	21259,#1
2571  02d4               L7031:
2572                     ; 975 }
2575  02d4 81            	ret
2611                     ; 985 void TIM5_OC2PolarityConfig(TIM5_OCPolarity_TypeDef TIM5_OCPolarity)
2611                     ; 986 {
2612                     	switch	.text
2613  02d5               _TIM5_OC2PolarityConfig:
2617                     ; 988     assert_param(IS_TIM5_OC_POLARITY(TIM5_OCPolarity));
2619                     ; 991     if (TIM5_OCPolarity == TIM5_OCPolarity_Low) {
2621  02d5 a101          	cp	a,#1
2622  02d7 2606          	jrne	L7231
2623                     ; 992         TIM5->CCER1 |= TIM_CCER1_CC2P ;
2625  02d9 721a530b      	bset	21259,#5
2627  02dd 2004          	jra	L1331
2628  02df               L7231:
2629                     ; 994         TIM5->CCER1 &= (uint8_t)(~TIM_CCER1_CC2P) ;
2631  02df 721b530b      	bres	21259,#5
2632  02e3               L1331:
2633                     ; 996 }
2636  02e3 81            	ret
2681                     ; 1008 void TIM5_CCxCmd(TIM5_Channel_TypeDef TIM5_Channel,
...
2689                     ; 1012     assert_param(IS_TIM5_CHANNEL(TIM5_Channel));
2691                     ; 1013     assert_param(IS_FUNCTIONAL_STATE(NewState));
2693                     ; 1015     if (TIM5_Channel == TIM5_Channel_1) {
...
2703                     ; 1018             TIM5->CCER1 |= TIM_CCER1_CC1E ;
2705  02ed 7210530b      	bset	21259,#0
2707  02f1 2014          	jra	L3631
2708  02f3               L7531:
2709                     ; 1020             TIM5->CCER1 &= (uint8_t)(~TIM_CCER1_CC1E) ;
...
2718                     ; 1026             TIM5->CCER1 |= TIM_CCER1_CC2E;
2720  02fd 7218530b      	bset	21259,#4
2722  0301 2004          	jra	L3631
2723  0303               L5631:
2724                     ; 1028             TIM5->CCER1 &= (uint8_t)(~TIM_CCER1_CC2E) ;
2726  0303 7219530b      	bres	21259,#4
2727  0307               L3631:
2728                     ; 1031 }
2731  0307 85            	popw	x
2732  0308 81            	ret
2896                     ; 1109 void TIM5_ICInit(TIM5_Channel_TypeDef TIM5_Channel,
2896                     ; 1110                  TIM5_ICPolarity_TypeDef TIM5_ICPolarity,
2896                     ; 1111                  TIM5_ICSelection_TypeDef TIM5_ICSelection,
2896                     ; 1112                  TIM5_ICPSC_TypeDef TIM5_ICPrescaler,
2896                     ; 1113                  uint8_t TIM5_ICFilter)
2896                     ; 1114 {
2897                     	switch	.text
2898  0309               _TIM5_ICInit:
2900  0309 89            	pushw	x
2901       00000000      OFST:	set	0
2904                     ; 1116     assert_param(IS_TIM5_CHANNEL(TIM5_Channel));
2906                     ; 1118     if (TIM5_Channel == TIM5_Channel_1) {
2908  030a 9e            	ld	a,xh
2909  030b 4d            	tnz	a
2910  030c 2614          	jrne	L5641
2911                     ; 1120         TI1_Config(TIM5_ICPolarity, TIM5_ICSelection, TIM5_ICFilter);
...
2921  031a 84            	pop	a
2922                     ; 1123         TIM5_SetIC1Prescaler(TIM5_ICPrescaler);
2924  031b 7b06          	ld	a,(OFST+6,sp)
2925  031d cd03fa        	call	_TIM5_SetIC1Prescaler
2928  0320 2012          	jra	L7641
2929  0322               L5641:
2930                     ; 1126         TI2_Config(TIM5_ICPolarity, TIM5_ICSelection, TIM5_ICFilter);
...
2940  032e 84            	pop	a
2941                     ; 1129         TIM5_SetIC2Prescaler(TIM5_ICPrescaler);
...
2950  0334 85            	popw	x
2951  0335 81            	ret
3047                     ; 1157 void TIM5_PWMIConfig(TIM5_Channel_TypeDef TIM5_Channel,
3047                     ; 1158                      TIM5_ICPolarity_TypeDef TIM5_ICPolarity,
3047                     ; 1159                      TIM5_ICSelection_TypeDef TIM5_ICSelection,
3047                     ; 1160                      TIM5_ICPSC_TypeDef TIM5_ICPrescaler,
3047                     ; 1161                      uint8_t TIM5_ICFilter)
3047                     ; 1162 {
3048                     	switch	.text
...
3056                     ; 1163     uint8_t icpolarity = TIM5_ICPolarity_Rising;
3058  0338 7b01          	ld	a,(OFST-1,sp)
3059  033a 97            	ld	xl,a
3060                     ; 1164     uint8_t icselection = TIM5_ICSelection_DirectTI;
3062  033b 7b02          	ld	a,(OFST+0,sp)
3063  033d 97            	ld	xl,a
3064                     ; 1167     assert_param(IS_TIM5_CHANNEL(TIM5_Channel));
3066                     ; 1170     if (TIM5_ICPolarity == TIM5_ICPolarity_Rising) {
3068  033e 0d04          	tnz	(OFST+2,sp)
3069  0340 2606          	jrne	L7351
3070                     ; 1171         icpolarity = TIM5_ICPolarity_Falling;
3072  0342 a601          	ld	a,#1
3073  0344 6b01          	ld	(OFST-1,sp),a
3075  0346 2002          	jra	L1451
3076  0348               L7351:
3077                     ; 1173         icpolarity = TIM5_ICPolarity_Rising;
3079  0348 0f01          	clr	(OFST-1,sp)
3080  034a               L1451:
3081                     ; 1177     if (TIM5_ICSelection == TIM5_ICSelection_DirectTI) {
3083  034a 7b07          	ld	a,(OFST+5,sp)
3084  034c a101          	cp	a,#1
3085  034e 2606          	jrne	L3451
3086                     ; 1178         icselection = TIM5_ICSelection_IndirectTI;
3088  0350 a602          	ld	a,#2
3089  0352 6b02          	ld	(OFST+0,sp),a
3091  0354 2004          	jra	L5451
3092  0356               L3451:
3093                     ; 1180         icselection = TIM5_ICSelection_DirectTI;
3095  0356 a601          	ld	a,#1
3096  0358 6b02          	ld	(OFST+0,sp),a
3097  035a               L5451:
3098                     ; 1183     if (TIM5_Channel == TIM5_Channel_1) {
3100  035a 0d03          	tnz	(OFST+1,sp)
3101  035c 2626          	jrne	L7451
3102                     ; 1185         TI1_Config(TIM5_ICPolarity, TIM5_ICSelection,
3102                     ; 1186                    TIM5_ICFilter);
...
3112  036a 84            	pop	a
3113                     ; 1189         TIM5_SetIC1Prescaler(TIM5_ICPrescaler);
3115  036b 7b08          	ld	a,(OFST+6,sp)
3116  036d cd03fa        	call	_TIM5_SetIC1Prescaler
3118                     ; 1192         TI2_Config((TIM5_ICPolarity_TypeDef)icpolarity, (TIM5_ICSelection_TypeDef)icselection, TIM5_ICFilter);
...
3128  037c 84            	pop	a
3129                     ; 1195         TIM5_SetIC2Prescaler(TIM5_ICPrescaler);
3131  037d 7b08          	ld	a,(OFST+6,sp)
3132  037f cd0416        	call	_TIM5_SetIC2Prescaler
3135  0382 2023          	jra	L1551
3136  0384               L7451:
3137                     ; 1198         TI2_Config(TIM5_ICPolarity, TIM5_ICSelection,
3137                     ; 1199                    TIM5_ICFilter);
...
3147  0390 84            	pop	a
3148                     ; 1202         TIM5_SetIC2Prescaler(TIM5_ICPrescaler);
3150  0391 7b08          	ld	a,(OFST+6,sp)
3151  0393 cd0416        	call	_TIM5_SetIC2Prescaler
3153                     ; 1205         TI1_Config((TIM5_ICPolarity_TypeDef)icpolarity, (TIM5_ICSelection_TypeDef)icselection, TIM5_ICFilter);
...
3163  03a2 84            	pop	a
3164                     ; 1208         TIM5_SetIC1Prescaler(TIM5_ICPrescaler);
...
3174  03a9 81            	ret
3226                     ; 1217 uint16_t TIM5_GetCapture1(void)
3226                     ; 1218 {
3227                     	switch	.text
...
3237                     ; 1222     tmpccr1h = TIM5->CCR1H;
3239  03ae c65311        	ld	a,21265
3240  03b1 6b02          	ld	(OFST-2,sp),a
3241                     ; 1223     tmpccr1l = TIM5->CCR1L;
...
3270  03d1 81            	ret
3322                     ; 1236 uint16_t TIM5_GetCapture2(void)
3322                     ; 1237 {
3323                     	switch	.text
...
3333                     ; 1241     tmpccr2h = TIM5->CCR2H;
3335  03d6 c65313        	ld	a,21267
3336  03d9 6b02          	ld	(OFST-2,sp),a
3337                     ; 1242     tmpccr2l = TIM5->CCR2L;
...
3366  03f9 81            	ret
3411                     ; 1260 void TIM5_SetIC1Prescaler(TIM5_ICPSC_TypeDef TIM5_IC1Prescaler)
3411                     ; 1261 {
3412                     	switch	.text
...
3423                     ; 1265     assert_param(IS_TIM5_IC_PRESCALER(TIM5_IC1Prescaler));
3425                     ; 1267     tmpccmr1 = TIM5->CCMR1;
...
3434                     ; 1273     tmpccmr1 |= (uint8_t)TIM5_IC1Prescaler;
3436  0409 7b01          	ld	a,(OFST+0,sp)
3437  040b 1a02          	or	a,(OFST+1,sp)
3438  040d 6b01          	ld	(OFST+0,sp),a
3439                     ; 1275     TIM5->CCMR1 = tmpccmr1;
3441  040f 7b01          	ld	a,(OFST+0,sp)
3442  0411 c75309        	ld	21257,a
3443                     ; 1276 }
3446  0414 85            	popw	x
3447  0415 81            	ret
3492                     ; 1288 void TIM5_SetIC2Prescaler(TIM5_ICPSC_TypeDef TIM5_IC2Prescaler)
3492                     ; 1289 {
3493                     	switch	.text
...
3504                     ; 1293     assert_param(IS_TIM5_IC_PRESCALER(TIM5_IC2Prescaler));
3506                     ; 1295     tmpccmr2 = TIM5->CCMR2;
...
3649  0449 85            	popw	x
3650  044a 81            	ret
3731                     ; 1361 void TIM5_GenerateEvent(TIM5_EventSource_TypeDef TIM5_EventSource)
3731                     ; 1362 {
3732                     	switch	.text
3733  044b               _TIM5_GenerateEvent:
3737                     ; 1364     assert_param(IS_TIM5_EVENT_SOURCE((uint8_t)TIM5_EventSource));
3739                     ; 1367     TIM5->EGR |= (uint8_t)TIM5_EventSource;
3741  044b ca5308        	or	a,21256
3742  044e c75308        	ld	21256,a
3743                     ; 1368 }
3746  0451 81            	ret
3885                     ; 1383 FlagStatus TIM5_GetFlagStatus(TIM5_FLAG_TypeDef TIM5_FLAG)
3885                     ; 1384 {
3886                     	switch	.text
...
3940  047d 81            	ret
3975                     ; 1413 void TIM5_ClearFlag(TIM5_FLAG_TypeDef TIM5_FLAG)
3975                     ; 1414 {
3976                     	switch	.text
3977  047e               _TIM5_ClearFlag:
3979  047e 89            	pushw	x
3980       00000000      OFST:	set	0
3983                     ; 1416     assert_param(IS_TIM5_CLEAR_FLAG((uint16_t)TIM5_FLAG));
3985                     ; 1418     TIM5->SR1 = (uint8_t)(~(uint8_t)(TIM5_FLAG));
3987  047f 9f            	ld	a,xl
3988  0480 43            	cpl	a
3989  0481 c75306        	ld	21254,a
3990                     ; 1419     TIM5->SR2 = (uint8_t)(~(uint8_t)((uint16_t)TIM5_FLAG >> 8));
...
3998  048a 85            	popw	x
3999  048b 81            	ret
4063                     ; 1433 ITStatus TIM5_GetITStatus(TIM5_IT_TypeDef TIM5_IT)
4063                     ; 1434 {
4064                     	switch	.text
...
4076                     ; 1437     uint8_t TIM5_itStatus = 0x0, TIM5_itEnable = 0x0;
4078  0491 7b01          	ld	a,(OFST-1,sp)
4079  0493 97            	ld	xl,a
4082  0494 7b02          	ld	a,(OFST+0,sp)
4083  0496 97            	ld	xl,a
4084                     ; 1440     assert_param(IS_TIM5_GET_IT(TIM5_IT));
4086                     ; 1442     TIM5_itStatus = (uint8_t)(TIM5->SR1 & (uint8_t)TIM5_IT);
4088  0497 c65306        	ld	a,21254
4089  049a 1403          	and	a,(OFST+1,sp)
4090  049c 6b01          	ld	(OFST-1,sp),a
4091                     ; 1444     TIM5_itEnable = (uint8_t)(TIM5->IER & (uint8_t)TIM5_IT);
4093  049e c65305        	ld	a,21253
4094  04a1 1403          	and	a,(OFST+1,sp)
4095  04a3 6b02          	ld	(OFST+0,sp),a
4096                     ; 1446     if ((TIM5_itStatus != (uint8_t)RESET ) && (TIM5_itEnable != (uint8_t)RESET)) {
...
4120  04b9 81            	ret
4156                     ; 1465 void TIM5_ClearITPendingBit(TIM5_IT_TypeDef TIM5_IT)
4156                     ; 1466 {
4157                     	switch	.text
4158  04ba               _TIM5_ClearITPendingBit:
4162                     ; 1468     assert_param(IS_TIM5_IT(TIM5_IT));
4164                     ; 1471     TIM5->SR1 = (uint8_t)(~(uint8_t)TIM5_IT);
4166  04ba 43            	cpl	a
4167  04bb c75306        	ld	21254,a
4168                     ; 1472 }
4171  04be 81            	ret
4244                     ; 1485 void TIM5_DMACmd( TIM5_DMASource_TypeDef TIM5_DMASource, FunctionalState NewState)
4244                     ; 1486 {
4245                     	switch	.text
...
4279  04d6 85            	popw	x
4280  04d7 81            	ret
4315                     ; 1506 void TIM5_SelectCCDMA(FunctionalState NewState)
4315                     ; 1507 {
4316                     	switch	.text
...
4327                     ; 1513         TIM5->CR2 |= TIM_CR2_CCDS;
4329  04db 72165301      	bset	21249,#3
4331  04df 2004          	jra	L5322
4332  04e1               L3322:
4333                     ; 1516         TIM5->CR2 &= (uint8_t)(~TIM_CR2_CCDS);
4335  04e1 72175301      	bres	21249,#3
4336  04e5               L5322:
4337                     ; 1518 }
4340  04e5 81            	ret
4364                     ; 1542 void TIM5_InternalClockConfig(void)
4364                     ; 1543 {
4365                     	switch	.text
4366  04e6               _TIM5_InternalClockConfig:
4370                     ; 1545     TIM5->SMCR &=  (uint8_t)(~TIM_SMCR_SMS);
4372  04e6 c65302        	ld	a,21250
4373  04e9 a4f8          	and	a,#248
4374  04eb c75302        	ld	21250,a
4375                     ; 1546 }
4378  04ee 81            	ret
4467                     ; 1563 void TIM5_TIxExternalClockConfig(TIM5_TIxExternalCLK1Source_TypeDef TIM5_TIxExternalCLKSource,
4467                     ; 1564                                  TIM5_ICPolarity_TypeDef TIM5_ICPolarity,
...
4475                     ; 1568     assert_param(IS_TIM5_TIXCLK_SOURCE(TIM5_TIxExternalCLKSource));
4477                     ; 1569     assert_param(IS_TIM5_IC_POLARITY(TIM5_ICPolarity));
4479                     ; 1570     assert_param(IS_TIM5_IC_FILTER(ICFilter));
4481                     ; 1573     if (TIM5_TIxExternalCLKSource == TIM5_TIxExternalCLK1Source_TI2) {
4483  04f0 9e            	ld	a,xh
4484  04f1 a160          	cp	a,#96
4485  04f3 260f          	jrne	L7032
4486                     ; 1574         TI2_Config(TIM5_ICPolarity, TIM5_ICSelection_DirectTI, ICFilter);
...
4498  0504               L7032:
4499                     ; 1576         TI1_Config(TIM5_ICPolarity, TIM5_ICSelection_DirectTI, ICFilter);
...
4508  0510 84            	pop	a
4509  0511               L1132:
4510                     ; 1580     TIM5_SelectInputTrigger((TIM5_TRGSelection_TypeDef)TIM5_TIxExternalCLKSource);
4512  0511 7b01          	ld	a,(OFST+1,sp)
4513  0513 ad4b          	call	_TIM5_SelectInputTrigger
4515                     ; 1583     TIM5->SMCR |= (uint8_t)(TIM5_SlaveMode_External1);
...
4523  051d 85            	popw	x
4524  051e 81            	ret
4641                     ; 1602 void TIM5_ETRClockMode1Config(TIM5_ExtTRGPSC_TypeDef TIM5_ExtTRGPrescaler,
4641                     ; 1603                               TIM5_ExtTRGPolarity_TypeDef TIM5_ExtTRGPolarity,
...
4649                     ; 1607     TIM5_ETRConfig(TIM5_ExtTRGPrescaler, TIM5_ExtTRGPolarity, ExtTRGFilter);
...
4683  054c 85            	popw	x
4684  054d 81            	ret
4742                     ; 1634 void TIM5_ETRClockMode2Config(TIM5_ExtTRGPSC_TypeDef TIM5_ExtTRGPrescaler,
4742                     ; 1635                               TIM5_ExtTRGPolarity_TypeDef TIM5_ExtTRGPolarity,
...
4750                     ; 1639     TIM5_ETRConfig(TIM5_ExtTRGPrescaler, TIM5_ExtTRGPolarity, ExtTRGFilter);
...
4760  0559 84            	pop	a
4761                     ; 1642     TIM5->ETR |= TIM_ETR_ECE ;
4763  055a 721c5303      	bset	21251,#6
4764                     ; 1643 }
4767  055e 85            	popw	x
4768  055f 81            	ret
4884                     ; 1694 void TIM5_SelectInputTrigger(TIM5_TRGSelection_TypeDef TIM5_InputTriggerSource)
4884                     ; 1695 {
4885                     	switch	.text
...
4896                     ; 1699     assert_param(IS_TIM5_TRIGGER_SELECTION(TIM5_InputTriggerSource));
4898                     ; 1701     tmpsmcr = TIM5->SMCR;
...
4907                     ; 1705     tmpsmcr |= (uint8_t)TIM5_InputTriggerSource;
4909  056f 7b01          	ld	a,(OFST+0,sp)
4910  0571 1a02          	or	a,(OFST+1,sp)
4911  0573 6b01          	ld	(OFST+0,sp),a
4912                     ; 1707     TIM5->SMCR = (uint8_t)tmpsmcr;
4914  0575 7b01          	ld	a,(OFST+0,sp)
4915  0577 c75302        	ld	21250,a
4916                     ; 1708 }
4919  057a 85            	popw	x
4920  057b 81            	ret
5019                     ; 1722 void TIM5_SelectOutputTrigger(TIM5_TRGOSource_TypeDef TIM5_TRGOSource)
5019                     ; 1723 {
5020                     	switch	.text
...
5031                     ; 1727     assert_param(IS_TIM5_TRGO_SOURCE(TIM5_TRGOSource));
5033                     ; 1729     tmpcr2 = TIM5->CR2;
...
5150                     ; 1755     assert_param(IS_TIM5_SLAVE_MODE(TIM5_SlaveMode));
5152                     ; 1757     tmpsmcr = TIM5->SMCR;
...
5222                     ; 1781         TIM5->SMCR |= TIM_SMCR_MSM;
5224  05b7 721e5302      	bset	21250,#7
5226  05bb 2004          	jra	L1062
5227  05bd               L7752:
5228                     ; 1783         TIM5->SMCR &= (uint8_t)(~TIM_SMCR_MSM);
5230  05bd 721f5302      	bres	21250,#7
5231  05c1               L1062:
5232                     ; 1785 }
5235  05c1 81            	ret
5291                     ; 1803 void TIM5_ETRConfig(TIM5_ExtTRGPSC_TypeDef TIM5_ExtTRGPrescaler,
5291                     ; 1804                     TIM5_ExtTRGPolarity_TypeDef TIM5_ExtTRGPolarity,
...
5299                     ; 1808     assert_param(IS_TIM5_EXT_PRESCALER(TIM5_ExtTRGPrescaler));
5301                     ; 1809     assert_param(IS_TIM5_EXT_POLARITY(TIM5_ExtTRGPolarity));
5303                     ; 1810     assert_param(IS_TIM5_EXT_FILTER(ExtTRGFilter));
5305                     ; 1813     TIM5->ETR |= (uint8_t)((uint8_t)((uint8_t)TIM5_ExtTRGPrescaler | (uint8_t)TIM5_ExtTRGPolarity)
...
5315  05ce 85            	popw	x
5316  05cf 81            	ret
5429                     ; 1850 void TIM5_EncoderInterfaceConfig(TIM5_EncoderMode_TypeDef TIM5_EncoderMode,
5429                     ; 1851                                  TIM5_ICPolarity_TypeDef TIM5_IC1Polarity,
5429                     ; 1852                                  TIM5_ICPolarity_TypeDef TIM5_IC2Polarity)
5429                     ; 1853 {
5430                     	switch	.text
...
5450                     ; 1859     assert_param(IS_TIM5_ENCODER_MODE(TIM5_EncoderMode));
5452                     ; 1860     assert_param(IS_TIM5_IC_POLARITY(TIM5_IC1Polarity));
5454                     ; 1861     assert_param(IS_TIM5_IC_POLARITY(TIM5_IC2Polarity));
5456                     ; 1863     tmpsmcr = TIM5->SMCR;
5458  05dc c65302        	ld	a,21250
5459  05df 6b01          	ld	(OFST-2,sp),a
5460                     ; 1864     tmpccmr1 = TIM5->CCMR1;
5462  05e1 c65309        	ld	a,21257
5463  05e4 6b02          	ld	(OFST-1,sp),a
5464                     ; 1865     tmpccmr2 = TIM5->CCMR2;
...
5473                     ; 1869     tmpsmcr |= (uint8_t)TIM5_EncoderMode;
...
5592                     ; 1908         TIM5->CR2 |= TIM_CR2_TI1S;
5594  0644 721e5301      	bset	21249,#7
5596  0648 2004          	jra	L5372
5597  064a               L3372:
5598                     ; 1910         TIM5->CR2 &= (uint8_t)(~TIM_CR2_TI1S);
5600  064a 721f5301      	bres	21249,#7
5601  064e               L5372:
5602                     ; 1912 }
5605  064e 81            	ret
5677                     ; 1933 static void TI1_Config(TIM5_ICPolarity_TypeDef TIM5_ICPolarity, \
5677                     ; 1934                        TIM5_ICSelection_TypeDef TIM5_ICSelection, \
5677                     ; 1935                        uint8_t TIM5_ICFilter)
5677                     ; 1936 {
5678                     	switch	.text
...
5690                     ; 1938     uint8_t tmpicpolarity = TIM5_ICPolarity;
5692  0654 7b03          	ld	a,(OFST+1,sp)
5693  0656 6b01          	ld	(OFST-1,sp),a
5694                     ; 1939     tmpccmr1 = TIM5->CCMR1;
5696  0658 c65309        	ld	a,21257
5697  065b 6b02          	ld	(OFST+0,sp),a
5698                     ; 1942     assert_param(IS_TIM5_IC_POLARITY(TIM5_ICPolarity));
5700                     ; 1943     assert_param(IS_TIM5_IC_SELECTION(TIM5_ICSelection));
5702                     ; 1944     assert_param(IS_TIM5_IC_FILTER(TIM5_ICFilter));
5704                     ; 1947     TIM5->CCER1 &=  (uint8_t)(~TIM_CCER1_CC1E);
...
5712                     ; 1951     tmpccmr1 |= (uint8_t)(((uint8_t)(TIM5_ICSelection)) | ((uint8_t)(TIM5_ICFilter << 4)));
...
5722                     ; 1953     TIM5->CCMR1 = tmpccmr1;
5724  0674 7b02          	ld	a,(OFST+0,sp)
5725  0676 c75309        	ld	21257,a
5726                     ; 1956     if (tmpicpolarity == (uint8_t)(TIM5_ICPolarity_Falling)) {
5728  0679 7b01          	ld	a,(OFST-1,sp)
5729  067b a101          	cp	a,#1
5730  067d 2606          	jrne	L5772
5731                     ; 1957         TIM5->CCER1 |= TIM_CCER1_CC1P;
5733  067f 7212530b      	bset	21259,#1
5735  0683 2004          	jra	L7772
5736  0685               L5772:
5737                     ; 1959         TIM5->CCER1 &= (uint8_t)(~TIM_CCER1_CC1P);
5739  0685 7213530b      	bres	21259,#1
5740  0689               L7772:
5741                     ; 1963     TIM5->CCER1 |=  TIM_CCER1_CC1E;
5743  0689 7210530b      	bset	21259,#0
5744                     ; 1964 }
5747  068d 5b04          	addw	sp,#4
5748  068f 81            	ret
5820                     ; 1981 static void TI2_Config(TIM5_ICPolarity_TypeDef TIM5_ICPolarity,
5820                     ; 1982                        TIM5_ICSelection_TypeDef TIM5_ICSelection,
5820                     ; 1983                        uint8_t TIM5_ICFilter)
5820                     ; 1984 {
5821                     	switch	.text
...
5833                     ; 1986     uint8_t tmpicpolarity = TIM5_ICPolarity;
5835  0695 7b03          	ld	a,(OFST+1,sp)
5836  0697 6b01          	ld	(OFST-1,sp),a
5837                     ; 1989     assert_param(IS_TIM5_IC_POLARITY(TIM5_ICPolarity));
5839                     ; 1990     assert_param(IS_TIM5_IC_SELECTION(TIM5_ICSelection));
5841                     ; 1991     assert_param(IS_TIM5_IC_FILTER(TIM5_ICFilter));
5843                     ; 1993     tmpccmr2 = TIM5->CCMR2;
5845  0699 c6530a        	ld	a,21258
5846  069c 6b02          	ld	(OFST+0,sp),a
5847                     ; 1996     TIM5->CCER1 &=  (uint8_t)(~TIM_CCER1_CC2E);
...
5855                     ; 2000     tmpccmr2 |= (uint8_t)(((uint8_t)(TIM5_ICSelection)) | ((uint8_t)(TIM5_ICFilter << 4)));
