 ...
 164                     ; 161         CLK->ICKCR |= CLK_ICKCR_HSION;
 166  0044 721050c2      	bset	20674,#0
 168  0048 2004          	jra	L15
 169  004a               L74:
 170                     ; 164         CLK->ICKCR &= (uint8_t)(~CLK_ICKCR_HSION);
 172  004a 721150c2      	bres	20674,#0
 173  004e               L15:
 174                     ; 166 }
 177  004e 81            	ret
 213                     ; 179 void CLK_AdjustHSICalibrationValue(uint8_t CLK_HSICalibrationValue)
 213                     ; 180 {
 214                     	switch	.text
 215  004f               _CLK_AdjustHSICalibrationValue:
 219                     ; 182     CLK->HSIUNLCKR = 0xAC;
 221  004f 35ac50ce      	mov	20686,#172
 222                     ; 183     CLK->HSIUNLCKR = 0x35;
 224  0053 353550ce      	mov	20686,#53
 225                     ; 186     CLK->HSITRIMR = (uint8_t)CLK_HSICalibrationValue;
 227  0057 c750cd        	ld	20685,a
 228                     ; 187 }
 231  005a 81            	ret
 266                     ; 203 void CLK_LSICmd(FunctionalState NewState)
 266                     ; 204 {
 267                     	switch	.text
 268  005b               _CLK_LSICmd:
 272                     ; 207     assert_param(IS_FUNCTIONAL_STATE(NewState));
 274                     ; 209     if (NewState != DISABLE) {
 276  005b 4d            	tnz	a
 277  005c 2706          	jreq	L701
 278                     ; 211         CLK->ICKCR |= CLK_ICKCR_LSION;
 280  005e 721450c2      	bset	20674,#2
 282  0062 2004          	jra	L111
 283  0064               L701:
 284                     ; 214         CLK->ICKCR &= (uint8_t)(~CLK_ICKCR_LSION);
 286  0064 721550c2      	bres	20674,#2
 287  0068               L111:
 288                     ; 216 }
 291  0068 81            	ret
 353                     ; 237 void CLK_HSEConfig(CLK_HSE_TypeDef CLK_HSE)
 353                     ; 238 {
 354                     	switch	.text
 355  0069               _CLK_HSEConfig:
 359                     ; 240     assert_param(IS_CLK_HSE(CLK_HSE));
 361                     ; 244     CLK->ECKCR &= (uint8_t)~CLK_ECKCR_HSEON;
 363  0069 721150c6      	bres	20678,#0
 364                     ; 247     CLK->ECKCR &= (uint8_t)~CLK_ECKCR_HSEBYP;
 366  006d 721950c6      	bres	20678,#4
 367                     ; 250     CLK->ECKCR |= (uint8_t)CLK_HSE;
 369  0071 ca50c6        	or	a,20678
 370  0074 c750c6        	ld	20678,a
 371                     ; 251 }
 374  0077 81            	ret
 436                     ; 268 void CLK_LSEConfig(CLK_LSE_TypeDef CLK_LSE)
 436                     ; 269 {
 437                     	switch	.text
 438  0078               _CLK_LSEConfig:
 442                     ; 271     assert_param(IS_CLK_LSE(CLK_LSE));
 444                     ; 275     CLK->ECKCR &= (uint8_t)~CLK_ECKCR_LSEON;
 446  0078 721550c6      	bres	20678,#2
 447                     ; 278     CLK->ECKCR &= (uint8_t)~CLK_ECKCR_LSEBYP;
 449  007c 721b50c6      	bres	20678,#5
 450                     ; 281     CLK->ECKCR |= (uint8_t)CLK_LSE;
 452  0080 ca50c6        	or	a,20678
 453  0083 c750c6        	ld	20678,a
 454                     ; 283 }
 457  0086 81            	ret
 481                     ; 294 void CLK_ClockSecuritySystemEnable(void)
 481                     ; 295 {
 482                     	switch	.text
 483  0087               _CLK_ClockSecuritySystemEnable:
 487                     ; 297     CLK->CSSR |= CLK_CSSR_CSSEN;
 489  0087 721050ca      	bset	20682,#0
 490                     ; 298 }
 493  008b 81            	ret
 529                     ; 305 void CLK_ClockSecuritySytemDeglitchCmd(FunctionalState NewState)
 529                     ; 306 {
 530                     	switch	.text
 531  008c               _CLK_ClockSecuritySytemDeglitchCmd:
 535                     ; 308     assert_param(IS_FUNCTIONAL_STATE(NewState));
 537                     ; 310     if (NewState != DISABLE) {
 539  008c 4d            	tnz	a
 540  008d 2706          	jreq	L122
 541                     ; 312         CLK->CSSR |= CLK_CSSR_CSSDGON;
 543  008f 721850ca      	bset	20682,#4
 545  0093 2004          	jra	L322
 546  0095               L122:
 547                     ; 315         CLK->CSSR &= (uint8_t)(~CLK_CSSR_CSSDGON);
 549  0095 721950ca      	bres	20682,#4
 550  0099               L322:
 551                     ; 317 }
 554  0099 81            	ret
 695                     ; 341 void CLK_CCOConfig(CLK_CCOSource_TypeDef CLK_CCOSource, CLK_CCODiv_TypeDef CLK_CCODiv)
 695                     ; 342 {
 696                     	switch	.text
 697  009a               _CLK_CCOConfig:
 699  009a 89            	pushw	x
 700       00000000      OFST:	set	0
 703                     ; 344     assert_param(IS_CLK_OUTPUT(CLK_CCOSource));
 705                     ; 345     assert_param(IS_CLK_OUTPUT_DIVIDER(CLK_CCODiv));
 707                     ; 348     CLK->CCOR = (uint8_t)((uint8_t)CLK_CCOSource | (uint8_t)CLK_CCODiv);
 709  009b 9f            	ld	a,xl
 ...
 715  00a1 85            	popw	x
 716  00a2 81            	ret
 790                     ; 401 void CLK_SYSCLKSourceConfig(CLK_SYSCLKSource_TypeDef CLK_SYSCLKSource)
 790                     ; 402 {
 791                     	switch	.text
 792  00a3               _CLK_SYSCLKSourceConfig:
 796                     ; 404     assert_param(IS_CLK_SOURCE(CLK_SYSCLKSource));
 798                     ; 407     CLK->SWR = (uint8_t)CLK_SYSCLKSource;
 800  00a3 c750c8        	ld	20680,a
 801                     ; 408 }
 804  00a6 81            	ret
 829                     ; 420 CLK_SYSCLKSource_TypeDef CLK_GetSYSCLKSource(void)
 829                     ; 421 {
 830                     	switch	.text
 831  00a7               _CLK_GetSYSCLKSource:
 835                     ; 422     return ((CLK_SYSCLKSource_TypeDef)(CLK->SCSR));
 837  00a7 c650c7        	ld	a,20679
 840  00aa 81            	ret
 912                     ; 463 uint32_t CLK_GetClockFreq(void)
 912                     ; 464 {
 913                     	switch	.text
 914  00ab               _CLK_GetClockFreq:
 916  00ab 5209          	subw	sp,#9
 917       00000009      OFST:	set	9
 920                     ; 465     uint32_t clockfrequency = 0;
 922  00ad 96            	ldw	x,sp
 923  00ae 1c0005        	addw	x,#OFST-4
 924  00b1 cd0000        	call	c_ltor
 926                     ; 466     uint32_t sourcefrequency = 0;
 928  00b4 ae0000        	ldw	x,#0
 929  00b7 1f07          	ldw	(OFST-2,sp),x
 930  00b9 ae0000        	ldw	x,#0
 931  00bc 1f05          	ldw	(OFST-4,sp),x
 932                     ; 467     CLK_SYSCLKSource_TypeDef clocksource = CLK_SYSCLKSource_HSI;
 934  00be 7b09          	ld	a,(OFST+0,sp)
 935  00c0 97            	ld	xl,a
 936                     ; 468     uint8_t tmp = 0, presc = 0;
 938  00c1 7b09          	ld	a,(OFST+0,sp)
 939  00c3 97            	ld	xl,a
 942  00c4 7b09          	ld	a,(OFST+0,sp)
 943  00c6 97            	ld	xl,a
 944                     ; 471     clocksource = (CLK_SYSCLKSource_TypeDef)CLK->SCSR;
 946  00c7 c650c7        	ld	a,20679
 947  00ca 6b09          	ld	(OFST+0,sp),a
 948                     ; 473     if ( clocksource == CLK_SYSCLKSource_HSI) {
 950  00cc 7b09          	ld	a,(OFST+0,sp)
 951  00ce a101          	cp	a,#1
 952  00d0 260c          	jrne	L704
 953                     ; 474         sourcefrequency = HSI_VALUE;
 ...
 961  00de               L704:
 962                     ; 475     } else if ( clocksource == CLK_SYSCLKSource_LSI) {
 964  00de 7b09          	ld	a,(OFST+0,sp)
 965  00e0 a102          	cp	a,#2
 966  00e2 260c          	jrne	L314
 967                     ; 476         sourcefrequency = LSI_VALUE;
 ...
 975  00f0               L314:
 976                     ; 477     } else if ( clocksource == CLK_SYSCLKSource_HSE) {
 978  00f0 7b09          	ld	a,(OFST+0,sp)
 979  00f2 a104          	cp	a,#4
 980  00f4 260c          	jrne	L714
 981                     ; 478         sourcefrequency = HSE_VALUE;
...
1032                     ; 490     return((uint32_t)clockfrequency);
1034  013f 96            	ldw	x,sp
1035  0140 1c0005        	addw	x,#OFST-4
1036  0143 cd0000        	call	c_ltor
1040  0146 5b09          	addw	sp,#9
1041  0148 81            	ret
1139                     ; 506 void CLK_SYSCLKDivConfig(CLK_SYSCLKDiv_TypeDef CLK_SYSCLKDiv)
1139                     ; 507 {
1140                     	switch	.text
1141  0149               _CLK_SYSCLKDivConfig:
1145                     ; 509     assert_param(IS_CLK_SYSTEM_DIVIDER(CLK_SYSCLKDiv));
1147                     ; 511     CLK->CKDIVR = (uint8_t)(CLK_SYSCLKDiv);
1149  0149 c750c0        	ld	20672,a
1150                     ; 512 }
1153  014c 81            	ret
1189                     ; 519 void CLK_SYSCLKSourceSwitchCmd(FunctionalState NewState)
1189                     ; 520 {
1190                     	switch	.text
1191  014d               _CLK_SYSCLKSourceSwitchCmd:
1195                     ; 522     assert_param(IS_FUNCTIONAL_STATE(NewState));
1197                     ; 524     if (NewState != DISABLE) {
1199  014d 4d            	tnz	a
1200  014e 2706          	jreq	L305
1201                     ; 526         CLK->SWCR |= CLK_SWCR_SWEN;
1203  0150 721250c9      	bset	20681,#1
1205  0154 2004          	jra	L505
1206  0156               L305:
1207                     ; 529         CLK->SWCR &= (uint8_t)(~CLK_SWCR_SWEN);
1209  0156 721350c9      	bres	20681,#1
1210  015a               L505:
1211                     ; 531 }
1214  015a 81            	ret
1360                     ; 591 void CLK_RTCClockConfig(CLK_RTCCLKSource_TypeDef CLK_RTCCLKSource, CLK_RTCCLKDiv_TypeDef CLK_RTCCLKDiv)
1360                     ; 592 {
1361                     	switch	.text
1362  015b               _CLK_RTCClockConfig:
1364  015b 89            	pushw	x
1365       00000000      OFST:	set	0
1368                     ; 594     assert_param(IS_CLK_CLOCK_RTC(CLK_RTCCLKSource));
1370                     ; 595     assert_param(IS_CLK_CLOCK_RTC_DIV(CLK_RTCCLKDiv));
1372                     ; 598     CLK->CRTCR = (uint8_t)((uint8_t)CLK_RTCCLKSource | (uint8_t)CLK_RTCCLKDiv);
...
1380  0162 85            	popw	x
1381  0163 81            	ret
1447                     ; 610 void CLK_BEEPClockConfig(CLK_BEEPCLKSource_TypeDef CLK_BEEPCLKSource)
1447                     ; 611 {
1448                     	switch	.text
1449  0164               _CLK_BEEPClockConfig:
1453                     ; 613     assert_param(IS_CLK_CLOCK_BEEP(CLK_BEEPCLKSource));
1455                     ; 616     CLK->CBEEPR = (uint8_t)(CLK_BEEPCLKSource);
1457  0164 c750cb        	ld	20683,a
1458                     ; 618 }
1461  0167 81            	ret
1686                     ; 652 void CLK_PeripheralClockConfig(CLK_Peripheral_TypeDef CLK_Peripheral, FunctionalState NewState)
1686                     ; 653 {
1687                     	switch	.text
...
1695                     ; 654     uint8_t reg = 0;
1697  016a 0f01          	clr	(OFST+0,sp)
1698                     ; 657     assert_param(IS_CLK_PERIPHERAL(CLK_Peripheral));
1700                     ; 658     assert_param(IS_FUNCTIONAL_STATE(NewState));
1702                     ; 661     reg = (uint8_t)((uint8_t)CLK_Peripheral & (uint8_t)0xF0);
1704  016c 9e            	ld	a,xh
1705  016d a4f0          	and	a,#240
1706  016f 6b01          	ld	(OFST+0,sp),a
1707                     ; 663     if ( reg == 0x00) {
1709  0171 0d01          	tnz	(OFST+0,sp)
1710  0173 2635          	jrne	L527
1711                     ; 664         if (NewState != DISABLE) {
1713  0175 0d03          	tnz	(OFST+2,sp)
1714  0177 2719          	jreq	L727
1715                     ; 666             CLK->PCKENR1 |= (uint8_t)((uint8_t)1 << ((uint8_t)CLK_Peripheral & (uint8_t)0x0F));
...
1733  0192               L727:
1734                     ; 669             CLK->PCKENR1 &= (uint8_t)(~(uint8_t)(((uint8_t)1 << ((uint8_t)CLK_Peripheral & (uint8_t)0x0F))));
...
1752  01aa               L527:
1753                     ; 671     } else if (reg == 0x10) {
1755  01aa 7b01          	ld	a,(OFST+0,sp)
1756  01ac a110          	cp	a,#16
1757  01ae 2633          	jrne	L537
1758                     ; 672         if (NewState != DISABLE) {
1760  01b0 0d03          	tnz	(OFST+2,sp)
1761  01b2 2717          	jreq	L737
1762                     ; 674             CLK->PCKENR2 |= (uint8_t)((uint8_t)1 << ((uint8_t)CLK_Peripheral & (uint8_t)0x0F));
...
1780  01cb               L737:
1781                     ; 677             CLK->PCKENR2 &= (uint8_t)(~(uint8_t)(((uint8_t)1 << ((uint8_t)CLK_Peripheral & (uint8_t)0x0F))));
...
1799  01e3               L537:
1800                     ; 680         if (NewState != DISABLE) {
1802  01e3 0d03          	tnz	(OFST+2,sp)
1803  01e5 2717          	jreq	L547
1804                     ; 682             CLK->PCKENR3 |= (uint8_t)((uint8_t)1 << ((uint8_t)CLK_Peripheral & (uint8_t)0x0F));
...
1822  01fe               L547:
1823                     ; 685             CLK->PCKENR3 &= (uint8_t)(~(uint8_t)(((uint8_t)1 << ((uint8_t)CLK_Peripheral & (uint8_t)0x0F))));
...
1845  0216 81            	ret
1869                     ; 726 void CLK_LSEClockSecuritySystemEnable(void)
1869                     ; 727 {
1870                     	switch	.text
1871  0217               _CLK_LSEClockSecuritySystemEnable:
1875                     ; 729     CSSLSE->CSR |= CSSLSE_CSR_CSSEN;
1877  0217 72105190      	bset	20880,#0
1878                     ; 730 }
1881  021b 81            	ret
1905                     ; 738 void CLK_RTCCLKSwitchOnLSEFailureEnable(void)
1905                     ; 739 {
1906                     	switch	.text
1907  021c               _CLK_RTCCLKSwitchOnLSEFailureEnable:
1911                     ; 741     CSSLSE->CSR |= CSSLSE_CSR_SWITCHEN;
1913  021c 72125190      	bset	20880,#1
1914                     ; 742 }
1917  0220 81            	ret
1992                     ; 768 void CLK_HaltConfig(CLK_Halt_TypeDef CLK_Halt, FunctionalState NewState)
1992                     ; 769 {
1993                     	switch	.text
1994  0221               _CLK_HaltConfig:
1996  0221 89            	pushw	x
1997       00000000      OFST:	set	0
2000                     ; 771     assert_param(IS_CLK_HALT(CLK_Halt));
2002                     ; 772     assert_param(IS_FUNCTIONAL_STATE(NewState));
2004                     ; 774     if (NewState != DISABLE) {
2006  0222 9f            	ld	a,xl
2007  0223 4d            	tnz	a
2008  0224 2709          	jreq	L5201
2009                     ; 775         CLK->ICKCR |= (uint8_t)(CLK_Halt);
2011  0226 9e            	ld	a,xh
2012  0227 ca50c2        	or	a,20674
2013  022a c750c2        	ld	20674,a
2015  022d 2009          	jra	L7201
2016  022f               L5201:
2017                     ; 777         CLK->ICKCR &= (uint8_t)(~CLK_Halt);
...
2606                     ; 924         bitstatus = SET;
2608  031b a601          	ld	a,#1
2609  031d 6b02          	ld	(OFST+0,sp),a
2611  031f 2002          	jra	L1131
2612  0321               L7031:
2613                     ; 926         bitstatus = RESET;
2615  0321 0f02          	clr	(OFST+0,sp)
2616  0323               L1131:
2617                     ; 930     return((FlagStatus)bitstatus);
2619  0323 7b02          	ld	a,(OFST+0,sp)
2622  0325 5b03          	addw	sp,#3
2623  0327 81            	ret
2646                     ; 938 void CLK_ClearFlag(void)
2646                     ; 939 {
2647                     	switch	.text
2648  0328               _CLK_ClearFlag:
2652                     ; 942     CSSLSE->CSR &= (uint8_t)(~CSSLSE_CSR_CSSF);
2654  0328 72175190      	bres	20880,#3
2655                     ; 943 }
2658  032c 81            	ret
2704                     ; 954 ITStatus CLK_GetITStatus(CLK_IT_TypeDef CLK_IT)
2704                     ; 955 {
2705                     	switch	.text
