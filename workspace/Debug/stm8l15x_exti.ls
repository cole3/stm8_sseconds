 ...
 254  0055               L12:
 255                     ; 163     case EXTI_Pin_0:
 255                     ; 164         EXTI->CR1 &=  (uint8_t)(~EXTI_CR1_P0IS);
 257  0055 c650a0        	ld	a,20640
 258  0058 a4fc          	and	a,#252
 259  005a c750a0        	ld	20640,a
 260                     ; 165         EXTI->CR1 |= (uint8_t)((uint8_t)(EXTI_Trigger) << EXTI_Pin);
 ...
 278  0074               L32:
 279                     ; 167     case EXTI_Pin_1:
 279                     ; 168         EXTI->CR1 &=  (uint8_t)(~EXTI_CR1_P1IS);
 281  0074 c650a0        	ld	a,20640
 282  0077 a4f3          	and	a,#243
 283  0079 c750a0        	ld	20640,a
 284                     ; 169         EXTI->CR1 |= (uint8_t)((uint8_t)(EXTI_Trigger) << EXTI_Pin);
 ...
 302  0093               L52:
 303                     ; 171     case EXTI_Pin_2:
 303                     ; 172         EXTI->CR1 &=  (uint8_t)(~EXTI_CR1_P2IS);
 305  0093 c650a0        	ld	a,20640
 306  0096 a4cf          	and	a,#207
 307  0098 c750a0        	ld	20640,a
 308                     ; 173         EXTI->CR1 |= (uint8_t)((uint8_t)(EXTI_Trigger) << EXTI_Pin);
 ...
 326  00b2               L72:
 327                     ; 175     case EXTI_Pin_3:
 327                     ; 176         EXTI->CR1 &=  (uint8_t)(~EXTI_CR1_P3IS);
 329  00b2 c650a0        	ld	a,20640
 330  00b5 a43f          	and	a,#63
 331  00b7 c750a0        	ld	20640,a
 332                     ; 177         EXTI->CR1 |= (uint8_t)((uint8_t)(EXTI_Trigger) << EXTI_Pin);
 ...
 350  00cf               L13:
 351                     ; 179     case EXTI_Pin_4:
 351                     ; 180         EXTI->CR2 &=  (uint8_t)(~EXTI_CR2_P4IS);
 353  00cf c650a1        	ld	a,20641
 354  00d2 a4fc          	and	a,#252
 355  00d4 c750a1        	ld	20641,a
 356                     ; 181         EXTI->CR2 |= (uint8_t)((uint8_t)(EXTI_Trigger) << ((uint8_t)EXTI_Pin & (uint8_t)0xEF));
 ...
 375  00ee               L33:
 376                     ; 183     case EXTI_Pin_5:
 376                     ; 184         EXTI->CR2 &=  (uint8_t)(~EXTI_CR2_P5IS);
 378  00ee c650a1        	ld	a,20641
 379  00f1 a4f3          	and	a,#243
 380  00f3 c750a1        	ld	20641,a
 381                     ; 185         EXTI->CR2 |= (uint8_t)((uint8_t)(EXTI_Trigger) << ((uint8_t)EXTI_Pin & (uint8_t)0xEF));
 ...
 400  010d               L53:
 401                     ; 187     case EXTI_Pin_6:
 401                     ; 188         EXTI->CR2 &=  (uint8_t)(~EXTI_CR2_P6IS);
 403  010d c650a1        	ld	a,20641
 404  0110 a4cf          	and	a,#207
 405  0112 c750a1        	ld	20641,a
 406                     ; 189         EXTI->CR2 |= (uint8_t)((uint8_t)(EXTI_Trigger) << ((uint8_t)EXTI_Pin & (uint8_t)0xEF));
 ...
 425  012c               L73:
 426                     ; 191     case EXTI_Pin_7:
 426                     ; 192         EXTI->CR2 &=  (uint8_t)(~EXTI_CR2_P7IS);
 428  012c c650a1        	ld	a,20641
 429  012f a43f          	and	a,#63
 430  0131 c750a1        	ld	20641,a
 431                     ; 193         EXTI->CR2 |= (uint8_t)((uint8_t)(EXTI_Trigger) << ((uint8_t)EXTI_Pin & (uint8_t)0xEF));
 ...
 816  01aa               L103:
 817                     ; 278         if (NewState != DISABLE) {
 819  01aa 0d02          	tnz	(OFST+2,sp)
 820  01ac 270c          	jreq	L113
 821                     ; 280             EXTI->CONF2 |= (uint8_t)(EXTI_HalfPort & (uint8_t)0x7F);
 ...
 829  01ba               L113:
 830                     ; 283             EXTI->CONF2 &= (uint8_t)(~(uint8_t) (EXTI_HalfPort & (uint8_t)0x7F));
 ...
 841  01c5 85            	popw	x
 842  01c6 81            	ret
 888                     ; 311 void EXTI_SetPortSensitivity(EXTI_Port_TypeDef EXTI_Port,
 888                     ; 312                              EXTI_Trigger_TypeDef EXTI_Trigger)
 888                     ; 313 {
 889                     	switch	.text
 890  01c7               _EXTI_SetPortSensitivity:
 892  01c7 89            	pushw	x
 893       00000000      OFST:	set	0
 896                     ; 315     assert_param(IS_EXTI_PORT(EXTI_Port));
 898                     ; 316     assert_param(IS_EXTI_TRIGGER(EXTI_Trigger));
 900                     ; 319     if ((EXTI_Port & 0xF0) == 0x00) {
 902  01c8 9e            	ld	a,xh
 903  01c9 a5f0          	bcp	a,#240
 904  01cb 2629          	jrne	L733
 905                     ; 321         EXTI->CR3 &= (uint8_t) (~(uint8_t)((uint8_t)0x03 << EXTI_Port));
 ...
 921                     ; 323         EXTI->CR3 |= (uint8_t)((uint8_t)(EXTI_Trigger) << EXTI_Port);
 ...
 938  01f6               L733:
 939                     ; 326         EXTI->CR4 &= (uint8_t) (~(uint8_t)((uint8_t)0x03 << (EXTI_Port & 0x0F)));
 ...
 956                     ; 328         EXTI->CR4 |= (uint8_t)(EXTI_Trigger << (EXTI_Port & 0x0F));
 ...
 976  0221 85            	popw	x
 977  0222 81            	ret
1023                     ; 346 EXTI_Trigger_TypeDef EXTI_GetPinSensitivity(EXTI_Pin_TypeDef EXTI_Pin)
1023                     ; 347 {
1024                     	switch	.text
1025  0223               _EXTI_GetPinSensitivity:
1027  0223 88            	push	a
1028       00000001      OFST:	set	1
1031                     ; 348     uint8_t value = 0;
1033  0224 0f01          	clr	(OFST+0,sp)
1034                     ; 351     assert_param(IS_EXTI_PINNUM(EXTI_Pin));
1036                     ; 353     switch (EXTI_Pin) {
1039                     ; 378     default:
1039                     ; 379         break;
1040  0226 4d            	tnz	a
...
1057  0247               L343:
1058                     ; 354     case EXTI_Pin_0:
1058                     ; 355         value = (uint8_t)(EXTI->CR1 & EXTI_CR1_P0IS);
...
1066  0250               L543:
1067                     ; 357     case EXTI_Pin_1:
1067                     ; 358         value = (uint8_t)((uint8_t)(EXTI->CR1 & EXTI_CR1_P1IS) >> EXTI_Pin_1);
...
1077  025b               L743:
1078                     ; 360     case EXTI_Pin_2:
1078                     ; 361         value = (uint8_t)((uint8_t)(EXTI->CR1 & EXTI_CR1_P2IS) >> EXTI_Pin_2);
...
1088  0267               L153:
1089                     ; 363     case EXTI_Pin_3:
1089                     ; 364         value = (uint8_t)((uint8_t)(EXTI->CR1 & EXTI_CR1_P3IS) >> EXTI_Pin_3);
...
1101  0275               L353:
1102                     ; 366     case EXTI_Pin_4:
1102                     ; 367         value = (uint8_t)(EXTI->CR2 & EXTI_CR2_P4IS);
...
1110  027e               L553:
1111                     ; 369     case EXTI_Pin_5:
1111                     ; 370         value = (uint8_t)((uint8_t)(EXTI->CR2 & EXTI_CR2_P5IS) >> ((uint8_t)EXTI_Pin_5 & (uint8_t)0x0F));
...
1121  0289               L753:
1122                     ; 372     case EXTI_Pin_6:
1122                     ; 373         value = (uint8_t)((uint8_t)(EXTI->CR2 & EXTI_CR2_P6IS) >> ((uint8_t)EXTI_Pin_6 & (uint8_t)0x0F));
...
1132  0295               L163:
1133                     ; 375     case EXTI_Pin_7:
1133                     ; 376         value = (uint8_t)((uint8_t)(EXTI->CR2 & EXTI_CR2_P7IS) >> ((uint8_t)EXTI_Pin_7 & (uint8_t)0x0F));
...
1145                     ; 379         break;
1147  02a1               L114:
1148                     ; 381     return((EXTI_Trigger_TypeDef)value);
1150  02a1 7b01          	ld	a,(OFST+0,sp)
1153  02a3 5b01          	addw	sp,#1
1154  02a5 81            	ret
1200                     ; 396 EXTI_Trigger_TypeDef EXTI_GetPortSensitivity(EXTI_Port_TypeDef EXTI_Port)
1200                     ; 397 {
1201                     	switch	.text
...
1209                     ; 398     uint8_t portsensitivity = 0;
1211  02a8 0f01          	clr	(OFST+0,sp)
1212                     ; 401     assert_param(IS_EXTI_PORT(EXTI_Port));
1214                     ; 404     if ((EXTI_Port & 0xF0) == 0x00) {
1216  02aa a5f0          	bcp	a,#240
1217  02ac 2614          	jrne	L534
1218                     ; 406         portsensitivity = (uint8_t)((uint8_t)0x03 & (uint8_t)(EXTI->CR3 >> EXTI_Port));
...
1235  02c2               L534:
1236                     ; 411         portsensitivity = (uint8_t)((uint8_t)0x03 & (uint8_t)(EXTI->CR4 >> (EXTI_Port & 0x0F)));
...
1252  02d6               L734:
1253                     ; 414     return((EXTI_Trigger_TypeDef)portsensitivity);
1255  02d6 7b01          	ld	a,(OFST+0,sp)
1258  02d8 85            	popw	x
1259  02d9 81            	ret
1429                     ; 454 ITStatus EXTI_GetITStatus(EXTI_IT_TypeDef EXTI_IT)
1429                     ; 455 {
1430                     	switch	.text
...
1438                     ; 456     ITStatus status = RESET;
1440  02dc 0f01          	clr	(OFST+0,sp)
1441                     ; 458     assert_param(IS_EXTI_ITPENDINGBIT(EXTI_IT));
1443                     ; 460     if (((uint16_t)EXTI_IT & (uint16_t)0xFF00) == 0x0100) {
...
1453                     ; 461         status = (ITStatus)(EXTI->SR2 & (uint8_t)((uint16_t)EXTI_IT & (uint16_t)0x00FF));
...
1461  02f5               L335:
1462                     ; 463         status = (ITStatus)(EXTI->SR1 & ((uint8_t)((uint16_t)EXTI_IT & (uint16_t)0x00FF)));
1464  02f5 7b03          	ld	a,(OFST+2,sp)
1465  02f7 a4ff          	and	a,#255
1466  02f9 c450a3        	and	a,20643
1467  02fc 6b01          	ld	(OFST+0,sp),a
1468  02fe               L535:
1469                     ; 465     return((ITStatus)status);
1471  02fe 7b01          	ld	a,(OFST+0,sp)
1474  0300 5b03          	addw	sp,#3
1475  0302 81            	ret
1520                     ; 488 void EXTI_ClearITPendingBit(EXTI_IT_TypeDef EXTI_IT)
1520                     ; 489 {
1521                     	switch	.text
...
1529                     ; 490     uint16_t tempvalue = 0;
1531  0305 5f            	clrw	x
1532  0306 1f01          	ldw	(OFST-1,sp),x
1533                     ; 493     assert_param(IS_EXTI_ITPENDINGBIT(EXTI_IT));
1535                     ; 495     tempvalue = ((uint16_t)EXTI_IT & (uint16_t)0xFF00);
