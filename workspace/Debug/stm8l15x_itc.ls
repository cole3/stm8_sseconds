 ...
 539  0052               L14:
 540                     ; 121     case FLASH_IRQn:
 540                     ; 122     case DMA1_CHANNEL0_1_IRQn:
 540                     ; 123     case DMA1_CHANNEL2_3_IRQn:
 540                     ; 124       Value = (uint8_t)(ITC->ISPR1 & Mask); /* Read software priority */
 ...
 548  005b               L34:
 549                     ; 127     case EXTIE_F_PVD_IRQn:
 549                     ; 128 #ifdef STM8L15X_MD
 549                     ; 129     case RTC_IRQn:
 549                     ; 130     case EXTIB_IRQn:
 549                     ; 131     case EXTID_IRQn:
 549                     ; 132 #elif defined (STM8L15X_LD)
 549                     ; 133     case RTC_CSSLSE_IRQn:
 549                     ; 134     case EXTIB_IRQn:
 549                     ; 135     case EXTID_IRQn:
 549                     ; 136 #elif defined (STM8L15X_HD) || defined (STM8L15X_MDP)
 549                     ; 137     case RTC_CSSLSE_IRQn:
 549                     ; 138     case EXTIB_G_IRQn:
 549                     ; 139     case EXTID_H_IRQn:
 549                     ; 140 #endif  /* STM8L15X_MD */
 549                     ; 141       Value = (uint8_t)(ITC->ISPR2 & Mask); /* Read software priority */
 ...
 557  0064               L54:
 558                     ; 144     case EXTI0_IRQn:
 558                     ; 145     case EXTI1_IRQn:
 558                     ; 146     case EXTI2_IRQn:
 558                     ; 147     case EXTI3_IRQn:
 558                     ; 148       Value = (uint8_t)(ITC->ISPR3 & Mask); /* Read software priority */
 ...
 566  006d               L74:
 567                     ; 151     case EXTI4_IRQn:
 567                     ; 152     case EXTI5_IRQn:
 567                     ; 153     case EXTI6_IRQn:
 567                     ; 154     case EXTI7_IRQn:
 567                     ; 155       Value = (uint8_t)(ITC->ISPR4 & Mask); /* Read software priority */
 ...
 575  0076               L15:
 576                     ; 161     case SWITCH_CSS_BREAK_DAC_IRQn:
 576                     ; 162 #endif /* STM8L15X_LD */		
 576                     ; 163     case ADC1_COMP_IRQn:
 576                     ; 164 #ifdef STM8L15X_MD
 576                     ; 165     case LCD_IRQn:
 576                     ; 166     case TIM2_UPD_OVF_TRG_BRK_IRQn:
 576                     ; 167 #elif defined (STM8L15X_LD)
 576                     ; 168     case TIM2_UPD_OVF_TRG_BRK_IRQn:
 576                     ; 169 #elif defined (STM8L15X_HD) || defined (STM8L15X_MDP)
 576                     ; 170     case LCD_AES_IRQn:
 576                     ; 171     case TIM2_UPD_OVF_TRG_BRK_USART2_TX_IRQn:
 576                     ; 172 #endif  /* STM8L15X_MD */
 576                     ; 173       Value = (uint8_t)(ITC->ISPR5 & Mask); /* Read software priority */
 ...
 584  007f               L35:
 585                     ; 177     case TIM1_UPD_OVF_TRG_IRQn:
 585                     ; 178 #endif /* STM8L15X_LD */		
 585                     ; 179 #if defined (STM8L15X_MD) || defined (STM8L15X_LD)
 585                     ; 180     case TIM2_CC_IRQn:
 585                     ; 181     case TIM3_UPD_OVF_TRG_BRK_IRQn :
 585                     ; 182     case TIM3_CC_IRQn:
 585                     ; 183 #elif defined (STM8L15X_HD) || defined (STM8L15X_MDP)
 585                     ; 184     case TIM2_CC_USART2_RX_IRQn:
 585                     ; 185     case TIM3_UPD_OVF_TRG_BRK_USART3_TX_IRQn :
 585                     ; 186     case TIM3_CC_USART3_RX_IRQn:
 585                     ; 187 #endif  /* STM8L15X_MD */
 585                     ; 188       Value = (uint8_t)(ITC->ISPR6 & Mask); /* Read software priority */
 ...
 593  0088               L55:
 594                     ; 192     case TIM1_CC_IRQn:
 594                     ; 193 #endif /* STM8L15X_LD */	
 594                     ; 194     case TIM4_UPD_OVF_TRG_IRQn:
 594                     ; 195     case SPI1_IRQn:
 594                     ; 196 #if defined (STM8L15X_MD) || defined (STM8L15X_LD)
 594                     ; 197     case USART1_TX_IRQn:
 594                     ; 198 #elif defined (STM8L15X_HD) || defined (STM8L15X_MDP)
 594                     ; 199     case USART1_TX_TIM5_UPD_OVF_TRG_BRK_IRQn:
 594                     ; 200 #endif  /* STM8L15X_MD || STM8L15X_LD */
 594                     ; 201       Value = (uint8_t)(ITC->ISPR7 & Mask); /* Read software priority */
 ...
 602  0091               L75:
 603                     ; 208     case USART1_RX_TIM5_CC_IRQn:
 603                     ; 209     case I2C1_SPI2_IRQn:
 603                     ; 210 #endif  /* STM8L15X_MD || STM8L15X_LD*/
 603                     ; 211       Value = (uint8_t)(ITC->ISPR8 & Mask); /* Read software priority */
 ...
 611                     ; 215       break;
 613  0098               L522:
 614                     ; 218   Value >>= (uint8_t)((IRQn % 4u) * 2u);
 ...
 630                     ; 220   return((ITC_PriorityLevel_TypeDef)Value);
 ...
 731                     ; 241 void ITC_SetSoftwarePriority(IRQn_TypeDef IRQn, ITC_PriorityLevel_TypeDef ITC_PriorityLevel)
 731                     ; 242 {
 732                     	switch	.text
 ...
 740                     ; 243   uint8_t Mask = 0;
 742  00b1 7b01          	ld	a,(OFST-1,sp)
 743  00b3 97            	ld	xl,a
 744                     ; 244   uint8_t NewPriority = 0;
