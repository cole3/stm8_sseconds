 ...
 216                     ; 102         curr_tcb->entry_point(curr_tcb->entry_param);
 ...
 234  0025 85            	popw	x
 235  0026 81            	ret
 296                     ; 165 void archThreadContextInit (ATOM_TCB *tcb_ptr, void *stack_top, void (*entry_point)(uint32_t), uint32_t entry_param)
 296                     ; 166 {
 297                     	switch	.text
 ...
 305                     ; 170     stack_ptr = (uint8_t *)stack_top;
 307  0029 1e07          	ldw	x,(OFST+5,sp)
 308  002b 1f01          	ldw	(OFST-1,sp),x
 309                     ; 187     *stack_ptr-- = (uint8_t)((uint16_t)thread_shell & 0xFF);
 ...
 317  003b f7            	ld	(x),a
 318                     ; 188     *stack_ptr-- = (uint8_t)(((uint16_t)thread_shell >> 8) & 0xFF);
 ...
 330  004f f7            	ld	(x),a
 331                     ; 224     tcb_ptr->sp_save_ptr = stack_ptr;
