 ...
 206  0075               L16:
 207                     ; 69         USART_SendData8(USART1, c);
 ...
 214  007e 84            	pop	a
 216  007f               L56:
 217                     ; 72         while (USART_GetFlagStatus(USART1, USART_FLAG_TC) == RESET);
 ...
 227                     ; 75         atomMutexPut(&uart_mutex);
 ...
 239  0097 81            	ret
 274                     ; 94 char putchar (char c)
 274                     ; 95 {
 275                     	switch	.text
 276  0098               _putchar:
 280                     ; 96     return (uart_putchar(c));
