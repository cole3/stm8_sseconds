 ...
 345                     ; 145         RI->ICR1 = (uint8_t) RI_InputCaptureRouting;
 347  002b 9f            	ld	a,xl
 348  002c c75431        	ld	21553,a
 350  002f 2005          	jra	L731
 351  0031               L531:
 352                     ; 150         RI->ICR2 = (uint8_t) RI_InputCaptureRouting;
 ...
 360  0036 85            	popw	x
 361  0037 81            	ret
 543                     ; 175 void SYSCFG_RIAnalogSwitchConfig(RI_AnalogSwitch_TypeDef RI_AnalogSwitch,
 543                     ; 176                                  FunctionalState NewState)
 543                     ; 177 {
 544                     	switch	.text
 ...
 552                     ; 178     uint8_t AnalogSwitchRegister, AnalogSwitchIndex = 0;
 554  003a 7b02          	ld	a,(OFST+0,sp)
 555  003c 97            	ld	xl,a
 556                     ; 181     assert_param(IS_RI_ANALOGSWITCH(RI_AnalogSwitch));
 558                     ; 182     assert_param(IS_FUNCTIONAL_STATE(NewState));
 560                     ; 185     AnalogSwitchRegister = (uint8_t) (RI_AnalogSwitch & (uint8_t) 0xF0);
 562  003d 7b03          	ld	a,(OFST+1,sp)
 563  003f a4f0          	and	a,#240
 564  0041 6b01          	ld	(OFST-1,sp),a
 565                     ; 188     AnalogSwitchIndex = (uint8_t) (RI_AnalogSwitch & (uint8_t) 0x0F);
 567  0043 7b03          	ld	a,(OFST+1,sp)
 568  0045 a40f          	and	a,#15
 569  0047 6b02          	ld	(OFST+0,sp),a
 570                     ; 190     if (NewState != DISABLE) {
 572  0049 0d04          	tnz	(OFST+2,sp)
 573  004b 2730          	jreq	L142
 574                     ; 191         if (AnalogSwitchRegister == (uint8_t) 0x10) {
 576  004d 7b01          	ld	a,(OFST-1,sp)
 577  004f a110          	cp	a,#16
 578  0051 2615          	jrne	L342
 579                     ; 193             RI->ASCR1 |= (uint8_t) ((uint8_t)1 << (uint8_t) AnalogSwitchIndex);
 ...
 596  0068               L342:
 597                     ; 196             RI->ASCR2 |= (uint8_t) ((uint8_t)1 << (uint8_t) AnalogSwitchIndex);
 ...
 613  007d               L142:
 614                     ; 199         if (AnalogSwitchRegister == (uint8_t) 0x10) {
 616  007d 7b01          	ld	a,(OFST-1,sp)
 617  007f a110          	cp	a,#16
 618  0081 2616          	jrne	L152
 619                     ; 201             RI->ASCR1 &= (uint8_t) (~(uint8_t)((uint8_t)1 <<  AnalogSwitchIndex));
 ...
 637  0099               L152:
 638                     ; 204             RI->ASCR2 &= (uint8_t) (~ (uint8_t)((uint8_t)1 << AnalogSwitchIndex));
 ...
 659  00af 81            	ret
 925                     ; 216 void SYSCFG_RIIOSwitchConfig(RI_IOSwitch_TypeDef RI_IOSwitch,
 925                     ; 217                              FunctionalState NewState)
 925                     ; 218 {
 926                     	switch	.text
 ...
 934                     ; 219     uint8_t IOSwitchRegsiter, IOSwitchIndex = 0;
 936  00b2 7b02          	ld	a,(OFST+0,sp)
 937  00b4 97            	ld	xl,a
 938                     ; 222     assert_param(IS_RI_IOSWITCH(RI_IOSwitch));
 940                     ; 223     assert_param(IS_FUNCTIONAL_STATE(NewState));
 942                     ; 226     IOSwitchIndex = (uint8_t) (RI_IOSwitch & (uint8_t) 0x0F);
 944  00b5 7b03          	ld	a,(OFST+1,sp)
 945  00b7 a40f          	and	a,#15
 946  00b9 6b02          	ld	(OFST+0,sp),a
 947                     ; 229     IOSwitchRegsiter = (uint8_t) (RI_IOSwitch & (uint8_t) 0xF0);
 949  00bb 7b03          	ld	a,(OFST+1,sp)
 950  00bd a4f0          	and	a,#240
 951  00bf 6b01          	ld	(OFST-1,sp),a
 952                     ; 232     if (IOSwitchRegsiter == (uint8_t) 0x10) {
 954  00c1 7b01          	ld	a,(OFST-1,sp)
 955  00c3 a110          	cp	a,#16
 956  00c5 2633          	jrne	L304
 957                     ; 233         if (NewState != DISABLE) {
 959  00c7 0d04          	tnz	(OFST+2,sp)
 960  00c9 2717          	jreq	L504
 961                     ; 235             RI->IOSR1 |= (uint8_t) ((uint8_t)1 << IOSwitchIndex);
 ...
 978  00e2               L504:
 979                     ; 238             RI->IOSR1 &= (uint8_t) (~ (uint8_t)((uint8_t)1 << IOSwitchIndex));
...
1023  0119               L514:
1024                     ; 249             RI->IOSR2 &= (uint8_t) (~(uint8_t)((uint8_t)1 <<  IOSwitchIndex));
...
1068  014e               L524:
1069                     ; 260             RI->IOSR3 &= (uint8_t) (~ (uint8_t) ((uint8_t) 1 << IOSwitchIndex));
...
1086  0164               L324:
1087                     ; 266         if (NewState != DISABLE) {
1089  0164 0d04          	tnz	(OFST+2,sp)
1090  0166 2715          	jreq	L334
1091                     ; 268             RI->IOSR4 |= (uint8_t) ((uint8_t)1 << IOSwitchIndex);
...
1108  017d               L334:
1109                     ; 271             RI->IOSR4 &= (uint8_t) (~ (uint8_t) ((uint8_t) 1 << IOSwitchIndex));
...
1130  0193 81            	ret
1210                     ; 286 void SYSCFG_RIResistorConfig(RI_Resistor_TypeDef RI_Resistor, FunctionalState NewState)
1210                     ; 287 {
1211                     	switch	.text
1212  0194               _SYSCFG_RIResistorConfig:
1214  0194 89            	pushw	x
1215       00000000      OFST:	set	0
1218                     ; 289     assert_param(IS_RI_RESISTOR(RI_Resistor));
1220                     ; 290     assert_param(IS_FUNCTIONAL_STATE(NewState));
1222                     ; 292     if (NewState != DISABLE) {
1224  0195 9f            	ld	a,xl
1225  0196 4d            	tnz	a
1226  0197 2709          	jreq	L574
1227                     ; 294         RI->RCR |= (uint8_t) RI_Resistor;
1229  0199 9e            	ld	a,xh
1230  019a ca543f        	or	a,21567
1231  019d c7543f        	ld	21567,a
1233  01a0 2009          	jra	L774
1234  01a2               L574:
1235                     ; 297         RI->RCR &= (uint8_t) (~RI_Resistor);
...
1245  01ab 85            	popw	x
1246  01ac 81            	ret
1269                     ; 331 void SYSCFG_REMAPDeInit(void)
1269                     ; 332 {
1270                     	switch	.text
1271  01ad               _SYSCFG_REMAPDeInit:
1275                     ; 334     SYSCFG->RMPCR1 = SYSCFG_RMPCR1_RESET_VALUE;
1277  01ad 350c509e      	mov	20638,#12
1278                     ; 337     SYSCFG->RMPCR2 = SYSCFG_RMPCR2_RESET_VALUE;
1280  01b1 725f509f      	clr	20639
1281                     ; 340     SYSCFG->RMPCR3 = SYSCFG_RMPCR3_RESET_VALUE;
1283  01b5 725f509d      	clr	20637
1284                     ; 341 }
1287  01b9 81            	ret
1505                     ; 374 void SYSCFG_REMAPPinConfig(REMAP_Pin_TypeDef REMAP_Pin, FunctionalState NewState)
1505                     ; 375 {
1506                     	switch	.text
...
1514                     ; 376     uint8_t regindex = 0;
1516  01bc 0f01          	clr	(OFST+0,sp)
1517                     ; 378     assert_param(IS_REMAP_PIN(REMAP_Pin));
1519                     ; 379     assert_param(IS_FUNCTIONAL_STATE(NewState));
1521                     ; 382     regindex = (uint8_t) ((uint16_t) REMAP_Pin >> 8);
1523  01be 9e            	ld	a,xh
1524  01bf 6b01          	ld	(OFST+0,sp),a
1525                     ; 385     if (regindex == 0x01) {
1527  01c1 7b01          	ld	a,(OFST+0,sp)
1528  01c3 a101          	cp	a,#1
1529  01c5 261e          	jrne	L316
1530                     ; 386         SYSCFG->RMPCR1 &= (uint8_t)((uint8_t)((uint8_t)REMAP_Pin << 4) | (uint8_t)0x0F);
...
1540                     ; 387         if (NewState != DISABLE) {
1542  01d5 0d06          	tnz	(OFST+5,sp)
1543  01d7 2742          	jreq	L716
1544                     ; 388             SYSCFG->RMPCR1 |= (uint8_t)((uint16_t)REMAP_Pin & (uint16_t)0x00F0);
...
1600  021d 81            	ret
1706                     ; 423 void SYSCFG_REMAPDMAChannelConfig(REMAP_DMAChannel_TypeDef REMAP_DMAChannel)
1706                     ; 424 {
1707                     	switch	.text
1708  021e               _SYSCFG_REMAPDMAChannelConfig:
1710  021e 88            	push	a
1711       00000000      OFST:	set	0
1714                     ; 426     assert_param(IS_REMAP_DMACHANNEL(REMAP_DMAChannel));
1716                     ; 429     if ((REMAP_DMAChannel & 0xF0) != RESET) {
1718  021f a5f0          	bcp	a,#240
1719  0221 270a          	jreq	L776
1720                     ; 431         SYSCFG->RMPCR1 &= (uint8_t) (~SYSCFG_RMPCR1_TIM4DMA_REMAP);
1722  0223 c6509e        	ld	a,20638
1723  0226 a4f3          	and	a,#243
1724  0228 c7509e        	ld	20638,a
1726  022b 2008          	jra	L107
1727  022d               L776:
1728                     ; 436         SYSCFG->RMPCR1 &= (uint8_t) (~SYSCFG_RMPCR1_ADC1DMA_REMAP);
1730  022d c6509e        	ld	a,20638
1731  0230 a4fc          	and	a,#252
1732  0232 c7509e        	ld	20638,a
1733  0235               L107:
1734                     ; 439     SYSCFG->RMPCR1 |= (uint8_t) ((uint8_t)0x0F & REMAP_DMAChannel);
