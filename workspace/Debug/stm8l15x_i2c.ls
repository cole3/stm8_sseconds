 ...
 545  0068               L02:
 546                     ; 216         tmpccrh = I2C_CCRH_FS;
 548  0068 a680          	ld	a,#128
 549  006a 6b07          	ld	(OFST-5,sp),a
 550                     ; 218         if (I2C_DutyCycle == I2C_DutyCycle_2) {
 552  006c 0d18          	tnz	(OFST+12,sp)
 553  006e 2633          	jrne	L562
 554                     ; 220             result = (uint32_t) ((input_clock * 1000000) / (OutputClockFrequency * 3));
 ...
 585  00a3               L562:
 586                     ; 223             result = (uint32_t) ((input_clock * 1000000) / (OutputClockFrequency * 25));
 ...
 646                     ; 238         I2Cx->TRISER = (uint8_t)tmpval;
 648  00fb 7b06          	ld	a,(OFST-6,sp)
 649  00fd 1e0d          	ldw	x,(OFST+1,sp)
 650  00ff e70d          	ld	(13,x),a
 652  0101 2059          	jra	L372
 653  0103               L362:
 654                     ; 243         result = (uint16_t)((input_clock * 1000000) / (OutputClockFrequency << (uint8_t)1));
 ...
 687                     ; 246         if (result < (uint16_t)0x0004) {
 ...
 765  019e 81            	ret
 832                     ; 281 void I2C_Cmd(I2C_TypeDef* I2Cx, FunctionalState NewState)
 832                     ; 282 {
 833                     	switch	.text
 834  019f               _I2C_Cmd:
 836  019f 89            	pushw	x
 837       00000000      OFST:	set	0
 840                     ; 285     assert_param(IS_FUNCTIONAL_STATE(NewState));
 842                     ; 287     if (NewState != DISABLE) {
 844  01a0 0d05          	tnz	(OFST+5,sp)
 845  01a2 2706          	jreq	L333
 846                     ; 289         I2Cx->CR1 |= I2C_CR1_PE;
 848  01a4 f6            	ld	a,(x)
 849  01a5 aa01          	or	a,#1
 850  01a7 f7            	ld	(x),a
 852  01a8 2006          	jra	L533
 853  01aa               L333:
 854                     ; 292         I2Cx->CR1 &= (uint8_t)(~I2C_CR1_PE);
 ...
 864  01b0 85            	popw	x
 865  01b1 81            	ret
 912                     ; 303 void I2C_GeneralCallCmd(I2C_TypeDef* I2Cx, FunctionalState NewState)
 912                     ; 304 {
 913                     	switch	.text
 914  01b2               _I2C_GeneralCallCmd:
 916  01b2 89            	pushw	x
 917       00000000      OFST:	set	0
 920                     ; 307     assert_param(IS_FUNCTIONAL_STATE(NewState));
 922                     ; 309     if (NewState != DISABLE) {
 924  01b3 0d05          	tnz	(OFST+5,sp)
 925  01b5 2706          	jreq	L363
 926                     ; 311         I2Cx->CR1 |= I2C_CR1_ENGC;
 928  01b7 f6            	ld	a,(x)
 929  01b8 aa40          	or	a,#64
 930  01ba f7            	ld	(x),a
 932  01bb 2006          	jra	L563
 933  01bd               L363:
 934                     ; 314         I2Cx->CR1 &= (uint8_t)(~I2C_CR1_ENGC);
 ...
 944  01c3 85            	popw	x
 945  01c4 81            	ret
 992                     ; 327 void I2C_GenerateSTART(I2C_TypeDef* I2Cx, FunctionalState NewState)
 992                     ; 328 {
 993                     	switch	.text
 994  01c5               _I2C_GenerateSTART:
 996  01c5 89            	pushw	x
 997       00000000      OFST:	set	0
1000                     ; 331     assert_param(IS_FUNCTIONAL_STATE(NewState));
1002                     ; 333     if (NewState != DISABLE) {
1004  01c6 0d05          	tnz	(OFST+5,sp)
1005  01c8 2708          	jreq	L314
1006                     ; 335         I2Cx->CR2 |= I2C_CR2_START;
1008  01ca e601          	ld	a,(1,x)
1009  01cc aa01          	or	a,#1
1010  01ce e701          	ld	(1,x),a
1012  01d0 2008          	jra	L514
1013  01d2               L314:
1014                     ; 338         I2Cx->CR2 &= (uint8_t)(~I2C_CR2_START);
...
1024  01da 85            	popw	x
1025  01db 81            	ret
1072                     ; 349 void I2C_GenerateSTOP(I2C_TypeDef* I2Cx, FunctionalState NewState)
1072                     ; 350 {
1073                     	switch	.text
1074  01dc               _I2C_GenerateSTOP:
1076  01dc 89            	pushw	x
1077       00000000      OFST:	set	0
1080                     ; 353     assert_param(IS_FUNCTIONAL_STATE(NewState));
1082                     ; 355     if (NewState != DISABLE) {
1084  01dd 0d05          	tnz	(OFST+5,sp)
1085  01df 2708          	jreq	L344
1086                     ; 357         I2Cx->CR2 |= I2C_CR2_STOP;
1088  01e1 e601          	ld	a,(1,x)
1089  01e3 aa02          	or	a,#2
1090  01e5 e701          	ld	(1,x),a
1092  01e7 2008          	jra	L544
1093  01e9               L344:
1094                     ; 360         I2Cx->CR2 &= (uint8_t)(~I2C_CR2_STOP);
...
1104  01f1 85            	popw	x
1105  01f2 81            	ret
1153                     ; 371 void I2C_SoftwareResetCmd(I2C_TypeDef* I2Cx, FunctionalState NewState)
1153                     ; 372 {
1154                     	switch	.text
1155  01f3               _I2C_SoftwareResetCmd:
1157  01f3 89            	pushw	x
1158       00000000      OFST:	set	0
1161                     ; 374     assert_param(IS_FUNCTIONAL_STATE(NewState));
1163                     ; 376     if (NewState != DISABLE) {
1165  01f4 0d05          	tnz	(OFST+5,sp)
1166  01f6 2708          	jreq	L374
1167                     ; 378         I2Cx->CR2 |= I2C_CR2_SWRST;
1169  01f8 e601          	ld	a,(1,x)
1170  01fa aa80          	or	a,#128
1171  01fc e701          	ld	(1,x),a
1173  01fe 2008          	jra	L574
1174  0200               L374:
1175                     ; 381         I2Cx->CR2 &= (uint8_t)(~I2C_CR2_SWRST);
...
1185  0208 85            	popw	x
1186  0209 81            	ret
1234                     ; 392 void I2C_StretchClockCmd(I2C_TypeDef* I2Cx, FunctionalState NewState)
1234                     ; 393 {
1235                     	switch	.text
1236  020a               _I2C_StretchClockCmd:
1238  020a 89            	pushw	x
1239       00000000      OFST:	set	0
1242                     ; 395     assert_param(IS_FUNCTIONAL_STATE(NewState));
1244                     ; 397     if (NewState != DISABLE) {
1246  020b 0d05          	tnz	(OFST+5,sp)
1247  020d 2706          	jreq	L325
1248                     ; 399         I2Cx->CR1 &= (uint8_t)(~I2C_CR1_NOSTRETCH);
1250  020f f6            	ld	a,(x)
1251  0210 a47f          	and	a,#127
1252  0212 f7            	ld	(x),a
1254  0213 2006          	jra	L525
1255  0215               L325:
1256                     ; 403         I2Cx->CR1 |= I2C_CR1_NOSTRETCH;
...
1266  021b 85            	popw	x
1267  021c 81            	ret
1314                     ; 414 void I2C_ARPCmd(I2C_TypeDef* I2Cx, FunctionalState NewState)
1314                     ; 415 {
1315                     	switch	.text
1316  021d               _I2C_ARPCmd:
1318  021d 89            	pushw	x
1319       00000000      OFST:	set	0
1322                     ; 417     assert_param(IS_FUNCTIONAL_STATE(NewState));
1324                     ; 419     if (NewState != DISABLE) {
1326  021e 0d05          	tnz	(OFST+5,sp)
1327  0220 2706          	jreq	L355
1328                     ; 421         I2Cx->CR1 |= I2C_CR1_ARP;
1330  0222 f6            	ld	a,(x)
1331  0223 aa10          	or	a,#16
1332  0225 f7            	ld	(x),a
1334  0226 2006          	jra	L555
1335  0228               L355:
1336                     ; 425         I2Cx->CR1 &= (uint8_t)(~I2C_CR1_ARP);
...
1346  022e 85            	popw	x
1347  022f 81            	ret
1395                     ; 436 void I2C_AcknowledgeConfig(I2C_TypeDef* I2Cx, FunctionalState NewState)
1395                     ; 437 {
1396                     	switch	.text
1397  0230               _I2C_AcknowledgeConfig:
1399  0230 89            	pushw	x
1400       00000000      OFST:	set	0
1403                     ; 439     assert_param(IS_FUNCTIONAL_STATE(NewState));
1405                     ; 441     if (NewState != DISABLE) {
1407  0231 0d05          	tnz	(OFST+5,sp)
1408  0233 2708          	jreq	L306
1409                     ; 443         I2Cx->CR2 |= I2C_CR2_ACK;
1411  0235 e601          	ld	a,(1,x)
1412  0237 aa04          	or	a,#4
1413  0239 e701          	ld	(1,x),a
1415  023b 2008          	jra	L506
1416  023d               L306:
1417                     ; 446         I2Cx->CR2 &= (uint8_t)(~I2C_CR2_ACK);
...
1427  0245 85            	popw	x
1428  0246 81            	ret
1484                     ; 456 void I2C_OwnAddress2Config(I2C_TypeDef* I2Cx, uint8_t Address)
1484                     ; 457 {
1485                     	switch	.text
...
1520  0265 81            	ret
1567                     ; 480 void I2C_DualAddressCmd(I2C_TypeDef* I2Cx, FunctionalState NewState)
1567                     ; 481 {
1568                     	switch	.text
1569  0266               _I2C_DualAddressCmd:
1571  0266 89            	pushw	x
1572       00000000      OFST:	set	0
1575                     ; 483     assert_param(IS_FUNCTIONAL_STATE(NewState));
1577                     ; 485     if (NewState != DISABLE) {
1579  0267 0d05          	tnz	(OFST+5,sp)
1580  0269 2708          	jreq	L366
1581                     ; 487         I2Cx->OAR2 |= I2C_OAR2_ENDUAL;
1583  026b e605          	ld	a,(5,x)
1584  026d aa01          	or	a,#1
1585  026f e705          	ld	(5,x),a
1587  0271 2008          	jra	L566
1588  0273               L366:
1589                     ; 490         I2Cx->OAR2 &= (uint8_t)(~I2C_OAR2_ENDUAL);
...
1599  027b 85            	popw	x
1600  027c 81            	ret
1670                     ; 504 void I2C_AckPositionConfig(I2C_TypeDef* I2Cx, I2C_AckPosition_TypeDef I2C_AckPosition)
1670                     ; 505 {
1671                     	switch	.text
1672  027d               _I2C_AckPositionConfig:
1674  027d 89            	pushw	x
1675       00000000      OFST:	set	0
1678                     ; 507     assert_param(IS_I2C_ACK_POSITION(I2C_AckPosition));
1680                     ; 510     I2Cx->CR2 &= (uint8_t)(~I2C_CR2_POS);
1682  027e e601          	ld	a,(1,x)
1683  0280 a4f7          	and	a,#247
1684  0282 e701          	ld	(1,x),a
1685                     ; 512     I2Cx->CR2 |= (uint8_t)I2C_AckPosition;
...
1693  028a 85            	popw	x
1694  028b 81            	ret
1763                     ; 524 void I2C_SMBusAlertConfig(I2C_TypeDef* I2Cx, I2C_SMBusAlert_TypeDef I2C_SMBusAlert)
1763                     ; 525 {
1764                     	switch	.text
1765  028c               _I2C_SMBusAlertConfig:
1767  028c 89            	pushw	x
1768       00000000      OFST:	set	0
1771                     ; 528     assert_param(IS_I2C_SMBUS_ALERT(I2C_SMBusAlert));
1773                     ; 530     if (I2C_SMBusAlert != I2C_SMBusAlert_High) {
1775  028d 0d05          	tnz	(OFST+5,sp)
1776  028f 2708          	jreq	L757
1777                     ; 532         I2Cx->CR2 |= (uint8_t)I2C_CR2_ALERT;
1779  0291 e601          	ld	a,(1,x)
1780  0293 aa20          	or	a,#32
1781  0295 e701          	ld	(1,x),a
1783  0297 2008          	jra	L167
1784  0299               L757:
1785                     ; 535         I2Cx->CR2 &= (uint8_t)(~I2C_CR2_ALERT);
...
1795  02a1 85            	popw	x
1796  02a2 81            	ret
1844                     ; 548 void I2C_FastModeDutyCycleConfig(I2C_TypeDef* I2Cx, I2C_DutyCycle_TypeDef I2C_DutyCycle)
1844                     ; 549 {
1845                     	switch	.text
1846  02a3               _I2C_FastModeDutyCycleConfig:
1848  02a3 89            	pushw	x
1849       00000000      OFST:	set	0
1852                     ; 552     assert_param(IS_I2C_DUTY_CYCLE(I2C_DutyCycle));
1854                     ; 554     if (I2C_DutyCycle == I2C_DutyCycle_16_9) {
1856  02a4 7b05          	ld	a,(OFST+5,sp)
1857  02a6 a140          	cp	a,#64
1858  02a8 2608          	jrne	L7001
1859                     ; 556         I2Cx->CCRH |= I2C_CCRH_DUTY;
1861  02aa e60c          	ld	a,(12,x)
1862  02ac aa40          	or	a,#64
1863  02ae e70c          	ld	(12,x),a
1865  02b0 2008          	jra	L1101
1866  02b2               L7001:
1867                     ; 559         I2Cx->CCRH &= (uint8_t)(~I2C_CCRH_DUTY);
...
1877  02ba 85            	popw	x
1878  02bb 81            	ret
1957                     ; 574 void I2C_Send7bitAddress(I2C_TypeDef* I2Cx, uint8_t Address, I2C_Direction_TypeDef I2C_Direction)
1957                     ; 575 {
1958                     	switch	.text
1959  02bc               _I2C_Send7bitAddress:
1961  02bc 89            	pushw	x
1962       00000000      OFST:	set	0
1965                     ; 577     assert_param(IS_I2C_ADDRESS(Address));
1967                     ; 578     assert_param(IS_I2C_DIRECTION(I2C_Direction));
1969                     ; 581     if (I2C_Direction != I2C_Direction_Transmitter) {
1971  02bd 0d06          	tnz	(OFST+6,sp)
1972  02bf 2708          	jreq	L3501
1973                     ; 583         Address |= OAR1_ADD0_Set;
1975  02c1 7b05          	ld	a,(OFST+5,sp)
1976  02c3 aa01          	or	a,#1
1977  02c5 6b05          	ld	(OFST+5,sp),a
1979  02c7 2006          	jra	L5501
1980  02c9               L3501:
1981                     ; 586         Address &= OAR1_ADD0_Reset;
1983  02c9 7b05          	ld	a,(OFST+5,sp)
1984  02cb a4fe          	and	a,#254
1985  02cd 6b05          	ld	(OFST+5,sp),a
1986  02cf               L5501:
1987                     ; 589     I2Cx->DR = Address;
...
1995  02d5 85            	popw	x
1996  02d6 81            	ret
2042                     ; 614 void I2C_SendData(I2C_TypeDef* I2Cx, uint8_t Data)
2042                     ; 615 {
2043                     	switch	.text
2044  02d7               _I2C_SendData:
2046  02d7 89            	pushw	x
2047       00000000      OFST:	set	0
2050                     ; 617     I2Cx->DR = Data;
...
2058  02de 85            	popw	x
2059  02df 81            	ret
2096                     ; 626 uint8_t I2C_ReceiveData(I2C_TypeDef* I2Cx)
2096                     ; 627 {
2097                     	switch	.text
2098  02e0               _I2C_ReceiveData:
2102                     ; 629     return ((uint8_t)I2Cx->DR);
2104  02e0 e606          	ld	a,(6,x)
2107  02e2 81            	ret
2154                     ; 655 void I2C_TransmitPEC(I2C_TypeDef* I2Cx, FunctionalState NewState)
2154                     ; 656 {
2155                     	switch	.text
2156  02e3               _I2C_TransmitPEC:
2158  02e3 89            	pushw	x
2159       00000000      OFST:	set	0
2162                     ; 658     assert_param(IS_FUNCTIONAL_STATE(NewState));
2164                     ; 660     if (NewState != DISABLE) {
2166  02e4 0d05          	tnz	(OFST+5,sp)
2167  02e6 2708          	jreq	L7411
2168                     ; 662         I2Cx->CR2 |= I2C_CR2_PEC;
2170  02e8 e601          	ld	a,(1,x)
2171  02ea aa10          	or	a,#16
2172  02ec e701          	ld	(1,x),a
2174  02ee 2008          	jra	L1511
2175  02f0               L7411:
2176                     ; 665         I2Cx->CR2 &= (uint8_t)(~I2C_CR2_PEC);
...
2186  02f8 85            	popw	x
2187  02f9 81            	ret
2234                     ; 676 void I2C_CalculatePEC(I2C_TypeDef* I2Cx, FunctionalState NewState)
2234                     ; 677 {
2235                     	switch	.text
2236  02fa               _I2C_CalculatePEC:
2238  02fa 89            	pushw	x
2239       00000000      OFST:	set	0
2242                     ; 679     assert_param(IS_FUNCTIONAL_STATE(NewState));
2244                     ; 681     if (NewState != DISABLE) {
2246  02fb 0d05          	tnz	(OFST+5,sp)
2247  02fd 2706          	jreq	L7711
2248                     ; 683         I2Cx->CR1 |= I2C_CR1_ENPEC;
2250  02ff f6            	ld	a,(x)
2251  0300 aa20          	or	a,#32
2252  0302 f7            	ld	(x),a
2254  0303 2006          	jra	L1021
2255  0305               L7711:
2256                     ; 686         I2Cx->CR1 &= (uint8_t)(~I2C_CR1_ENPEC);
...
2266  030b 85            	popw	x
2267  030c 81            	ret
2337                     ; 699 void I2C_PECPositionConfig(I2C_TypeDef* I2Cx, I2C_PECPosition_TypeDef I2C_PECPosition)
2337                     ; 700 {
2338                     	switch	.text
2339  030d               _I2C_PECPositionConfig:
2341  030d 89            	pushw	x
2342       00000000      OFST:	set	0
2345                     ; 702     assert_param(IS_I2C_PEC_POSITION(I2C_PECPosition));
2347                     ; 705     I2Cx->CR2 &= (uint8_t)(~I2C_CR2_POS);
2349  030e e601          	ld	a,(1,x)
2350  0310 a4f7          	and	a,#247
2351  0312 e701          	ld	(1,x),a
2352                     ; 707     I2Cx->CR2 |= (uint8_t)I2C_PECPosition;
...
2360  031a 85            	popw	x
2361  031b 81            	ret
2398                     ; 716 uint8_t I2C_GetPEC(I2C_TypeDef* I2Cx)
2398                     ; 717 {
2399                     	switch	.text
2400  031c               _I2C_GetPEC:
2404                     ; 719     return (I2Cx->PECR);
2406  031c e60e          	ld	a,(14,x)
2409  031e 81            	ret
2456                     ; 747 void I2C_DMACmd(I2C_TypeDef* I2Cx, FunctionalState NewState)
2456                     ; 748 {
2457                     	switch	.text
2458  031f               _I2C_DMACmd:
2460  031f 89            	pushw	x
2461       00000000      OFST:	set	0
2464                     ; 750     assert_param(IS_FUNCTIONAL_STATE(NewState));
2466                     ; 752     if (NewState != DISABLE) {
2468  0320 0d05          	tnz	(OFST+5,sp)
2469  0322 2708          	jreq	L3031
2470                     ; 754         I2Cx->ITR |= I2C_ITR_DMAEN;
2472  0324 e60a          	ld	a,(10,x)
2473  0326 aa08          	or	a,#8
2474  0328 e70a          	ld	(10,x),a
2476  032a 2008          	jra	L5031
2477  032c               L3031:
2478                     ; 757         I2Cx->ITR &= (uint8_t)(~I2C_ITR_DMAEN);
...
2488  0334 85            	popw	x
2489  0335 81            	ret
2537                     ; 768 void I2C_DMALastTransferCmd(I2C_TypeDef* I2Cx, FunctionalState NewState)
2537                     ; 769 {
2538                     	switch	.text
2539  0336               _I2C_DMALastTransferCmd:
2541  0336 89            	pushw	x
2542       00000000      OFST:	set	0
2545                     ; 771     assert_param(IS_FUNCTIONAL_STATE(NewState));
2547                     ; 773     if (NewState != DISABLE) {
2549  0337 0d05          	tnz	(OFST+5,sp)
2550  0339 2708          	jreq	L3331
2551                     ; 775         I2Cx->ITR |= I2C_ITR_LAST;
2553  033b e60a          	ld	a,(10,x)
2554  033d aa10          	or	a,#16
2555  033f e70a          	ld	(10,x),a
2557  0341 2008          	jra	L5331
2558  0343               L3331:
2559                     ; 778         I2Cx->ITR &= (uint8_t)(~I2C_ITR_LAST);
...
2569  034b 85            	popw	x
2570  034c 81            	ret
2759                     ; 892 void I2C_ITConfig(I2C_TypeDef* I2Cx, I2C_IT_TypeDef I2C_IT, FunctionalState NewState)
2759                     ; 893 {
2760                     	switch	.text
2761  034d               _I2C_ITConfig:
2763  034d 89            	pushw	x
2764       00000000      OFST:	set	0
2767                     ; 895     assert_param(IS_I2C_CONFIG_IT(I2C_IT));
2769                     ; 896     assert_param(IS_FUNCTIONAL_STATE(NewState));
2771                     ; 898     if (NewState != DISABLE) {
2773  034e 0d07          	tnz	(OFST+7,sp)
2774  0350 2708          	jreq	L7341
2775                     ; 900         I2Cx->ITR |= (uint8_t)I2C_IT;
2777  0352 e60a          	ld	a,(10,x)
2778  0354 1a06          	or	a,(OFST+6,sp)
2779  0356 e70a          	ld	(10,x),a
2781  0358 2009          	jra	L1441
2782  035a               L7341:
2783                     ; 903         I2Cx->ITR &= (uint8_t)(~(uint8_t)I2C_IT);
...
2794  0363 85            	popw	x
2795  0364 81            	ret
2956                     ; 929 uint8_t I2C_ReadRegister(I2C_TypeDef* I2Cx, I2C_Register_TypeDef I2C_Register)
2956                     ; 930 {
2957                     	switch	.text
...
2965                     ; 931     __IO uint16_t tmp = 0;
2967  0368 5f            	clrw	x
2968  0369 1f03          	ldw	(OFST-1,sp),x
2969                     ; 933     assert_param(IS_I2C_REGISTER(I2C_Register));
2971                     ; 935     tmp = (uint16_t) I2Cx;
2973  036b 1e05          	ldw	x,(OFST+1,sp)
2974  036d 1f03          	ldw	(OFST-1,sp),x
2975                     ; 936     tmp += I2C_Register;
...
2984                     ; 939     return (*(__IO uint8_t *) tmp);
2986  037c 1e03          	ldw	x,(OFST-1,sp)
2987  037e f6            	ld	a,(x)
2990  037f 5b06          	addw	sp,#6
2991  0381 81            	ret
3245                     ; 979 ErrorStatus I2C_CheckEvent(I2C_TypeDef* I2Cx, I2C_Event_TypeDef I2C_Event)
3245                     ; 980 {
3246                     	switch	.text
...
3315  03c5               L7561:
3316                     ; 997     if (((uint16_t)lastevent & (uint16_t)I2C_Event) == (uint16_t)I2C_Event) {
...
3465  0415               L3271:
3466                     ; 1041     return (I2C_Event_TypeDef)lastevent;
3468  0415 1e05          	ldw	x,(OFST-1,sp)
3471  0417 5b08          	addw	sp,#8
3472  0419 81            	ret
3729                     ; 1078 FlagStatus I2C_GetFlagStatus(I2C_TypeDef* I2Cx, I2C_FLAG_TypeDef I2C_FLAG)
3729                     ; 1079 {
3730                     	switch	.text
...
3738                     ; 1080     uint8_t tempreg = 0;
3740  041c 0f02          	clr	(OFST+0,sp)
3741                     ; 1081     uint8_t regindex = 0;
3743  041e 7b01          	ld	a,(OFST-1,sp)
3744  0420 97            	ld	xl,a
3745                     ; 1082     FlagStatus bitstatus = RESET;
3747  0421 7b02          	ld	a,(OFST+0,sp)
3748  0423 97            	ld	xl,a
3749                     ; 1085     assert_param(IS_I2C_GET_FLAG(I2C_FLAG));
3751                     ; 1088     regindex = (uint8_t)((uint16_t)I2C_FLAG >> 8);
3753  0424 7b07          	ld	a,(OFST+5,sp)
3754  0426 6b01          	ld	(OFST-1,sp),a
3755                     ; 1090     switch (regindex) {
...
3767  0435               L5271:
3768                     ; 1092     case 0x01:
3768                     ; 1093         tempreg = (uint8_t)I2Cx->SR1;
...
3776  043d               L7271:
3777                     ; 1097     case 0x02:
3777                     ; 1098         tempreg = (uint8_t)I2Cx->SR2;
...
3785  0445               L1371:
3786                     ; 1102     case 0x03:
3786                     ; 1103         tempreg = (uint8_t)I2Cx->SR3;
...
3884                     ; 1153     uint16_t flagpos = 0;
3886  0460 5f            	clrw	x
3887  0461 1f01          	ldw	(OFST-1,sp),x
3888                     ; 1155     assert_param(IS_I2C_CLEAR_FLAG(I2C_FLAG));
3890                     ; 1158     flagpos = (uint16_t)I2C_FLAG & FLAG_Mask;
...
3900                     ; 1160     I2Cx->SR2 = (uint8_t)((uint16_t)(~flagpos));
...
3910  0478 81            	ret
3986                     ; 1186 ITStatus I2C_GetITStatus(I2C_TypeDef* I2Cx, I2C_IT_TypeDef I2C_IT)
3986                     ; 1187 {
3987                     	switch	.text
...
3995                     ; 1188     ITStatus bitstatus = RESET;
3997  047c 7b04          	ld	a,(OFST+0,sp)
3998  047e 97            	ld	xl,a
3999                     ; 1189     __IO uint8_t enablestatus = 0;
4001  047f 0f03          	clr	(OFST-1,sp)
4002                     ; 1190     uint16_t tempregister = 0;
4004  0481 1e01          	ldw	x,(OFST-3,sp)
4005                     ; 1193     assert_param(IS_I2C_GET_IT(I2C_IT));
4007                     ; 1195     tempregister = (uint8_t)( ((uint16_t)((uint16_t)I2C_IT & ITEN_Mask)) >> 8);
...
4023                     ; 1198     enablestatus = (uint8_t)(I2Cx->ITR & ( uint8_t)tempregister);
4025  0495 1e05          	ldw	x,(OFST+1,sp)
4026  0497 e60a          	ld	a,(10,x)
4027  0499 1402          	and	a,(OFST-2,sp)
4028  049b 6b03          	ld	(OFST-1,sp),a
4029                     ; 1200     if ((uint16_t)((uint16_t)I2C_IT & REGISTER_Mask) == REGISTER_SR1_Index) {
...
4041                     ; 1202         if (((I2Cx->SR1 & (uint8_t)I2C_IT) != RESET) && enablestatus) {
...
4154                     ; 1255     uint16_t flagpos = 0;
4156  04de 5f            	clrw	x
4157  04df 1f01          	ldw	(OFST-1,sp),x
4158                     ; 1258     assert_param(IS_I2C_CLEAR_IT(I2C_IT));
4160                     ; 1261     flagpos = (uint16_t)I2C_IT & FLAG_Mask;
...
4170                     ; 1264     I2Cx->SR2 = (uint8_t)((uint16_t)~flagpos);
