 ...
 492                     ; 218         ADCx->CR1 |= ADC_CR1_ADON;
 494  0046 f6            	ld	a,(x)
 495  0047 aa01          	or	a,#1
 496  0049 f7            	ld	(x),a
 498  004a 2006          	jra	L342
 499  004c               L142:
 500                     ; 221         ADCx->CR1 &= (uint8_t)~ADC_CR1_ADON;
 ...
 510  0052 85            	popw	x
 511  0053 81            	ret
 549                     ; 230 void ADC_SoftwareStartConv(ADC_TypeDef* ADCx)
 549                     ; 231 {
 550                     	switch	.text
 551  0054               _ADC_SoftwareStartConv:
 555                     ; 233     ADCx->CR1 |= ADC_CR1_START;
 557  0054 f6            	ld	a,(x)
 558  0055 aa02          	or	a,#2
 559  0057 f7            	ld	(x),a
 560                     ; 234 }
 563  0058 81            	ret
 691                     ; 252 void ADC_ExternalTrigConfig(ADC_TypeDef* ADCx,
 691                     ; 253                             ADC_ExtEventSelection_TypeDef ADC_ExtEventSelection,
 691                     ; 254                             ADC_ExtTRGSensitivity_TypeDef ADC_ExtTRGSensitivity)
 691                     ; 255 {
 692                     	switch	.text
 693  0059               _ADC_ExternalTrigConfig:
 695  0059 89            	pushw	x
 696       00000000      OFST:	set	0
 699                     ; 257     assert_param(IS_ADC_EXT_EVENT_SELECTION(ADC_ExtEventSelection));
 701                     ; 258     assert_param(IS_ADC_EXT_TRG_SENSITIVITY(ADC_ExtTRGSensitivity));
 703                     ; 261     ADCx->CR2 &= (uint8_t)~(ADC_CR2_TRIGEDGE | ADC_CR2_EXTSEL);
 705  005a e601          	ld	a,(1,x)
 706  005c a487          	and	a,#135
 707  005e e701          	ld	(1,x),a
 708                     ; 265     ADCx->CR2 |= (uint8_t)( (uint8_t)ADC_ExtTRGSensitivity | \
 708                     ; 266                             (uint8_t)ADC_ExtEventSelection);
 ...
 717  0068 85            	popw	x
 718  0069 81            	ret
1032                     ; 330 void ADC_AnalogWatchdogChannelSelect(ADC_TypeDef* ADCx,
1032                     ; 331                                      ADC_AnalogWatchdogSelection_TypeDef ADC_AnalogWatchdogSelection)
1032                     ; 332 {
1033                     	switch	.text
1034  006a               _ADC_AnalogWatchdogChannelSelect:
1036  006a 89            	pushw	x
1037       00000000      OFST:	set	0
1040                     ; 334     assert_param(IS_ADC_ANALOGWATCHDOG_SELECTION(ADC_AnalogWatchdogSelection));
1042                     ; 337     ADCx->CR3 &= ((uint8_t)~ADC_CR3_CHSEL);
1044  006b e602          	ld	a,(2,x)
1045  006d a4e0          	and	a,#224
1046  006f e702          	ld	(2,x),a
1047                     ; 340     ADCx->CR3 |= (uint8_t)ADC_AnalogWatchdogSelection;
...
1055  0077 85            	popw	x
1056  0078 81            	ret
1112                     ; 352 void ADC_AnalogWatchdogThresholdsConfig(ADC_TypeDef* ADCx, uint16_t HighThreshold, uint16_t LowThreshold)
1112                     ; 353 {
1113                     	switch	.text
1114  0079               _ADC_AnalogWatchdogThresholdsConfig:
1116  0079 89            	pushw	x
1117       00000000      OFST:	set	0
1120                     ; 355     assert_param(IS_ADC_THRESHOLD(HighThreshold));
1122                     ; 356     assert_param(IS_ADC_THRESHOLD(LowThreshold));
1124                     ; 359     ADCx->HTRH = (uint8_t)(HighThreshold >> 8);
1126  007a 7b05          	ld	a,(OFST+5,sp)
1127  007c 1e01          	ldw	x,(OFST+1,sp)
1128  007e e706          	ld	(6,x),a
1129                     ; 360     ADCx->HTRL = (uint8_t)(HighThreshold);
1131  0080 7b06          	ld	a,(OFST+6,sp)
1132  0082 1e01          	ldw	x,(OFST+1,sp)
1133  0084 e707          	ld	(7,x),a
1134                     ; 363     ADCx->LTRH = (uint8_t)(LowThreshold >> 8);
1136  0086 7b07          	ld	a,(OFST+7,sp)
1137  0088 1e01          	ldw	x,(OFST+1,sp)
1138  008a e708          	ld	(8,x),a
1139                     ; 364     ADCx->LTRL = (uint8_t)(LowThreshold);
...
1147  0092 85            	popw	x
1148  0093 81            	ret
1215                     ; 403 void ADC_AnalogWatchdogConfig(ADC_TypeDef* ADCx,
1215                     ; 404                               ADC_AnalogWatchdogSelection_TypeDef ADC_AnalogWatchdogSelection,
1215                     ; 405                               uint16_t HighThreshold,
1215                     ; 406                               uint16_t LowThreshold)
1215                     ; 407 {
1216                     	switch	.text
1217  0094               _ADC_AnalogWatchdogConfig:
1219  0094 89            	pushw	x
1220       00000000      OFST:	set	0
1223                     ; 409     assert_param(IS_ADC_ANALOGWATCHDOG_SELECTION(ADC_AnalogWatchdogSelection));
1225                     ; 410     assert_param(IS_ADC_THRESHOLD(HighThreshold));
1227                     ; 411     assert_param(IS_ADC_THRESHOLD(LowThreshold));
1229                     ; 414     ADCx->CR3 &= ((uint8_t)~ADC_CR3_CHSEL);
1231  0095 e602          	ld	a,(2,x)
1232  0097 a4e0          	and	a,#224
1233  0099 e702          	ld	(2,x),a
1234                     ; 417     ADCx->CR3 |= (uint8_t)ADC_AnalogWatchdogSelection;
1236  009b e602          	ld	a,(2,x)
1237  009d 1a05          	or	a,(OFST+5,sp)
1238  009f e702          	ld	(2,x),a
1239                     ; 420     ADCx->HTRH = (uint8_t)(HighThreshold >> 8);
1241  00a1 7b06          	ld	a,(OFST+6,sp)
1242  00a3 1e01          	ldw	x,(OFST+1,sp)
1243  00a5 e706          	ld	(6,x),a
1244                     ; 421     ADCx->HTRL = (uint8_t)(HighThreshold);
1246  00a7 7b07          	ld	a,(OFST+7,sp)
1247  00a9 1e01          	ldw	x,(OFST+1,sp)
1248  00ab e707          	ld	(7,x),a
1249                     ; 424     ADCx->LTRH = (uint8_t)(LowThreshold >> 8);
1251  00ad 7b08          	ld	a,(OFST+8,sp)
1252  00af 1e01          	ldw	x,(OFST+1,sp)
1253  00b1 e708          	ld	(8,x),a
1254                     ; 425     ADCx->LTRL = (uint8_t)LowThreshold;
...
1262  00b9 85            	popw	x
1263  00ba 81            	ret
1298                     ; 465 void ADC_TempSensorCmd(FunctionalState NewState)
1298                     ; 466 {
1299                     	switch	.text
1300  00bb               _ADC_TempSensorCmd:
1304                     ; 468     assert_param(IS_FUNCTIONAL_STATE(NewState));
1306                     ; 470     if (NewState != DISABLE) {
1308  00bb 4d            	tnz	a
1309  00bc 2706          	jreq	L175
1310                     ; 472         ADC1->TRIGR[0] |= (uint8_t)(ADC_TRIGR1_TSON);
1312  00be 721a534e      	bset	21326,#5
1314  00c2 2004          	jra	L375
1315  00c4               L175:
1316                     ; 475         ADC1->TRIGR[0] &= (uint8_t)(~ADC_TRIGR1_TSON);
1318  00c4 721b534e      	bres	21326,#5
1319  00c8               L375:
1320                     ; 477 }
1323  00c8 81            	ret
1358                     ; 485 void ADC_VrefintCmd(FunctionalState NewState)
1358                     ; 486 {
1359                     	switch	.text
1360  00c9               _ADC_VrefintCmd:
1364                     ; 488     assert_param(IS_FUNCTIONAL_STATE(NewState));
1366                     ; 490     if (NewState != DISABLE) {
1368  00c9 4d            	tnz	a
1369  00ca 2706          	jreq	L316
1370                     ; 492         ADC1->TRIGR[0] |= (uint8_t)(ADC_TRIGR1_VREFINTON);
1372  00cc 7218534e      	bset	21326,#4
1374  00d0 2004          	jra	L516
1375  00d2               L316:
1376                     ; 495         ADC1->TRIGR[0] &= (uint8_t)(~ADC_TRIGR1_VREFINTON);
1378  00d2 7219534e      	bres	21326,#4
1379  00d6               L516:
1380                     ; 497 }
1383  00d6 81            	ret
1695                     ; 568 void ADC_ChannelCmd(ADC_TypeDef* ADCx, ADC_Channel_TypeDef ADC_Channels, FunctionalState NewState)
1695                     ; 569 {
1696                     	switch	.text
...
1704                     ; 570     uint8_t regindex = 0;
1706  00d9 0f01          	clr	(OFST+0,sp)
1707                     ; 572     assert_param(IS_FUNCTIONAL_STATE(NewState));
1709                     ; 574     regindex = (uint8_t)((uint16_t)ADC_Channels >> 8);
1711  00db 7b06          	ld	a,(OFST+5,sp)
1712  00dd 6b01          	ld	(OFST+0,sp),a
1713                     ; 576     if (NewState != DISABLE) {
1715  00df 0d08          	tnz	(OFST+7,sp)
1716  00e1 270f          	jreq	L367
1717                     ; 578         ADCx->SQR[regindex] |= (uint8_t)(ADC_Channels);
...
1730  00f2               L367:
1731                     ; 581         ADCx->SQR[regindex] &= (uint8_t)(~(uint8_t)(ADC_Channels));
...
1750  0106 81            	ret
1900                     ; 607 void ADC_SamplingTimeConfig(ADC_TypeDef* ADCx,
1900                     ; 608                             ADC_Group_TypeDef ADC_GroupChannels,
1900                     ; 609                             ADC_SamplingTime_TypeDef ADC_SamplingTime)
1900                     ; 610 {
1901                     	switch	.text
1902  0107               _ADC_SamplingTimeConfig:
1904  0107 89            	pushw	x
1905       00000000      OFST:	set	0
1908                     ; 612     assert_param(IS_ADC_GROUP(ADC_GroupChannels));
1910                     ; 613     assert_param(IS_ADC_SAMPLING_TIME_CYCLES(ADC_SamplingTime));
1912                     ; 615     if ( ADC_GroupChannels != ADC_Group_SlowChannels) {
1914  0108 0d05          	tnz	(OFST+5,sp)
1915  010a 2712          	jreq	L3501
1916                     ; 617         ADCx->CR3 &= (uint8_t)~ADC_CR3_SMPT2;
1918  010c e602          	ld	a,(2,x)
1919  010e a41f          	and	a,#31
1920  0110 e702          	ld	(2,x),a
1921                     ; 618         ADCx->CR3 |= (uint8_t)(ADC_SamplingTime << 5);
...
1948  012e 85            	popw	x
1949  012f 81            	ret
2016                     ; 670 void ADC_SchmittTriggerConfig(ADC_TypeDef* ADCx, ADC_Channel_TypeDef ADC_Channels,
2016                     ; 671                               FunctionalState NewState)
2016                     ; 672 {
2017                     	switch	.text
...
2025                     ; 673     uint8_t regindex = 0;
2027  0132 0f01          	clr	(OFST+0,sp)
2028                     ; 675     assert_param(IS_FUNCTIONAL_STATE(NewState));
2030                     ; 677     regindex = (uint8_t)((uint16_t)ADC_Channels >> 8);
2032  0134 7b06          	ld	a,(OFST+5,sp)
2033  0136 6b01          	ld	(OFST+0,sp),a
2034                     ; 679     if (NewState != DISABLE) {
2036  0138 0d08          	tnz	(OFST+7,sp)
2037  013a 2710          	jreq	L3111
2038                     ; 681         ADCx->TRIGR[regindex] &= (uint8_t)(~(uint8_t)ADC_Channels);
...
2052  014c               L3111:
2053                     ; 684         ADCx->TRIGR[regindex] |= (uint8_t)(ADC_Channels);
...
2071  015f 81            	ret
2118                     ; 693 uint16_t ADC_GetConversionValue(ADC_TypeDef* ADCx)
2118                     ; 694 {
2119                     	switch	.text
...
2234  0195 85            	popw	x
2235  0196 81            	ret
2319                     ; 804 void ADC_ITConfig(ADC_TypeDef* ADCx, ADC_IT_TypeDef ADC_IT, FunctionalState NewState)
2319                     ; 805 {
2320                     	switch	.text
2321  0197               _ADC_ITConfig:
2323  0197 89            	pushw	x
2324       00000000      OFST:	set	0
2327                     ; 807     assert_param(IS_FUNCTIONAL_STATE(NewState));
2329                     ; 808     assert_param(IS_ADC_IT(ADC_IT));
2331                     ; 810     if (NewState != DISABLE) {
2333  0198 0d06          	tnz	(OFST+6,sp)
2334  019a 2706          	jreq	L5321
2335                     ; 812         ADCx->CR1 |= (uint8_t) ADC_IT;
2337  019c f6            	ld	a,(x)
2338  019d 1a05          	or	a,(OFST+5,sp)
2339  019f f7            	ld	(x),a
2341  01a0 2007          	jra	L7321
2342  01a2               L5321:
2343                     ; 815         ADCx->CR1 &= (uint8_t)(~ADC_IT);
...
2354  01a9 85            	popw	x
2355  01aa 81            	ret
2460                     ; 829 FlagStatus ADC_GetFlagStatus(ADC_TypeDef* ADCx, ADC_FLAG_TypeDef ADC_FLAG)
2460                     ; 830 {
2461                     	switch	.text
...
2469                     ; 831     FlagStatus flagstatus = RESET;
2471  01ad 0f01          	clr	(OFST+0,sp)
2472                     ; 834     assert_param(IS_ADC_GET_FLAG(ADC_FLAG));
2474                     ; 837     if ((ADCx->SR & ADC_FLAG) != (uint8_t)RESET) {
2476  01af e603          	ld	a,(3,x)
2477  01b1 1506          	bcp	a,(OFST+5,sp)
2478  01b3 2706          	jreq	L3131
2479                     ; 839         flagstatus = SET;
2481  01b5 a601          	ld	a,#1
2482  01b7 6b01          	ld	(OFST+0,sp),a
2484  01b9 2002          	jra	L5131
2485  01bb               L3131:
2486                     ; 842         flagstatus = RESET;
2488  01bb 0f01          	clr	(OFST+0,sp)
2489  01bd               L5131:
2490                     ; 846     return  flagstatus;
2492  01bd 7b01          	ld	a,(OFST+0,sp)
2495  01bf 5b03          	addw	sp,#3
2496  01c1 81            	ret
2543                     ; 859 void ADC_ClearFlag(ADC_TypeDef* ADCx,
2543                     ; 860                    ADC_FLAG_TypeDef ADC_FLAG)
2543                     ; 861 {
2544                     	switch	.text
2545  01c2               _ADC_ClearFlag:
2547  01c2 89            	pushw	x
2548       00000000      OFST:	set	0
2551                     ; 863     assert_param(IS_ADC_CLEAR_FLAG(ADC_FLAG));
2553                     ; 866     ADCx->SR = (uint8_t)~ADC_FLAG;
...
2562  01ca 85            	popw	x
2563  01cb 81            	ret
2639                     ; 879 ITStatus ADC_GetITStatus(ADC_TypeDef* ADCx,
2639                     ; 880                          ADC_IT_TypeDef ADC_IT)
2639                     ; 881 {
2640                     	switch	.text
...
2648                     ; 882     ITStatus itstatus = RESET;
2650  01cf 7b03          	ld	a,(OFST+0,sp)
2651  01d1 97            	ld	xl,a
2652                     ; 883     uint8_t itmask = 0, enablestatus = 0;
2654  01d2 7b03          	ld	a,(OFST+0,sp)
2655  01d4 97            	ld	xl,a
2658  01d5 7b02          	ld	a,(OFST-1,sp)
2659  01d7 97            	ld	xl,a
2660                     ; 886     assert_param(IS_ADC_GET_IT(ADC_IT));
2662                     ; 889     itmask = (uint8_t)(ADC_IT >> 3);
2664  01d8 7b08          	ld	a,(OFST+5,sp)
2665  01da 44            	srl	a
2666  01db 44            	srl	a
2667  01dc 44            	srl	a
2668  01dd 6b03          	ld	(OFST+0,sp),a
2669                     ; 890     itmask =  (uint8_t)((uint8_t)((uint8_t)(itmask & (uint8_t)0x10) >> 2) | \
2669                     ; 891                         (uint8_t)(itmask & (uint8_t)0x03));
...
2680                     ; 894     enablestatus = (uint8_t)(ADCx->CR1 & (uint8_t)ADC_IT) ;
2682  01ef 1e04          	ldw	x,(OFST+1,sp)
2683  01f1 f6            	ld	a,(x)
2684  01f2 1408          	and	a,(OFST+5,sp)
2685  01f4 6b02          	ld	(OFST-1,sp),a
2686                     ; 897     if (((ADCx->SR & itmask) != (uint8_t)RESET) && enablestatus) {
...
2778                     ; 922     uint8_t itmask = 0;
2780  0211 0f02          	clr	(OFST+0,sp)
2781                     ; 925     assert_param(IS_ADC_IT(ADC_IT));
2783                     ; 928     itmask = (uint8_t)(ADC_IT >> 3);
2785  0213 7b07          	ld	a,(OFST+5,sp)
2786  0215 44            	srl	a
2787  0216 44            	srl	a
2788  0217 44            	srl	a
2789  0218 6b02          	ld	(OFST+0,sp),a
2790                     ; 929     itmask =  (uint8_t)((uint8_t)(((uint8_t)(itmask & (uint8_t)0x10)) >> 2) | \
2790                     ; 930                         (uint8_t)(itmask & (uint8_t)0x03));
...
2801                     ; 933     ADCx->SR = (uint8_t)~itmask;
